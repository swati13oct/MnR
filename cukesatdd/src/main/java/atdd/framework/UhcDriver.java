...
//			scrollToView(element);
	...
	public void selectFromDropDownByValue(WebElement dropdownElement, String value) {
		...
		// waitUntilSelectOptionsPopulated(dropdown);
		// if
		// (!dropdown.getFirstSelectedOption().getAttribute("value").trim().equalsIgnoreCase(value))
		// Assertion.fail("Expected value is not present in dropdown");
	}
	...
	public void grantPermissionOnAndroidChrome(WebElement pdfLink) {
		...
		wait.until(ExpectedConditions
				.invisibilityOfElementLocated(By.xpath("//android.widget.Button[@resource-id='android:id/button1']")));
		...
		for (String context : contexts) {
			if (context.contains("NATIVE_APP")) {
				...
				try {
					 ...
					 */
					mobileDriver.findElement(By.xpath("//android.widget.Button[@resource-id='android:id/button1']"))
							.click();
					mobileDriver.findElement(By.xpath(
