...
public class ExecutionListener extends RunListener {
	...
	public void testFinished(Description description) throws Exception {
		...
		try {
			FileUtils.copyFile(file, new File("C:/Users/akapoo18/codehublatest/mratdd/cukesatdd/"+GetDate()+"_Pass/"+GetTimeStampValue()+".jpg"));
		} catch (IOException e) {
	...
	public void testFailure(Failure failure) throws java.lang.Exception {
		...
		File file  = (File) ((TakesScreenshot)driver1).getScreenshotAs(OutputType.FILE);
		try {
			FileUtils.copyFile(file, new File("C:/Users/akapoo18/codehublatest/mratdd/cukesatdd/"+GetDate()+"_Fail/"+GetTimeStampValue()+".jpg"));
		} catch (IOException e) {
