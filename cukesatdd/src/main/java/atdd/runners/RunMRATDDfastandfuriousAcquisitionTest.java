...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition.vpp","acceptancetests.acquisition.isdecisionguide"  },
features = { "src/main/resources/feature/acquisition/vpp", "src/main/resources/feature/acquisition/IsDecisionGuide", "src/main/resources/feature/acquisition/ole" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDfastandfuriousAcquisitionTest.json" }, tags = { "@F338035" })
