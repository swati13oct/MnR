...
@ExtendedCucumberOptions(jsonReport = "target/cucumber-RunMRATDDFixedTests8.json",detailedReport = true, detailedAggregatedReport = true, overviewReport = true, toPDF = true, outputFolder = "target")
