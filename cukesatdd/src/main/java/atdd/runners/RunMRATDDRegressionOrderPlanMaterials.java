...
features = { "src/main/resources/feature/memberredesign/order-plan-materials" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionOrderPlanMaterials.json" }, 
		tags = { "@regression_06_06_18" })
