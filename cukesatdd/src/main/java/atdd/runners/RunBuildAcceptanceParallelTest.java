...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.vbfacquisition" }, features = { "src/main/resources/feature/vbfacquisition" }, plugin = {
		"html:reports/test-report", "json:target/cucumber-RunBuildAcceptanceParallelTest.json" }, tags = { "@BAT_CommunityMeetings,@BAT_AgentAppointment,@BAT_acq_providersearch,@BAT_acq_pharmacylocator" })
