...
jsonReport = "target/cucumber-RunMRATDDAcquisitionGlobalComponentsShopBlogZipAgent3AARPmobile.json",
detailedReport = true, detailedAggregatedReport = true, overviewReport = true, toPDF = true, 
outputFolder = "target/RunMRATDDAcquisitionGlobalComponentsShopBlogZipAgent3AARPmobile")
