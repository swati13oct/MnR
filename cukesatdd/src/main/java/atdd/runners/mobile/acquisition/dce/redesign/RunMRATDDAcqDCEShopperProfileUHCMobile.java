...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.mobile" }, features = { "src/main/resources/feature/mobile/acquisition/dceredesign" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcqDCEShopperProfileUHCMobile.json" }, 
tags = { "@DCEShopperProfileAddDrugsGlobally_UHC, @DCEShopperProfileAddDrugsPlancard_UHC" })
