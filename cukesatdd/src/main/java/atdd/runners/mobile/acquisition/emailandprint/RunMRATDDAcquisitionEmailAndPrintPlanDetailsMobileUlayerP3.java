...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.mobile.acquisition" }, features = { "src/main/resources/feature/mobile/acquisition/vpp" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcquisitionEmailAndPrintPlanDetailsUlayerP3.json" }, tags = { "@VppEmailandPrintCommon_AARP_1"})//"@emailAndPrint_AARP","@emailAndPrintplanSummary" })
