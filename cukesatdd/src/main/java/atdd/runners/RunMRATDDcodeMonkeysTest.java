...
features = { "src/main/resources/feature/memberredesign" }, plugin = {"pretty", "html:reports/test-report", 
		"json:target/cucumber-RunMRATDDcodeMonkeysTest.json" }, tags = {"@CMNeedhelp,@CMNeedhelpShip,@CMvalidatePdfsectiongroupenglish,@CMvalidatePdfsectiongroupspanishchinese,@CMvalidatePdfsectionindividual"})
