...
jsonReport = "target/cucumber-RunMRATDDRegressionBenefitNCoverage_Pdp_NonlisMemAuthProd.json",detailedReport = true, detailedAggregatedReport = true,
...
features = { "src/main/resources/feature/memberredesign/benefitsandcoverage" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionBenefitNCoverage_Pdp_NonlisMemAuthProd.json" }, tags = { "@test123" })
