...
jsonReport = "target/cucumber-RunMRATDDRegressionBenefitNCoverage_LinksValidation_SSUP_MemAuthProd.json",detailedReport = true, detailedAggregatedReport = true,
overviewReport = true, toPDF = true, outputFolder = "target/RunMRATDDRegressionBenefitNCoverage_LinksValidation_SSUP_MemAuthProd")
