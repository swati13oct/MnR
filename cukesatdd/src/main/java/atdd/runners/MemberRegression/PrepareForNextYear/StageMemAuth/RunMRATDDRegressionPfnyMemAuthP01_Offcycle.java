...
jsonReport = "target/cucumber-RunMRATDDRegressionPfnyMemAuthP01_Offcycle.json",detailedReport = true, detailedAggregatedReport = true,
...
features = { "src/main/resources/feature/memberredesign/prepareForNextYear" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionPfnyMemAuthP01_Offcycle.json" }, tags = { "@memAuth_pfny01_offcycle" })
