...
jsonReport = "target/cucumber-RunMRATDDRegressionPfnyProdP04_ShipComboFedShip.json",detailedReport = true, detailedAggregatedReport = true,
...
features = { "src/main/resources/feature/memberredesign/prepareForNextYear" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionPfnyProdP04_ShipComboFedShip.json" }, tags = { "@prod_pfny03b" })
