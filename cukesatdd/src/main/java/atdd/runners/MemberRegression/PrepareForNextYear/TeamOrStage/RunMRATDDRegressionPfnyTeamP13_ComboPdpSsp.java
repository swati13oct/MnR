...
jsonReport = "target/cucumber-RunMRATDDRegressionPfnyTeamP13_ComboPdpSsp.json",detailedReport = true, detailedAggregatedReport = true,
...
features = { "src/main/resources/feature/memberredesign/prepareForNextYear" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionPfnyTeamP13_ComboPdpSsp.json" }, tags = { "@teamEnv","@pfny01_comboPdpSsp" })
