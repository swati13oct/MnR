...
jsonReport = "target/cucumber-RunMRATDDRegressionPfnyTeamP01_Offcycle.json",detailedReport = true, detailedAggregatedReport = true,
...
features = { "src/main/resources/feature/memberredesign/prepareForNextYear" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionPfnyTeamP01_Offcycle.json" }, tags = { "@teamEnv","@pfny01_offcycle" })
