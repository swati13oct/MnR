...
features = { "src/main/resources/feature/memberredesign/providerSearch" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDSanityProviderSearchMemAuthProdP1a_ma.json" }, tags = { "@prod_sanity01","@prod_sanity_providerSearch01_ma" })
