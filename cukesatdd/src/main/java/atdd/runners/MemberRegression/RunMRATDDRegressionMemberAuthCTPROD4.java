...
features = { "src/main/resources/feature/memberredesign/memberAuth/MemberAuthCTPROD.feature" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionMemberAuthCTPROD.json" }, tags = { "@regressionMemberPROD4" })
public class RunMRATDDRegressionMemberAuthCTPROD4 {
