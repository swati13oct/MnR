...
features = { "src/main/resources/feature/memberredesign/pharmaciesandprescriptions" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionPharmaciesAndPrescriptionsMemAuthP3.json" }, tags = { " @memAuth_pharmaciesandprescriptions01c" })
public class RunMRATDDRegressionPharmaciesAndPrescriptionsMemAuthP3 {
