...
features = { "src/main/resources/feature/memberredesign/planDocumentsAndResources" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionPlanDocAndResMemAuth_P6_ActPcp_P6bof7.json" }, tags = { "@prod_planAndDocuments06_6bof7","@prod_active_pcp_6bof7" })
