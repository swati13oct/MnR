...
features = { "src/main/resources/feature/memberredesign/header" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionHeader_withPymt.json" }, tags = { "@premiumpaymentsheader" })
public class RunMRATDDRegressionHeader_withPymt {
