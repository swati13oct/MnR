...
features = { "src/main/resources/feature/memberredesign/footer" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionFooterNeedHelp.json" }, tags = { "@footer03,@footer04","@regressionMember" })
public class RunMRATDDRegressionFooterNeedHelp {
