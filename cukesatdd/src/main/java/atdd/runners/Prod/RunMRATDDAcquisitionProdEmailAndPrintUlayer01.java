...
@ExtendedCucumberOptions(retryCount = 0, screenShotSize = "", screenShotLocation = "/screenshots/", jsonReport = "target/cucumber-RunMRATDDAcquisitionProdEmailAndPrintUlayer01.json", detailedReport = true, detailedAggregatedReport = true, overviewReport = true, toPDF = true, outputFolder = "target/RunMRATDDAcquisitionProdEmailAndPrintUlayer01")
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, features = {
		"src/main/resources/feature/acquisition/vpp/VPP-EmailAndPrint-Common.feature" }, plugin = {
				...
				"json:target/cucumber-RunMRATDDAcquisitionProdEmailAndPrintUlayer01.json" }, tags = {
						"@prodRegression_AARP_01" })
public class RunMRATDDAcquisitionProdEmailAndPrintUlayer01 {
}
