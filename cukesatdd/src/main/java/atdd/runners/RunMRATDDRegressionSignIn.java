...
features = { "src/main/resources/feature/memberredesign/newSignInPage" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDRegressionSignIn.json" }, tags = { "@regression_06_06_18" })
