...
@ExtendedCucumberOptions(retryCount=2,screenShotSize="", screenShotLocation="/screenshots/",jsonReport = "RunMRATDDAcquisitionInsuranceAgentBlayer.json",detailedReport = true,
