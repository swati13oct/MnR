...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, features = { "src/main/resources/feature/acquisition/IsDecisionGuide/IS-DecisionGuide-Common.feature" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcquisitionDecisionGuideUlayer.json" }, tags = { "@IS_DecisionGuide_Common_AARP"})//"@IS_DecisionGuide_AARP" })
