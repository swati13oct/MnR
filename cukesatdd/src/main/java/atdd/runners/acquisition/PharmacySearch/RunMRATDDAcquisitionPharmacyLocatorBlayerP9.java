...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, features = { "src/main/resources/feature/acquisition/pharmacylocator/PharmacySearch-Common.feature" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcquisitionPharmacyLocatorBlayerP9.json" }, tags = { "@PharmacyLocatorCommonUHC07,@PharmacyLocatorCommonUHC08"})///*"@pharmacyLocatorRegression","@pharmacylocatorblayer07,@pharmacylocatorblayer08"*/"@pharmacylocatorblayer06" })
