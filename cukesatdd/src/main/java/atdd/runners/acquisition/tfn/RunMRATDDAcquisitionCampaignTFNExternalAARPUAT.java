...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, monochrome = true, features = { "src/main/resources/feature/acquisition/tfn/tfn_UAT_Updated/CampaignTFN-AARP-UAT.feature" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcquisitionCampaignTFNExternalAARPUAT.json" }, tags = {"@Scenario_7_DirectTraffic_Email_UAT,@Scenario_8_External_Link_PDP_UAT,@Scenario_9_External_Link_UAT,@Scenario4_1_ExternalLink_AARP_UAT"})
