...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, monochrome = true, features = { "src/main/resources/feature/acquisition/tfn/tfn_UAT_Updated/CampaignTFN-UHC-UAT.feature" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcquisitionCampaignTFNUHCUAT.json" }, tags = {"@Scenario_1_2_DirectTraffic__UHC_UAT,@Scenario_2_CampaignTraffic_UHC_UAT,@Scenario_5_2_DirectTraffic_Email_UHC_UAT,@Scenario_6_External_Link_UHC_UAT"})
