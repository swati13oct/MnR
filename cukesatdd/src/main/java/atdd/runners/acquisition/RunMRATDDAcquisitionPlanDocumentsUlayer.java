...
features = { "src/main/resources/feature/acquisition/vpp" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDfastandfuriousAcquisitionTest.json" }, tags = { "@PlanDocs_PDF_URLvalidation,@PlanDocs_PDF_Textvalidation" })
