...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, features = { "src/main/resources/feature/acquisition/dceredesign" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcqDCEVPPPlanCompareAARP.json" }, tags = { "@DCE_Redesign_VPP_PlanCompare_AARP,@DCE_Redesign_VPP_PlanCompare2_AARP,@DCE_Redesign_VPP_PlanCompare3_AARP" })
