...
/**
 * this file is to run E2E testing on PRE-VPP-DCE using RunMRATDDAcquisitionPREVppDCERedesignAARP
 */
...
@ExtendedCucumberOptions(
		...
		jsonReport = "target/cucumber-RunMRATDDAcquisitionPREVppDCERedesignAARP.json",
		detailedReport = true,
