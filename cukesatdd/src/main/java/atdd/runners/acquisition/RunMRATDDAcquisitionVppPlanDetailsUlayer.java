...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, features = { "src/main/resources/feature/acquisition/vpp" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcquisitionVppPlanSummaryUlayer.json" }, tags = { "@vppPlanDetailsUlayer,@UlayerSAMCall,@UlayerSAMChat" })
