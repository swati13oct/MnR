...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, features = {
		"src/main/resources/feature/acquisition/visitorProfile" }, plugin = { "pretty", "html:reports/test-report",
				"json:target/cucumber-RunMRATDDAcqAuthenticatedVisitorProfileNBABlayerMAPD.json" }, tags = {
						"@authenticatedNBAMAPDUHC01" })
public class RunMRATDDAcqAuthenticatedVisitorProfileNBABlayerMAPD {
