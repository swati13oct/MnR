...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, features = { "src/main/resources/feature/acquisition/vpp/MicroAPP" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcquisitionVPPPlanSummaryAARP01.json" }, tags = { "@VBFTEAMC" })//"@vppPlanSummaryAARPRun01" })
public class RunMRATDDAcquisitionVPPTeamC { 
