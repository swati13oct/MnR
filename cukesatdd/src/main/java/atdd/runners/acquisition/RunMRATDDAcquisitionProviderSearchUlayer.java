...
jsonReport = "target/cucumber-RunMRATDDAcquisitionProviderSearchUlayer.json",detailedReport = true,
...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.acquisition" }, features = { "src/main/resources/feature/acquisition/providersearch" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber-RunMRATDDAcquisitionProviderSearchUlayer.json" }, tags = { "@ProviderSearchCommon_AARP"})//"@AcqRegressionProviderSearchUlayer" })
