...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.dashboard.registration" }, features = { "src/main/resources/feature/dashboard/registration" }, plugin = {
		"pretty", "html:reports/test-report", "json:target/cucumber.json" }, tags = { "@Sanity_registrationRedesign" })
