...
@CucumberOptions(glue = { "atdd.framework", "acceptancetests.memberrdesignVBF.healthandwellness" }, features = { "src/main/resources/feature/member-redesign-vbf/health-and-wellness" }, plugin = {
