...
public class RequestHelpAndInformationPage extends UhcDriver {
	...
	public boolean validateHelpandInfoPage(){
		if(validateNew(ma_requestAgentAppointmentLink)&&validateNew(findUnitedHealthcareLink))
			return true;
		return false;
	}
	
	public boolean validateUhcLink(){
		if(validateNew(findUnitedHealthcareLink)&&findUnitedHealthcareLink.getText().contains("Find UnitedHealthcare in Your Community"))
			return true;
		return false;
	}
}
