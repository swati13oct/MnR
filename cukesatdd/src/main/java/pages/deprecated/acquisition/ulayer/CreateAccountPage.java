...
public class CreateAccountPage extends UhcDriver{
	...
	public RegistrationSuccessPage createAccount(
		...
		sendkeysNew(confirmPasswordField, confirmPassword);
		sendkeysNew(emailAdrField, emailId);
		sendkeysNew(confirmEmailAdrField, confirmEmailId);
	...
	public void openAndValidate() {
		...
		validateNew(confirmPasswordField);
		validateNew(emailAdrField);
		validateNew(confirmEmailAdrField);
