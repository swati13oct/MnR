...
public class SpecialElectionPeriodPage extends UhcDriver {
	...
	public void openAndValidate() {
		validateNew(yes);
		validateNew(no);
		validateNew(saveAndContinue);
		validateNew(previous);
		validateNew(checkBoxOne);
		validateNew(checkBoxTwo);
		validateNew(checkBoxThree);
		validateNew(checkBoxFour);
		//validate(checkBoxSixA);
		//validate(checkBoxSixB);
		validateNew(checkBoxSeven);
		validateNew(checkBoxEight);
		validateNew(checkBoxNine);
		validateNew(enterDateOne);
		validateNew(enterDateTwo);
		validateNew(enterDateFive);
		//validate(enterDateSixA);
		//validate(enterDateSixB);
		validateNew(enterReason);	
...
*/
	...
	public boolean validateSEPPage(){
		boolean flag = false;
		if(validateNew(sepHeader)&&validateNew(yes)&&validateNew(no)&&validateNew(saveAndContinue))
			flag = true;
		return flag;
	}
