...
public class PlanPaymentOptions extends UhcDriver{
	...
	public void openAndValidate() {
		validateNew(ppodisclaimerAgreeBtn);
	...
	public OptionalRidersPage clickdisclaimerbutton() {
		...
		validateNew(disclaimerppoagreebutton);
		...
		validateNew(saveandcontinuebutton);
	...
	public boolean validatePPOPage(){
		boolean flag = false;
		if(validateNew(ppoHeader)&&validateNew(ppoPrevBtn)&&validateNew(saveandcontinuebutton)&&validateNew(ppoCancelBtn)&&
		validateNew(disclaimerppo)&&validateNew(planpaymentyes)&&validateNew(planpaymentno))
			flag = true;
		return flag;
	}
	}
