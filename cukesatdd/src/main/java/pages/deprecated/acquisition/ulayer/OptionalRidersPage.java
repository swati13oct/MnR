...
public class OptionalRidersPage extends UhcDriver{
	...
	public void entersOptionalRiderInformation(
		...
		public boolean validateOptionalRidersPage(){
			boolean flag = false;
			if(validateNew(optHeader)&&validateNew(optionalridersprevious)&&validateNew(optionalriderssaveandcontinue)&&
			validateNew(optionalriderscancelregristration))//&&validate(optno))
				flag = true;
			return flag;
		}
}
