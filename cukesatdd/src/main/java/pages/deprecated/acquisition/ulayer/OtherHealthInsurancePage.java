...
public class OtherHealthInsurancePage extends UhcDriver{
	...
	public void openAndValidate() {
	 validateNew(otherhealthinsuranceno);
	  validateNew(otherhealthinsuranceyes);
	...
	public void entersotherhealthinsurInformation(
		...
		if(othradiooption.equalsIgnoreCase("No")){
			...
			sendkeysNew(otherhealthinsurancename,othnameofhealthinsur);
			sendkeysNew(otherhealthinsurancegroup,othgroupid);
			sendkeysNew(otherhealthinsurancememberid,othmemberid);
		}			
			...
			public boolean validateOTHPage(){
				boolean flag = false;
				if(validateNew(otherhealthinsuranceno)&&validateNew(otherhealthinsuranceyes)&&validateNew(otherhelathinsurancesaveandcontinue)&&validateNew(otherhealthinsuranceprevious)&&
				validateNew(otherhelathinsurancecancelregristration)&&validateNew(othHeader))
					flag = true;
				return flag;
			}
	}
