...
public class AgentAppointmentConfirmationPage extends UhcDriver {
	...
	public boolean validateConfirmationPage(){
		CommonUtility.waitForPageLoadNew(driver, confirmationHeader,CommonConstants.TIMEOUT_30);
		//System.out.println("text:"+confirmationHeader.getText());
		if(validateNew(rightRail))//.getText().contains("Thank You for Your Appointment Request"))
			return true;
		return false;
	}
}
