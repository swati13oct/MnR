...
public class PortfolioPage extends UhcDriver {
   ...
   // New elements added
    ...
    private WebElement selectACounty;
	...
	public Boolean findplansbuttonclick2() {
		...
		return validateNew(errormessage);
	...
	public void searchbyaddressclick() {
        ...
        validateNew(searchbyaddresslink);
...
//	    WebElement element =findNoSuchElement(By.id("zipcode"));
	...
	//    element.sendKeys(Keys.ENTER);
	  ...
	  System.out.println("Actual title:"+driver.getTitle()+ "Expected Page title:"+PageTitleConstants.ULAYER_PLAN_SUMMARY_PAGE_TITLE);
		if (driver.getTitle().contains(PageTitleConstants.ULAYER_PLAN_SUMMARY_PAGE_TITLE)) {
