...
public class MedicalClaimDetailsPage extends UhcDriver {
	...
	public MedicalClaimDetailsPage(WebDriver driver) {
		...
		CommonUtility.waitForPageLoadNew(driver, drugdetailtableheader, CommonConstants.TIMEOUT_30);
	...
	public boolean validateMoreInfo(){
		boolean flag = false;
		if(validateNew(drugclaimdetailbox)&&validateNew(medDetailsInnerBox)&&validateNew(backtoClaimSearchbtn))
			flag = true;
