...
public class PlanSummaryPage extends UhcDriver {
	...
	public AddPlanPopUpPage clickAddPlan() {
		...
		if(validateNew(element) && element.getText().equalsIgnoreCase("Add Another Plan to Your Online Account"))
	...
	public void openAndValidate() {
		validateNew(addAnotherPlanLink);
		validateNew(logOut);
	...
	public boolean validateClaims() {
		boolean flag = false;
		CommonUtility.waitForPageLoadNew(driver, claimSectionHeading,20);
