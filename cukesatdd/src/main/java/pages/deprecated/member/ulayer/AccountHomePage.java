...
//	private WebElement formsAndResourcesLink;
	...
	public MyProfilesPage navigateToProfAndPref() {
		...
		CommonUtility.waitForPageLoadNew(driver, myProfilePageHeading, 25);
	...
	public pages.memberrdesignVBF.PaymentHistoryPage changeUrlToNewPaymentHistoryPage() {
		...
		if (paymentsHeading.getText().contains("Premium Payments Overview")) {
			...
			return new pages.memberrdesignVBF.PaymentHistoryPage(driver);
	...
	public MyPreferencesPage clicksOnGoGreenIcon() {
		...
		CommonUtility.waitForPageLoadNew(driver, preferencesPageHeading, 20);
	...
	public PlanComparePage navigateToPlanCompare() {
		...
		CommonUtility.waitForPageLoadNew(driver, planCompareHeader, 20);
