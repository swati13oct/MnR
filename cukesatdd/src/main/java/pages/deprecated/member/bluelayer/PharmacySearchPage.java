...
public class PharmacySearchPage extends UhcDriver {
	...
	public PharmacyResultPage searchesPharmacy() {
		...
		CommonUtility.waitForPageLoadNew(driver, pharmacySearchResultMsg, CommonConstants.TIMEOUT_30);
		if (driver.getTitle().equalsIgnoreCase(
				"UnitedHealthcare Medicare Solutions | Pharmacy Directory")) {
	...
	public void openAndValidate() {
		...
		validateNew(searchPharmaciesButton);
		validateNew(espanolLink);
		validateNew(chineseLink);
		validateNew(createPdfLink); 
	}
