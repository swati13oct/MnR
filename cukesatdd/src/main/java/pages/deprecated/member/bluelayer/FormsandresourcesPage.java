...
public class FormsandresourcesPage extends UhcDriver {
	...
	public PrescriptionDrugEobPage navigateToPresDrugEob() {
		CommonUtility.waitForPageLoadNew(driver, prescriptionDrugEobLink, 20);
	...
	public boolean verifyPassportFlyer(){
		return validateNew(passport_Flyer);
	}
	public boolean verifyPassportFlyerSpanish(){
		return validateNew(passport_Flyer_Spanish);

	}
	
	public String validatePrescriptionmailorderBenefitPdfs() {
		// TODO Auto-generated method stub
		validateNew(preferredMailOrderLink);
	...
	public boolean validateMedEOBFormsPage(){
		if(eobSectionBox.getText().contains("Explanation of Benefits (EOB)")&&validateNew(medicalEobLink))
			return true;
		return false;
	}
	/**
