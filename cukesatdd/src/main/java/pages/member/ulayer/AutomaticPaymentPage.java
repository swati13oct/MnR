...
public class AutomaticPaymentPage extends UhcDriver{
	...
	public AutomaticPaymentPage(WebDriver driver) {
		super(driver);
	...
	public ConfirmAutomaticPaymentPage enterPaymentDetails(Map<String, String> accountAttributessMap) {
		...
		if(driver.getTitle().equalsIgnoreCase("Make Online Payment")){
			return new ConfirmAutomaticPaymentPage(driver);
		}
		return null;
