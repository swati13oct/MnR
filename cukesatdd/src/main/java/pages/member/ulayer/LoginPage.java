...
public class LoginPage extends UhcDriver {
	...
	public Object loginWith(String username, String password) {
		...
		if (MRScenario.environment.equals("awe-dev-b") || MRScenario.environment.equals("dev-a") || MRScenario.environment.equals("dev-c") || MRScenario.environment.equals("team-b") || MRScenario.environment.equals("team-c")) {
