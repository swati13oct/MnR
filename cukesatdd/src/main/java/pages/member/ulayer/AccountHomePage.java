...
public class AccountHomePage extends UhcDriver {
	...
	public pages.dashboard.member.ulayer.ClaimSummarypage navigateToClaimsSummaryPage() {
		...
		if (MRScenario.environment.equalsIgnoreCase("team-h")) {
			CommonUtility.waitForPageLoad(driver, driver.findElement(By.linkText("Go to Claims page  page")), 60); 	
			driver.findElement(By.linkText("Go to Claims page  page")).click();
		}
