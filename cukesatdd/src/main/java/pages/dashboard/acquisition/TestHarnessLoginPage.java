...
public class TestHarnessLoginPage extends UhcDriver{
               
               private static String PAGE_URL = MRConstants.TestHarnessLoginPage;
               ...
               public TestHarnessLoginPage(WebDriver driver) {
                              super(driver);
