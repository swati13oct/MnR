...
public class RequestMailedInformationUHC extends UhcDriver {
	...
	public RequestMailedInformationUHC(WebDriver driver) throws InterruptedException {
		super(driver);
	...
	public boolean submitAgentAppointmentUHC(Map<String,String> personalDetails)
	{
		wallgreens.click();
