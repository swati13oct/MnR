...
public class PEEHIPHomePage extends UhcDriver {
	
	@Override
	public void openAndValidate(){
		start(PEEHIP_HOME_PAGE_URL);
	}
	
	private static String PEEHIP_HOME_PAGE_URL = MRConstants.PEEHIP_HOME_PAGE_URL;
	
	@FindBy(xpath="//*[@id='main']/div/div[1]/div/div[3]/div[2]/div[8]/div/div/div[1]/a/span")
    private WebElement getstartedbutton;
	
	public PEEHIPHomePage(WebDriver driver) {
		super(driver);
