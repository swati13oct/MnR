...
public class CostBasicsPageNew extends GlobalWebElements {
    public CostBasicsPageNew(WebDriver driver) {
        super(driver);
    ...
    public MedicareAdvantagePartCPlansPageNew clickOnReadNextMAPlanLink(){
