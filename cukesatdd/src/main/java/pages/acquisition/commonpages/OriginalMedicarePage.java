...
public class OriginalMedicarePage extends GlobalWebElements {
    public OriginalMedicarePage(WebDriver driver) {
        super(driver);
    ...
    public OverviewofPlanTypesPage clickonNextPlanOverviewLink() {
