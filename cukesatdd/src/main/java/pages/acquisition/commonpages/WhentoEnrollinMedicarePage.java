...
public class WhentoEnrollinMedicarePage extends GlobalWebElements {
    public WhentoEnrollinMedicarePage(WebDriver driver) {
        super(driver);
    ...
    public HowtoEnrollinMedicarePage clickOnNextHowToEnrollLink() {
