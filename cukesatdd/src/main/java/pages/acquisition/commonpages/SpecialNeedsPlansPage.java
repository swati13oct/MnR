...
public class SpecialNeedsPlansPage extends GlobalWebElements {
    public SpecialNeedsPlansPage(WebDriver driver) {
        super(driver);
    ...
    public WhentoEnrollinMedicarePage clickOnMedicareEnrollment() {
        sleepBySec(2);
