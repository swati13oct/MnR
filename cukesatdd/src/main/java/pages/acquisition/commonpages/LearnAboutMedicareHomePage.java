...
public class LearnAboutMedicareHomePage extends GlobalWebElements {
	...
	// @FindBy(xpath =
	// "//a[contains(@class,'tile')]//span[contains(text(),'Advantage')]")
...
//		getLnkMedicareAdvantage().click();
		...
		if (driver.getCurrentUrl().contains("classic")) {
			...
			lnkMA = driver.findElement(By.xpath(
					"//a[contains(@href,'/medicare-education/medicare-advantage')]//span[contains(text(),'Advantage')]"));
		}
		jsClickNew(lnkMA);
...
//		getLnkMedicareAdvantage().click();
	...
	public CoverageChoicesPage clickonCoverageChoicesLink() {
		// WebElement
		// lnkcvrgChoice=driver.findElement(By.xpath("//div[contains(@class,'tile')]//a[contains(@href,'medicare-parts')]//span[contains(text(),'Coverage')]"));
