 ...
 *
 */
public class ConfirmYourEligibilityPage extends UhcDriver{
	...
	@FindBy(xpath = "//h3[contains(text(),'confirm') or contains(text(),'Other')]")
	...
	public ConfirmYourEligibilityPage(WebDriver driver) {
		super(driver);
