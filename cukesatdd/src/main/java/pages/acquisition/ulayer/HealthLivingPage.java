...
public class HealthLivingPage extends GlobalWebElements{
	...
	public HealthLivingPage(WebDriver driver) {
		...
		@FindBy(xpath = "//*[@id='subnav_4']/div/div/div[1]/div[1]/div[2]/p[2]/a/span")
		private WebElement healthlivinglink;
...
public void hoverhealthandwellnesslink() {
	...
	public HealthToolsPage HealthToolsClick() {
		...
		Actions actions = new Actions(driver);
		 actions.moveToElement(healthlivinglink);
	      ...
	      if(driver.getTitle().equalsIgnoreCase("Health Tools")){
		    	return new HealthToolsPage(driver);
	}
