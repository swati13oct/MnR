...
public class VPPPlanSummaryPage extends UhcDriver {
	...
	public WebElement getValEstimatedAnnualDrugCostValue(String planName) {
		WebElement valEstimatedAnnualDrugCostValue = driver.findElement(By.xpath("//*[contains(text(),'" + planName
				+ "')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[@ng-show='plan.network']"));
	...
	public void viewPlanSummary(String planType) {
		if (planType.equalsIgnoreCase("PDP")) {
			...
			sleepBySec(2); // note: add sleep for timing issue, tried increase
							// timeout from waitForPageLoadNew but didn't work
	...
	public void ValidateclicksOnIsProviderCovered(String planName) throws InterruptedException {
		...
		// CommonConstants.MAIN_WINDOW_HANDLE_ACQUISITION =
	...
	public boolean getSpecificPlanInfo(String planName) throws InterruptedException {
		...
		/*
		 * else if (planName.contains("Regional PPO")) { //ElementData
		 * elementData = new ElementData("id", "viewDetailsMA"); element =
		 * getSpecificPlanSummary(findChildElements(elementData, maPlanList),
		 * planName); }
		 */
	...
	public ComparePlansPage clickOnCompareLink() {
		List<WebElement> compareLinks = driver.findElements(
				By.xpath(".//span[contains(@class,'added-text show')]//button[contains(text(),'Compare plans')]"));
	...
	public String getPlanPremium(String PlanName) {
		...
		WebElement PremiumForPlan = driver.findElement(By.xpath("//*[contains(text(), '" + PlanName
				+ "')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//li[1]//span[contains(text(),'$')]"));
	...
	public WelcomePage Enroll_OLE_Plan(String planName) throws InterruptedException {
		...
		WebElement EnrollForPlan = driver.findElement(By.xpath("//*[contains(text(), '" + planName
				+ "')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'Enroll in plan')]"));
	...
	public ComparePlansPage selectplantocompare(String PlanType, String PlanName) {
		...
		try {
			if (driver
					.findElement(By.xpath("//*[contains(text(), '" + PlanName
	...
	public void validateAndClickAddtoCompareinAARP(String planType, String planName) throws InterruptedException {
		...
		if (planType.equalsIgnoreCase("PDP")) {
			...
			// '"+planName+"')]/ancestor::div[@class='module-plan-overview
			// module swiper-slide ng-scope']//input[@id='compare-plan-7']"));
			WebElement addToCompare = driver.findElement(By.xpath("//*[contains(text(),\'" + planName
					+ "\')]/ancestor::div[contains(@class, 'module-plan-overview')]//div[contains(@class ,'compare-box')]//span[contains(@class ,'ng-scope')]/label"));
			validateNew(addToCompare);
			addToCompare.click();
	...
	public boolean compareTextAfterclickingAddtoCompareinAARP(String planName) throws InterruptedException {
		WebElement compareText = driver.findElement(By.xpath("//*[contains(text(), '" + planName
				+ "')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope compare-add']//div[@class='compare-box']/span[@class='single-added-text show']"));
	...
	public void deselectAddToCompareinAARP(String planName) {
		try {
			...
			// driver.findElement(By.xpath("//*[contains(text(),
			// '"+planName+"')]/ancestor::div[@class='module-plan-overview
			// module swiper-slide ng-scope
			// compare-add']//div[@class='compare-box']/span[@class='ng-scope']"));
			WebElement addToCompareCheck = driver
					.findElement(By.xpath("//label[contains(text(),'Added to compare')]//parent::span//label"));
	...
	public void validateAddToCompareNotPresentForDSNP(String planName) {
		try {
			if (driver
					.findElement(By.xpath("//*[contains(text(), '" + planName
							+ "')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'compare-plan')]"))
					.isDisplayed()) {
	...
	public void validateAndClickLearnMoreAboutExtraHelpInAARP(String planType, String planName)
		...
		if (planType.equalsIgnoreCase("MAPD")) {
			WebElement learnMoreAboutExtraHelp = driver.findElement(By.xpath("(//*[contains(text(), '" + planName
					+ "')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//a[@class='inline-edit-link modal-link vpp-monthly-premium-modal'])[1]"));
		...
		if (planType.equalsIgnoreCase("SNP")) {
			...
			// driver.findElement(By.xpath("(//*[contains(text(),
			// '"+planName+"')]/ancestor::div[@class='module-plan-overview
			// module swiper-slide ng-scope']//a[@class='inline-edit-link
			// modal-link vpp-monthly-premium-modal'])[1]"));
			WebElement learnMoreAboutExtraHelp = driver.findElement(By.xpath("(//*[contains(text(), '" + planName
					+ "')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//a[@class='inline-edit-link modal-link vpp-monthly-premium-modal'])[1]"));
			validateNew(learnMoreAboutExtraHelp);
			learnMoreAboutExtraHelp.click();
	...
	public void validatePlanPremium(String planName, String monthlyPremium) {
		WebElement PremiumForPlan = driver.findElement(By.xpath("(//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'Monthly Premium')]/span)[1]"));
		CommonUtility.waitForPageLoadNew(driver, PremiumForPlan, 30);
		String PlanPremium = PremiumForPlan.getText();
	...
	public void validatePrimaryCarePhysicianBenefit(String planType, String planName, String primaryCarePhysician) {
		WebElement PrimaryCarePhysicianForPlan = driver.findElement(By.xpath("//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'Primary Care Physician')]/span"));
		 ...
		 * +PrimaryCare.replaceAll("\n", " ")); //String PrimaryCare1 =
		 * PrimaryCarePhysicianForPlan.getAttribute("textContent").trim();
		 * System.out.println("Primary care is " +PrimaryCare);
		 * if(PrimaryCare.equalsIgnoreCase(primaryCarePhysician)){
		 * System.out.println("PrimaryCare for the plan is " + PrimaryCare);
		 * Assert.assertTrue(true); } else Assert.
		 * fail("Primary Care Physician Benefit for the plan is incorrect : "
		 * +planName); }
		 */
	}

	public void validateSpecialistBenefit(String planType, String planName, String specialist) {
		WebElement SpecialistForPlan = driver.findElement(By.xpath("//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'Specialist')]/span"));
	...
	public void validateReferrralRequiredBenefit(String planName, String referralRequired) {
		WebElement ReferralRequiredForPlan = driver.findElement(By.xpath("//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'Referral Required')]/span"));
	...
	public void validatesOutOfPocketMaximum(String planName, String outOfPocketMaximum) {
		WebElement OOPForPlan = driver.findElement(By.xpath("//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'Out Of Pocket Maximum')]/span"));
	...
	public void validatePrescriptionDrugsTier1(String planName, String prescriptionDrugsTier1) {
		WebElement DrugsForPlan = driver.findElement(By.xpath("(//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'Prescription Drugs, Tier 1')]/span)[1]"));
	...
	public void validateAnnualDeductible(String planName, String annualDeductible) {
		WebElement AnnualDeductibleForPlan = driver.findElement(By.xpath("(//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'Annual Deductible')]/span)[2]"));
		 ...
		 * System.out.println(" The text from feature file is "
		 * +annualDeductible);
		 * 
	 ...
	 * System.out.println("Annual Deductible for the plan is " +
	 * PlanDeductible); Assert.assertTrue(true); } else
	 * Assert.fail("Annual Deductible for the plan is incorrect : "+planName); }
	 */
	...
	public void validateMarketingBullets(String planType, String planName) {
		...
		if (!planType.equals("PDP")) {
			WebElement marketingBullets = driver.findElement(By.xpath("//*[contains(text(),\'" + planName
					+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//div[@class='vppColumnDivisionContainer']"));
			validateNew(marketingBullets);
		}
		if (planType.equals("PDP")) {
			WebElement marketingBullets = driver.findElement(By.xpath("(//*[contains(text(),\'" + planName
					+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//ul)[2]"));
			validateNew(marketingBullets);
		}
	...
	public void toolTipForPremium0(String planName) {
		WebElement toolTip = driver.findElement(By.xpath("//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//descendant :: span[@class='standalone']//*[name()='use']"));
		WebElement tooltipContent = driver.findElement(By.xpath("//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//descendant :: span[@class='standalone']//span"));
	...
	public void toolTipForAnnualDeductible(String planName) {
		WebElement toolTip = driver.findElement(By.xpath("(//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//descendant :: span[@class='standalone']//*[name()='use'])[2]"));
		WebElement tooltipContent = driver.findElement(By.xpath("(//*[contains(text(),\'" + planName
				+ "\')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//descendant :: span[@class='standalone']//span)[2]"));
		Actions action = new Actions(driver);
		action.moveToElement(toolTip).build().perform();
		String toolTipText = tooltipContent.getAttribute("textContent").trim();
	...
	public pages.acquisition.dce.ulayer.DrugCostEstimatorPage navigatetoDCEPage(String planName) {
		WebElement DCELink = driver.findElement(By.xpath("(//*[contains(text(),'" + planName
				+ "')]/ancestor::div[@class='module-plan-overview module swiper-slide ng-scope']//*[contains(text(), 'Prescription Drugs, Tier 1')]/span)[2]"));
		DCELink.click();
		CommonUtility.checkPageIsReadyNew(driver);
	...
	public void validateMedicareVideoGuideRightRail() throws InterruptedException {
		...
		/*
		 * validateNew(ChooseAVideo); //
		 * CommonUtility.waitForPageLoadNew(driver, RightRail_AgentInYourArea,
		 * 30); String parentHandle = driver.getWindowHandle(); int initialCount
		 * = driver.getWindowHandles().size(); ChooseAVideo.click();
		 * 
		 * waitForCountIncrement(initialCount); ArrayList<String> tabs = new
		 * ArrayList<String>(driver.getWindowHandles()); String currentHandle =
		 * null; for (int i = 0; i < initialCount + 1; i++) {
		 * driver.switchTo().window(tabs.get(i)); currentHandle =
		 * driver.getWindowHandle(); if
		 * (!currentHandle.contentEquals(parentHandle)) break; }
		 */
	...
	public void enterRequiredFieldsForMedicareGuide(Map<String, String> memberAttributesMap) {
		...
		WebElement popup = driver
				.findElement(By.xpath("//div[@class='closeBg']/*[contains (text() , 'Thank you for your interest')]"));
	...
	public void validateEmailOptionExistOnPage(String planType) {
		...
		if (planType.equalsIgnoreCase("mapd") || planType.equalsIgnoreCase("ma")) {
			// System.out.println("TEST - going to validate the print and email
			// element for MA");
	...
	public void validatePrintOptionExistOnPage(String planType) {
		...
		/*
		 * tbd-remove //note: temperary - remove the following when email option
		 * is enable, this is just to make sure it wasn't turn on by mistake
		 * WebElement emailElement=null; if (planType.equalsIgnoreCase("mapd")
		 * || planType.equalsIgnoreCase("ma")) { //System.out.
		 * println("TEST - going to validate the print and email element for MA"
		 * ); emailElement=maEmailOption; } else if
		 * (planType.equalsIgnoreCase("pdp")) { //System.out.
		 * println("TEST - going to validate the print and email element for PDP"
		 * ); emailElement=pdpEmailOption; } else if
		 * (planType.equalsIgnoreCase("snp")) { //System.out.
		 * println("TEST - going to validate the print and email element for SNP"
		 * ); emailElement=snpEmailOption; } else {
		 * Assert.assertTrue("PROBLEM - test not coded for this '"
		 * +planType+"' planType testing", false); } Assert.
		 * assertTrue("PROBLEM - Email option should NOT show up (disabled until feature approved). emailCheck="
		 * +validate(emailElement), !validate(emailElement));
		 */
	}
	...
	public void validateDefaultNoSavedPlan(String planType) {
		...
		// System.out.println("TEST - Number of Available Plan for
		// planType='"+planType+"'="+numOfAvaliablePlans);
		...
		// System.out.println("TEST - listOfUnsavedPlans
		// xpath="+testXpath+favoritePlanXpath);
		// System.out.println("TEST - Number of unsave plan link for
		// planType='"+planType+"'="+numOfUnsavedPlans);
		...
		// System.out.println("TEST - listOfUnfilledIcons
		// xpath="+testXpath+unfilledIconXpath);
		// System.out.println("TEST - Number of unsave plan icon for
		// planType='"+planType+"'="+numOfUnfilledIcons);
	...
	public void validateAbilityToSavePlans(String savePlanNames, String planType) {
		...
		for (String plan : listOfTestPlans) {
			...
			String initial_savePlanIconXpath = headerPath + "[contains(text(),'" + plan + "')]" + subPath
					+ savePlanImgXpath;
			// System.out.println("TEST - initial_savePlanLIconXpath
			// xpath="+initial_savePlanIconXpath);
			...
			String savedPlanIconXpath = headerPath + "[contains(text(),'" + plan + "')]" + subPath
					+ "//button[contains(@class,'savedPlan') and contains(@style,'block')]" + savedPlanImgXpath;
			// System.out.println("TEST - savedPlanIconXpath
			// xpath="+savedPlanIconXpath);
			...
			// System.out.println("TEST - initial_savePlanLIconXpath
			// xpath="+initial_savePlanIconXpath);
			String afterSavePlanIconXpath = headerPath + "[contains(text(),'" + plan + "')]" + subPath
					+ "//button[contains(@class,'savePlan') and contains(@style,'block')]//img[contains(@src,'ic_favorite-unfilled.png')]";
			listOfSavePlanIcons = driver.findElements(By.xpath(afterSavePlanIconXpath));
			expMatch = 0;
			Assert.assertTrue("PROBLEM - 'Save Plan' icon should have disappeared after click for ='" + plan
			...
			String appeared_savedPlanIconXpath = headerPath + "[contains(text(),'" + plan + "')]" + subPath
					+ "//button[contains(@class,'savedPlan') and contains(@style,'')]" + savedPlanImgXpath;
			// System.out.println("TEST - appeared_savedPlanLIconXpath
			// xpath="+appeared_savedPlanIconXpath);
			...
			String appeared_savedTextXpath = headerPath + "[contains(text(),'" + plan + "')]" + subPath
					+ "//button[contains(@class,'savedPlan') and contains(@style,'')]"
					+ "/span[contains(text(),'Saved')]";
			// System.out.println("TEST - appeared_savedTextXpath
			// xpath="+appeared_savedTextXpath);
	...
	public void validatePlansAreSaved(String savePlanNames, String planType) {
		...
		String appeared_savedPlanLIconXpath = planTypePath + headerPath + subPath
				+ "//button[contains(@class,'savedPlan') and not(contains(@style,'none'))]" + savedPlanImgXpath;
		// System.out.println("TEST - appeared_savedPlanLIconXpath
		// xpath="+appeared_savedPlanLIconXpath);
	...
	public VPPPlanSummaryPage navagateToChangeZipcodeOptionToChangeZipcode(String zipcode, String countyName,
		...
		try {
			// if change zip code link is there then click it, once you used it
			// then it will only display field box going forward.
		...
		// if field box already there then clear it if left over text from prior
		// run
	...
	public void validateAbilityToUnSavePlans(String savedPlans, String planType) {
		...
		String appeared_savedPlanLIconXpath = headerPath + "[contains(text(),'" + unsavePlan + "')]" + subPath
				+ "//button[contains(@class, 'savedPlan') and not(contains(@style,'none'))]" + savedPlanImgXpath;
		// System.out.println("TEST - appeared_savedPlanLIconXpath
		// xpath="+appeared_savedPlanLIconXpath);
		List<WebElement> listOfAppearedSavedPlanIcons = driver.findElements(By.xpath(appeared_savedPlanLIconXpath));
		...
		String savePlanIconXpath = headerPath + "[contains(text(),'" + unsavePlan + "')]" + subPath
				+ "//button[contains(@class, 'savePlan') and not(contains(@style,'none'))]" + savePlanImgXpath;
		// System.out.println("TEST - savePlanIconXpath
		// xpath="+savePlanIconXpath);
		...
		String savePlanTextXpath = headerPath + "[contains(text(),'" + unsavePlan + "')]" + subPath
				+ "//button[contains(@class, 'savePlan') and not(contains(@style,'none'))]"
				+ "/span[contains(text(),'Save plan')]";
		// System.out.println("TEST - savePlanTextXpath
		// xpath="+savePlanTextXpath);
		List<WebElement> listOfSavePlanText = driver.findElements(By.xpath(savePlanTextXpath));
		expMatch = 1;
		Assert.assertTrue(
				"PROBLEM - unable to locate 'Save Plan' text for ='" + unsavePlan + "'.  Expect number of match='"
						+ expMatch + "' | Actual number of match='" + listOfSavePlanText.size() + "'",
				listOfSavePlanText.size() == expMatch);
	}
	...
	public void validateOnePlanSavedOnePlanUnsaved(String savePlanNames, String planType) {
		...
		Assert.assertTrue(
				"PROBLEM - scenario validation only support testing with two plans as input arguments, please update input and try again.  Input current has '"
						+ listOfTestPlans.size() + "' number of plans listed",
				listOfTestPlans.size() == 2);
		for (int i = 0; i < listOfTestPlans.size(); i++) {
			if (i == 0) {
				...
				System.out.println("Proceed to validate 'Save Plan' icon appeared again after unsaved plan");
				String savePlanLIconXpath = headerPath + "[contains(text(),'" + plan + "')]" + subPath
						+ "//button[contains(@class, 'savePlan') and contains(@style,'none')]" + savePlanImgXpath;
				// System.out.println("TEST - initial_savePlanLIconXpath
				// xpath="+savePlanLIconXpath);
				...
				System.out.println("Proceed to validate 'Save Plan' icon appeared again after unsaved plan");
				String savedPlanIconXpath = headerPath + "[contains(text(),'" + plan + "')]" + subPath
						+ "//button[contains(@class, 'savePlan') and not(contains(@style,'none')) and not(contains(@style,'block'))]"
						+ savePlanImgXpath;
				// System.out.println("TEST - savedPlanIconXpath
				// xpath="+savedPlanIconXpath);
				List<WebElement> listOfSavedPlanIcons = driver.findElements(By.xpath(savedPlanIconXpath));
				...
				System.out.println("Proceed to validate 'Save Plan' text appeared again after unsaved plan");
				String savePlanTextXpath = headerPath + "[contains(text(),'" + plan + "')]" + subPath
						+ "//button[contains(@class, 'savePlan') and not(contains(@style,'none')) and not(contains(@style,'block'))]"
						+ "/span[contains(text(),'Save plan')]";
				// System.out.println("TEST - savePlanTextXpath
				// xpath="+savePlanTextXpath);
				...
				expMatch = 1;
				Assert.assertTrue(
						"PROBLEM - unable to locate Save Plan text for ='" + plan + "'.  Expect number of match='"
								+ expMatch + "' | Actual number of match='" + listOfsavedPlanText.size() + "'",
						listOfsavedPlanText.size() == expMatch);
			}
		}
	}
	...
	public void validateEmailOption(String planType) {
		...
		Assert.assertTrue("PROBLEM - unable to locate success message after email is sent",
				validate(emailPlanSummarySuccessText));
		...
		Assert.assertTrue("PROBLEM - unable to locate success message after email is sent",
				validate(emailPlanSummarySuccessCloseButton));
	...
	public void validatePrintOption(String planType) {
		// note: the print function will bring up the print preview window where
		// the content can't be controlled by selenium
		// for now will only validate the print button will bring up the print
		// preview page
		...
		Assert.assertTrue(
				"PROBLEM - page title should have been the same after closing print preview.  \nBefore='"
						+ originalPageTitle + "' \nAfter='" + pageTitleAfterClosingPrintPreview + "'",
	...
	public String StartApplicationButton(String DateOfBirth, String FirstName, String LastName)
			throws InterruptedException {
		Thread.sleep(4000);
	...
	public MedSuppOLEPage StartApplication(String DateOfBirth) throws InterruptedException {
		...
		yearDrpDwn.click();
		waitforElementVisibilityInTime(yearDrpDwnOption, 45);
		yearDrpDwnOption.click();
		System.out.println("Effective date- year value selected");

		startDrpDwn.click();
		waitforElementVisibilityInTime(startDrpDwnOption, 45);
		startDrpDwnOption.click();
