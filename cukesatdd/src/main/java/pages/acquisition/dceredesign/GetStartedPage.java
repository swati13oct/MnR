...
public void yahooSearch(String searchParameter) {
	...
	@FindBy(xpath = "//*[contains(@id, 'modal')]//button[contains(@dtmname, 'review my drugs')]")
	public WebElement ReviewDrugsBtn;
