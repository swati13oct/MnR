...
public class CQPage extends UhcDriver{
	...
	public void validateVPPPages() {
		...
		//AARP pages
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/aarp/plan.html?page=summary");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/aarp/plan.html?page=detail#/zipcode");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/aarp/plan.html?page=portfolio");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/aarp/plan.html?page=compare");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/aarp/mapdmarketing.html");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/aarp/planmarketing.html");
		validateNew(vppContent);
		
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/tool-tip-configuration.html");
		validateNew(vppToolTip);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/CnSPlans.html");
		validateNew(cnsPlansContent);
		
		//UHC pages
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/uhc/plan.html?page=summary");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/uhc/plan.html?page=detail#/zipcode");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/uhc/plan.html?page=portfolio");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/uhc/plan.html?page=compare");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/uhc/mapdmarketing.html");
		validateNew(vppContent);
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/commontools/vpp/uhc/planmarketing.html");
		validateNew(vppContent);
	...
	public void validateAcqPages(){
		...
		//home page
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/aarpmedicareplans/en.html");
		validateAcqContent();
		
		//shop for a plan pages
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/aarpmedicareplans/en/health-plans/shop/medicare-advantage-plans.html");
		validateAcqContent();
	
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/aarpmedicareplans/en/health-plans/shop/prescription-drug-plans.html");
		validateAcqContent();
		
		//Understanding medicare pages
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/aarpmedicareplans/en/medicare-education/medicare-eligibility.html");
		validateAcqContent();
		
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/aarpmedicareplans/en/medicare-education/medicare-costs.html");
		validateAcqContent();
	
		//footer links pages
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/aarpmedicareplans/en/contact-us.html");
		validateAcqContent();
		
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/aarpmedicareplans/en/terms-of-use.html");
		validateAcqContent();
	...
	public void validateMemberPages(){
		...
		//login page
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/medicare/login.html");
		validateMemberPreSingInContent();
		
		//secondary pages
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/medicare/member/order-materials.html");
		validateMemberContent();
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/medicare/member/benefits.html");
		validateMemberContent();
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/medicare/member/payments.html");
		validateMemberContent();
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/medicare/member/claims.html");
		validateMemberContent();
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/medicare/member/health-and-wellness.html");
		validateMemberContent();
		driver.get("http://author-team-ucpcontent.ocp-ctc-dmz-nonprod.optum.com/content/medicare/member/eob.html");
		validateMemberContent();
