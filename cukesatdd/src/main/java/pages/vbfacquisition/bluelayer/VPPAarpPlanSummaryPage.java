...
import pages.vbfacquisition.ulayer.GetStartedPage;
import pages.vbfacquisition.ulayer.IntroductionInformationPage;
import pages.vbfacquisition.ulayer.ManageDrugPage;
import pages.vbfacquisition.ulayer.PageTitleConstants;
import pages.vbfacquisition.ulayer.PlanDetailsPage;
import pages.vbfacquisition.ulayer.PlanInformationPage;
import pages.vbfacquisition.ulayer.ProviderSearchPage;
...
public class VPPAarpPlanSummaryPage extends UhcDriver {
	...
	public PlanDetailsPage navigateToPlanDetails(String planName,
		...
		if (driver.getTitle().equalsIgnoreCase(PageTitleConstants.BLAYER_PLAN_DETAILS_AARP_MEDICARE_PLANS)
