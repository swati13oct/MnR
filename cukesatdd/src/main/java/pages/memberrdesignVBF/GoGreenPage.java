...
public class GoGreenPage extends UhcDriver {
	...
	public GoGreenPage(WebDriver driver) {
		...
		goGreen = CommonUtility.readPageData(fileName, CommonConstants.PAGE_OBJECT_DIRECTORY_BLUELAYER_MEMBER);
	...
	public void openAndValidate() {
		...
		for (String key : goGreen.getExpectedData().keySet()) {
			WebElement element = findElement(goGreen.getExpectedData().get(key));
			if (element != null) {
