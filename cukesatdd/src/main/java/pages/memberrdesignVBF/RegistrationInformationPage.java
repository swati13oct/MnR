...
public class RegistrationInformationPage extends UhcDriver {
	 ...
	 * create Account Confirm Registration
	 * 
	 * @FindBy(id = "accountConfirmation") private WebElement
	 *            accountConfirmation;
	 */
	...
	public void enterMemberID(String memberID) {
		...
		CommonUtility.waitForPageLoadNew(driver, memberid, 60);
		sendkeysNew(memberid, memberID);
	}
	...
	public void enterMonth(String month) {
		sendkeysNew(monthToEnterText, month);
	}
	...
	public void enterMedicareID(String medicare_id) {
		sendkeysNew(medicareID, medicare_id);
	}
	...
	public void clickExistingStartOver() {
		validateNew(existingStartOverLink);
	...
	public void clickFutureStartOver() {
		validateNew(futureStartOverLink);
	...
	public void clickInactiveStartOver() {
		validateNew(inactiveStartOverLink);
	...
	public void clickNotFoundStartOver() {
		validateNew(notFoundStartOverLink);
	...
	public void clickUserNameAndPasswordLink() {
		validateNew(usernameAndPasswordHelpLink);
	...
	public void clickSignInWithExistingLink() {
		validateNew(signInWithYourExistingCredentialsLink);
	...
	public void enterSecMemberID(String memberID) {
		sendkeysNew(additionalPlanMemberID, memberID);
	}
	...
	public void waitForAccountConfirmationPage() {
		CommonUtility.checkPageIsReadyNew(driver);
		CommonUtility.waitForPageLoadNew(driver, accountConfirmationText, 60);
	}
