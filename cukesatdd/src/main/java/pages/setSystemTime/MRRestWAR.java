...
public class MRRestWAR extends UhcDriver{
	...
	private static String PAGE_URL = MRConstants.SERVER_DATE_MR_REST_WAR;
	...
	public MRRestWAR(WebDriver driver, String month, String date, String year, String hours,String min, String seconds) {
		super(driver);
	...
	public void setSystemTime(String month, String date, String year, String hours,String min, String seconds){
		...
		if(confirmationPage.getText().contains("timedelegate is joda frozen")){
			System.out.println("Successfully changed MRRestWAR Time");
		}else{
			Assert.fail();
		}
