...
public class ClaimsSummaryPage extends ClaimsSummaryBase{
	...
	public void validateRallyClaims() {
		...
		//keep String expUrl2="systest3.myuhc.com"; //note: sometimes it's hard to find user that works on rally access also, let this pass if the user reaches this page also
		String actUrl=driver.getCurrentUrl();
		
		//keep Assert.assertTrue("PROBLEM - unable to land on expected claims page.  Expected landing URL to contains '"+expUrl+"' | Actual Url='"+actUrl+"'", actUrl.contains(expUrl) || actUrl.contains(expUrl2));
