...
public class PlanDocumentsAndResourcesWebElements extends UhcDriver  {
	...
	//--------------------------
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Individual')]//a[contains(text(),'Provider Search')]")
	...
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Individual')]//a[contains(text(),'Provider Search')]//img")
	...
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Individual')]//a[contains(text(),'Provider Search')]//following-sibling::p")
	...
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Individual')]//a[contains(text(),'Pharmacy Locator')]")
	...
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Individual')]//a[contains(text(),'Pharmacy Locator')]//img")
	...
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Individual')]//a[contains(text(),'Pharmacy Locator')]//following-sibling::p")
	...
	//----
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Group')]//a[contains(text(),'Provider Search')]")
	...
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Group')]//a[contains(text(),'Provider Search')]//img")
	...
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Group')]//a[contains(text(),'Provider Search')]//following-sibling::p")
	...
	//tbd @FindBy(xpath="//div[contains(@class,'calloutBoth_AD_Group')]//a[contains(text(),'Pharmacy Locator')]")
