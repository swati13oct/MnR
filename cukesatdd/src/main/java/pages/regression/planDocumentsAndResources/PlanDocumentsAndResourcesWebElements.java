...
public class PlanDocumentsAndResourcesWebElements extends UhcDriver  {
	...
	@FindBy(xpath="//div[contains(@class,'Directories_') and not(contains(@class,'ng-hide'))]//div[(contains(@class,'Pharmacy_Provider') or contains(@class,'rovider') or contains(@class,'_PE') or contains(@class,'_AD_Group')) and not(contains(@class,'ng-hide'))]//a[contains(text(),'Provider Search')]")
	protected WebElement providerSearch_link_PD;

	@FindBy(xpath="//div[contains(@class,'Directories_') and not(contains(@class,'ng-hide'))]//div[(contains(@class,'Pharmacy_Provider') or contains(@class,'rovider') or contains(@class,'_PE') or contains(@class,'_AD_Group')) and not(contains(@class,'ng-hide'))]//a[contains(text(),'Provider Search')]//img")
	protected WebElement providerSearch_link_img;
	
	@FindBy(xpath="//div[contains(@class,'Directories_') and not(contains(@class,'ng-hide'))]//div[(contains(@class,'Pharmacy_Provider') or contains(@class,'rovider') or contains(@class,'_PE') or contains(@class,'_AD_Group')) and not(contains(@class,'ng-hide'))]//a[contains(text(),'Provider Search')]//following-sibling::p")
	protected List<WebElement> providerSearch_instr_PD;
	
	@FindBy(xpath="//div[contains(@class,'Directories_') and not(contains(@class,'ng-hide'))]//div[(contains(@class,'Pharmacy_Provider') or contains(@class,'Pharmacy')  or contains(@class,'_PE') or contains(@class,'_AD_Group')) and not(contains(@class,'ng-hide'))]//a[contains(text(),'Pharmacy Locator')]")
	protected WebElement pharmacyLocator_link_PD;

	@FindBy(xpath="//div[contains(@class,'Directories_') and not(contains(@class,'ng-hide'))]//div[(contains(@class,'Pharmacy_Provider') or contains(@class,'Pharmacy')  or contains(@class,'_PE') or contains(@class,'_AD_Group')) and not(contains(@class,'ng-hide'))]//a[contains(text(),'Pharmacy Locator')]//img")
	protected WebElement pharmacyLocator_link_img;

	@FindBy(xpath="//div[contains(@class,'Directories_') and not(contains(@class,'ng-hide'))]//div[(contains(@class,'Pharmacy_Provider') or contains(@class,'Pharmacy')  or contains(@class,'_PE') or contains(@class,'_AD_Group')) and not(contains(@class,'ng-hide'))]//a[contains(text(),'Pharmacy Locator')]//following-sibling::p")
