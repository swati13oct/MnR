...
public class PharmacySearchPage extends UhcDriver{
	...
	//tbd-remove @FindBy(xpath = "//area[@href='javascript:clWin()'][@alt = 'close']")
	//tbd-remove private WebElement FeedbackModal;
	...
	public PharmacySearchPage(WebDriver driver) {
		...
		//tbd-remove CommonUtility.checkPageIsReady(driver);
		try {
			Thread.sleep(2000);
	...
	public PharmacySearchPage selectsPharmacy(String givenPharmacyTypes) throws InterruptedException {
		String[] pharmacyTypeArray = givenPharmacyTypes.split(",");
		CommonUtility.checkPageIsReady(driver);
		//tbd-remove pharmacyTypeSelectionRadioButton.click();
		CommonUtility.waitForElementToDisappear(driver, loadingImage, 60);
	...
	public PharmacySearchPage enterDistanceZipDetails(String distance, String zipcode) throws InterruptedException {
		...
		String DistanceSelection = distance+" miles";
		select.selectByVisibleText(DistanceSelection);
		/* tbd-remove                          driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
                              CommonUtility.checkPageIsReady(driver);
                              zipcodeField.clear();
		 */                          Thread.sleep(50000);
		 CommonUtility.checkPageIsReady(driver);
	...
	public PharmacySearchPage ValidateSearchPdfResult() throws InterruptedException {
		Thread.sleep(10000);
		//tbd-remove Thread.sleep(160000);
		CommonUtility.checkPageIsReady(driver);
		if (viewsearchpdf.isDisplayed()) {
			viewsearchpdf.click();
			Thread.sleep(20000);
			//tbd-remove Thread.sleep(200000);
			CommonUtility.checkPageIsReady(driver);
	...
	*/
	...
	/** navigate pharmacy tool via aarp acquistion site */
	...
	/** navigate pharmacy tool via UHC acquistion site */
	...
	public PharmacySearchPage enterZipDistanceDetails(String zipcode, String distance, String county) throws InterruptedException {
		...
		//tbd-remove selectFromDropDown(distanceDropDown, distance);
		//tbd-remove continueField.click();
		CommonUtility.checkPageIsReady(driver);
