...
public class PharmacySearchWebElements extends UhcDriver{
	...
	@FindBy(xpath="//a[contains(@href,'/member/contact-us/overview.html')][contains(text(), 'contact UnitedHealthcare')]|//a[contains(@href,'contact-us.html')][contains(text(), 'UnitedHealthcare')]|//a[contains(@href,'/member/contact-us/overview.html')][contains(text(), 'comuníquese con UnitedHealthcare')]")
