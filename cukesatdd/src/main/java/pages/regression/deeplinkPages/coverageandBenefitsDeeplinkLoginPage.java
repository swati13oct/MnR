 ...
 *
 */
public class coverageandBenefitsDeeplinkLoginPage extends UhcDriver {
	...
	//page from MR constants 	
			private static String STAGE_DEEPLINK_URL_coverageandBenefit = MRConstants.STAGE_DEEPLINK_URL_coverageandBenefit;
			
			 /*This method will open deep link page */
			public coverageandBenefitsDeeplinkLoginPage navigateToLoginURL(){
				start(STAGE_DEEPLINK_URL_coverageandBenefit);
			...
			/*This method will enter user name & password */
			  ...
			  /*Click continue & answer security question & covid page */
				...
				public boolean validateCoverageBenefitPage() {
					...
					if (driver.getCurrentUrl().contains("benefits/overview.html?deeplink=true")) {
						System.out.println("*** Page URL ***" + driver.getCurrentUrl());
						System.out.println("** User landed on Coverage & Benefits deeplink Page **");
						System.out.println("*** PageTitle ***" + driver.getTitle());
						Assert.assertTrue(driver.getTitle().contains("Plan Benefits Summary"));
						return true;
						} else {
