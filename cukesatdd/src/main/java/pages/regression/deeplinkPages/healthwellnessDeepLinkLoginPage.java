 ...
 *
 */
public class healthwellnessDeepLinkLoginPage extends UhcDriver {
	...
	public healthwellnessDeepLinkLoginPage(WebDriver driver) {
		super(driver);
	...
	//page from MR constants 	
			private static String STAGE_DEEPLINK_URL_health_and_wellness = MRConstants.STAGE_DEEPLINK_URL_health_and_wellness;
			
			 /*This method will open deep link page */
			public healthwellnessDeepLinkLoginPage navigateToLoginURL(){
				start(STAGE_DEEPLINK_URL_health_and_wellness);
			...
			/*This method will enter user name & password */
			  ...
			  /*Click continue & answer security question & covid page */
				...
				public boolean validateHealthWellnessPage() {
					...
					if (driver.getCurrentUrl().contains("health-and-wellness.html?deeplink=true")) {
						System.out.println("*** Page URL ***" + driver.getCurrentUrl());
						System.out.println("** User landed on health and wellness deeplink Page **");
						System.out.println("*** PageTitle ***" + driver.getTitle());
						Assert.assertTrue(driver.getTitle().contains("Health And Wellness"));
						return true;
						} else {
