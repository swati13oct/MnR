 ...
 *
 */
public class OfflineProd_VirtualVisitDeeplinkLoginPage extends UhcDriver {
	...
	public OfflineProd_VirtualVisitDeeplinkLoginPage(WebDriver driver) {
		super(driver);
	...
	public static final String Offline_PROD_UHC_DEEPLINK_URL_VirtualVisit = MRConstants.Offline_PROD_UHC_DEEPLINK_URL_VirtualVisit;
	...
	public OfflineProd_VirtualVisitDeeplinkLoginPage navigateToLoginURL(String brand) {
		switch (brand) {
		case "UHC":
			start(Offline_PROD_UHC_DEEPLINK_URL_VirtualVisit);
			break;
		case "AARP":
			start(Offline_PROD_AARP_DEEPLINK_URL_VirtualVisit);
			break;
		case "PCP":
			start(Offline_PROD_PCP_DEEPLINK_URL_VirtualVisit);
			break;
		case "Medica":
			start(Offline_PROD_Medica_DEEPLINK_URL_VirtualVisit);
			break;
		}
	...
	public boolean validateOfflineProdVirtualVisitPage() {
		...
		if (driver.getCurrentUrl().contains("SMSR/virtualvisits")) {
			...
			Assert.fail("VirtualVisit Login page for offline PROD is not loaded through deeplink");
		}
		return true;
	}
