...
public class TravelMobilePage extends UhcDriver {
	...
	public void travelpageElements() {
		...
		//Assertion.assertTrue(travelPagePrimaryQuestion.getText().contains("your life"));
		validate(travelPagePrimaryQuestionMark);
		validate(travelPagePrimaryQuestionDecsription);
		validate(travelOftenOption, 30);
		//Assertion.assertTrue(travelOftenOption.getText().contains("travel"));
		validate(travelAnotherPartOption, 30);
		//Assertion.assertTrue(travelAnotherPartOption.getText().contains("another part"));
		validate(travelRegularHealthOption, 30);
		//Assertion.assertTrue(travelRegularHealthOption.getText().contains("care away"));
		validate(travelNoneOption, 30);
		//Assertion.assertTrue(travelNoneOption.getText().contains("None"));
