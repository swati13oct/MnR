...
// Additional Services page Elements
	...
	public void additionalpage(String drugInfo) {
		...
		//Assertion.assertTrue(additionalPagePrimaryQuestion.getText().contains("additional"));
		validate(additionalPagePrimaryQuestionDecsription);
		//Assertion.assertTrue(additionalPagePrimaryQuestionDecsription.getText().contains("additional"));
