 ...
 *
 */
public class ConfirmYourEligibilityPageMobile extends UhcDriver{
	...
	//@FindBy(css = "#confirmEligibilityh3")
	...
	public ConfirmYourEligibilityPageMobile(WebDriver driver) {
		super(driver);
