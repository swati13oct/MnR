...
public class SelectGenericPageMobile extends UhcDriver {
	...
	public SelectGenericPageMobile(WebDriver driver) {
		super(driver);
	...
	public ManageDrugPageMobile selectGeneric(String drugDosage) {
