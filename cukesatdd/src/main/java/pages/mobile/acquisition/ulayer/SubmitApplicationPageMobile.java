...
public class SubmitApplicationPageMobile extends UhcDriver{
	...
	public SubmitApplicationPageMobile(WebDriver driver) {
		super(driver);
	...
	public EnrollmentConfirmationPageMobile submitsApplication() {
		...
		if (pageHeading.getText().equalsIgnoreCase(
			...
			return new EnrollmentConfirmationPageMobile(driver);
		}
		return null;
