...
public class Deprecated_PharmacySearchPageMobile extends UhcDriver {
	...
	public Deprecated_PharmacySearchPageMobile(WebDriver driver) {
		super(driver);
	...
	public Deprecated_PharmacyResultPageMobile searchesPharmacy() {
	...
	public Deprecated_PharmacyResultPageMobile showAllPharmacies() {
		allPharmacies.click();
		searchPharmaciesButton.click();
		for(int i=0;i<10;i++){
			try {
	...
	public Deprecated_PharmacySearchPageMobile showParticularService() {
		particularServices.click();
		return new Deprecated_PharmacySearchPageMobile(driver);
	}

	public Deprecated_PharmacyResultPageMobile clickOnContinue() {
		btnContinue.click();
		return new Deprecated_PharmacyResultPageMobile(driver);
	}

	public Deprecated_PharmacyResultPageMobile selectAPlan(String planName) {
	...
	public Deprecated_PharmacyResultPageMobile searchSelectingPharmacyTypes(String[] pharmacyTypeArray) {
	...
	public Deprecated_PharmacyResultPageMobile ValidateShowOnMapResult() {
	...
	public Deprecated_PharmacyResultPageMobile ValidateSearchPdfResult() {
	...
	public Deprecated_PharmacySearchPageMobile ValidateSearchResultMapd() {
	...
	public Deprecated_PharmacySearchPageMobile enterDistanceZipCountyDetails(String distance, String zipcode, String county) {
		CommonUtility.checkPageIsReady(driver);
	...
	public Deprecated_PharmacySearchPageMobile verifyPharmacyErrormessages(String inputZip) {
	...
	public Deprecated_PharmacySearchPageMobile validateShowOnMapLinks() {
		CommonUtility.checkPageIsReady(driver);
	...
	public Deprecated_PharmacySearchPageMobile clickChinese() {
		CommonUtility.checkPageIsReady(driver);
	...
	public Deprecated_PharmacySearchPageMobile selectspanLanguage() {
		CommonUtility.checkPageIsReady(driver);
	...
	public Deprecated_PharmacySearchPageMobile multilangPharmacySearchResult() {
		CommonUtility.checkPageIsReady(driver);
	...
	public void Select_PlanType_Filter(String pharmacyType, String language) {
		...
		public void validatePharmacyWidgets(String planType, String memberType,String planName, 
			...
			public Deprecated_PharmacySearchPageMobile validateGetDirectionLinks() {
				CommonUtility.checkPageIsReady(driver);
