...
public class PDPEnrollementGuidePageMobile extends UhcDriver{
	...
	public PDPEnrollementGuidePageMobile(WebDriver driver) {
		super(driver);
	...
	public EnquiryKitConfirmationPageMobile submitsRequest() {
		...
		if(currentUrl().contains("inquirykitconfirmation.html")){
			return  new EnquiryKitConfirmationPageMobile(driver);
		}
		return null;
