...
public class VisitorProfileTestHarnessPageMobile extends UhcDriver {
	...
	public VisitorProfileTestHarnessPageMobile(WebDriver driver) {
		super(driver);
	...
	public VisitorProfilePageMobile NavigateToVP_from_SaveplansinGuestprofileLink() {
	...
	public VisitorProfilePageMobile DeleteplaninVisitorProfile(String HpbpNum) {
	...
	public VisitorProfilePageMobile NavigateToVP_from_SaveplansinauthenticatedprofileLink(String UUID, String isguest) {
		validateNew(Uuid);
		sendkeys(Uuid, UUID);
	...
	public VisitorProfilePageMobile NavigateToVP_from_LaunchVPwithDrugandPharmacyInfoLink() {
	...
	public VisitorProfilePageMobile NavigateToVP_from_LaunchVPwithProvidersLink() {
	...
	public ComparePlansPageMobile NavigateToPlanCompareFromVpTest(String Zipcode, String PlanIds) {
	...
	public PlanDetailsPageMobile NavigateToPlanDetailsFromVpTest(String Zipcode, String CNum, String Pnum, String Snum,
	...
	public VisitorProfilePageMobile DeleteDrugAndPharamacy() {
	...
	public VisitorProfilePageMobile DeleteProvider() {
