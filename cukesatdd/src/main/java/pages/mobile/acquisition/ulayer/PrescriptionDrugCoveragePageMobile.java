 ...
 * @author pperugu
 *c */
public class PrescriptionDrugCoveragePageMobile extends UhcDriver{	
	...
	public PrescriptionDrugCoveragePageMobile(WebDriver driver) {
	...
	public void enterspdcInformation(
		...
		public LongTermCarePageMobile navigatesToNextStep() {
