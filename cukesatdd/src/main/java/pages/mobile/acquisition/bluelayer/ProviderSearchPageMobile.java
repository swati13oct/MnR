...
public class ProviderSearchPageMobile extends UhcDriver {
	...
	public VPPPlanSummaryPageMobile selectsProvider(String physicianSearchCriteria,
...
public PlanDetailsPageMobile selectsProviderFromVppPlanDetailsPage() {
	...
	public VPPTestHarnessPageMobile selectsProviderNavigateBacktoTestharness() {
		GetStarted.click();
