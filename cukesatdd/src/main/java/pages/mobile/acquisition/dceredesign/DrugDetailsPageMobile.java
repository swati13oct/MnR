...
public class DrugDetailsPageMobile extends UhcDriver {
	...
	@FindBy(xpath = "//span[contains(text(),'View Plan Details')]")
	...
	public void ValidatesDrugsTier_Limits_ImportantInfo() {
		...
		WebElement PA_PDF_Link = driver.findElement(By.xpath(
				"//h3[contains(text(), 'Plan Formulary')]/following::a[contains(@dtmname, 'prior authorization')]"));
