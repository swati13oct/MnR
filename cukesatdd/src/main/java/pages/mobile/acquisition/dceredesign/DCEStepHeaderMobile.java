...
public class DCEStepHeaderMobile extends UhcDriver {
	...
	public DCEStepHeaderMobile(WebDriver driver) {
		super(driver);
		PageFactory.initElements(driver, this);
		// CommonUtility.waitForPageLoad(driver, addDrugDetailsPageMobile, 10);
		openAndValidate();
	}
	...
	public BuildYourDrugListMobile ClickStep2_NavigateDrugListPage() {
		validateNew(StepHeader_Step2);
	...
	public DrugDetailsPageMobile ClickStep3_NavigateDrugDetailsPage() {
		validateNew(StepHeader_Step3);
	...
	public DrugSummaryPageMobile ClickStep3_NavigateDrugSummaryPage() {
		validateNew(StepHeader_Step3);
		jsClickNew(StepHeader_Step3);
		waitForPageLoadSafari();
		threadsleep(2000);
