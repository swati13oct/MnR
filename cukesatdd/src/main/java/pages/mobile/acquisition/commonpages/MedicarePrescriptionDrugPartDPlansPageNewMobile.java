...
public class MedicarePrescriptionDrugPartDPlansPageNewMobile extends GlobalWebElements {
    public MedicarePrescriptionDrugPartDPlansPageNewMobile(WebDriver driver) {
        super(driver);
    ...
    public HowtoEnrollinMedicarePageMobile clickOnHowToEnroll() {
        sleepBySec(2);
