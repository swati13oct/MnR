...
public class MedicarePrescriptionDrugPartDPlansPageMobile extends GlobalWebElements {

	public MedicarePrescriptionDrugPartDPlansPageMobile(WebDriver driver) {
		super(driver);
