...
public class AcquisitionHomePageMobile extends GlobalWebElements {
	...
	public VPPPlanSummaryPageMobile addPlansForVisitorProfile(String zipcode) {
	...
	public AcquisitionHomePageMobile validateCallpopup() throws InterruptedException {
	...
	public AcquisitionHomePageMobile validateChatpopup() throws InterruptedException {
		// CommonUtility.checkPageIsReady(driver);
		chatsam.click();
