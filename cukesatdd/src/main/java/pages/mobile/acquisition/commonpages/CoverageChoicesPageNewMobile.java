...
import pages.acquisition.commonpages.PrescriptionProviderBenefitsPageNew;

import java.util.List;

public class CoverageChoicesPageNewMobile extends GlobalWebElements {
    public CoverageChoicesPageNewMobile(WebDriver driver) {
        super(driver);
    ...
    public PrescriptionProviderBenefitsPageNewMobile clickOnBenifitsLink() {
