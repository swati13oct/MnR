...
public class LongTermCarePageMobile extends UhcDriver{
	...
	public LongTermCarePageMobile(WebDriver driver) {
		super(driver);
	...
	public MedicaidPageMobile navigatesToNextStepMAorMAPD() {
