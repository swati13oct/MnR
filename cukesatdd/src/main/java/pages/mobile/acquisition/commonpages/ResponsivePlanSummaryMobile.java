...
//Plan Costs
	...
	public ResponsivePlanSummaryMobile(WebDriver driver) {
		super(driver);
	...
	public ResponsivePlanSummaryMobile(WebDriver driver, String url) {
		super(driver);
		PageFactory.initElements(driver, this);
		String fileName = CommonConstants.VPP_PLAN_SUMMARY_PAGE_DATA;
		vppPlanSummary = CommonUtility.readPageData(fileName, CommonConstants.PAGE_OBJECT_DIRECTORY_ULAYER_ACQ);
...
public ResponsivePlanSummaryMobile viewPlanSummary(String planType) {
//	JavascriptExecutor js = (JavascriptExecutor)driver;
	try {
		Thread.sleep(4000);
	} catch (InterruptedException e) {
...
public void comparePlanslnk() throws InterruptedException{
	...
	public ResponsivePlanSummaryMobile validatePlanHighlights(){
	 ...
	 */
	 ...
	 public void validateCountyName(String CountyName)  {
		...
		public PlanSelectorPageMobile navigateToPlanSelectorPage(){
			 planSelector.click();
			 try {
				Thread.sleep(10000);
			} catch (InterruptedException e) {
		...
		public Rallytool_Page navigateToRallyPage(String planName) { 
		 ...
		 public void selectPlansToCompareTwoPlans(String planName1, String planName2){
			 ...
			 public GetStartedPageMobile estimateYourDrugs(String planName){
				//	int i=0;
					List<WebElement> plans = driver.findElements(By.xpath("//h2[contains(text(),'AARP')]"));
					System.out.println("PLANS SIZE :: "+plans.size());
...
*/					
				...
				public VPPPlanSummaryPageMobile clicksOnEnterDrugInformationLink(String planName) {
				 ...
				 public VPPPlanSummaryPageMobile planYear() throws InterruptedException{
                     Thread.sleep(10000);
                     planYear.click();
                         //showMaPlans.click();
                         return null;
				 ...
				 public VPPPlanSummaryPageMobile verifyEnrollNowbtn2017(){
				 ...
				 public PlanComparePageMobile navigateToPlanCompare(String planName){
