...
public class ComparePlansPageBlayerMobile extends UhcDriver {
	...
	public ComparePlansPageBlayerMobile(WebDriver driver) {
		super(driver);
...
public VPPPlanSummaryPageMobile clickOnNewAddIcon(){
     ...
     public ComparePlansPageBlayerMobile validateCallSam() throws InterruptedException {
         boolean present;
         try {
         validateNew(callsam);
         present = true;
 	...
 	public ComparePlansPageBlayerMobile validateCallSamContent() throws InterruptedException {
 	...
 	public ComparePlansPageBlayerMobile validateChatSam() throws InterruptedException {
         boolean present;
         try {
         validateNew(chatsam);
         present = true;
 	...
 	public ComparePlansPageBlayerMobile validateChatSamContent() throws InterruptedException {
 	...
 	public ComparePlansPageBlayerMobile  validateChatpopup() throws InterruptedException {
 		//CommonUtility.checkPageIsReady(driver);
 		chatsam.click();
 	...
 	public ComparePlansPageBlayerMobile navigateToPlanDetailfromplanCompare() {
