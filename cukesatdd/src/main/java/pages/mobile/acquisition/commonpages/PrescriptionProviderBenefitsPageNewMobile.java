...
import pages.acquisition.commonpages.CostBasicsPageNew;
import pages.acquisition.commonpages.GlobalWebElements;
import pages.acquisition.commonpages.LearnAboutMedicareHomePageNew;

import java.util.List;

public class PrescriptionProviderBenefitsPageNewMobile extends GlobalWebElements {
    public PrescriptionProviderBenefitsPageNewMobile(WebDriver driver) {
        super(driver);
    ...
    public CostBasicsPageNewMobile clickOnCostBasicsLink() {
