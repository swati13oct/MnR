...
public class MedicareSupplementInsurancePlansPageNewMobile extends GlobalWebElements {
    public MedicareSupplementInsurancePlansPageNewMobile(WebDriver driver) {
        super(driver);
