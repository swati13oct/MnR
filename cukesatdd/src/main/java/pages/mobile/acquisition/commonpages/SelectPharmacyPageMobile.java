...
public class SelectPharmacyPageMobile extends UhcDriver {
	...
	public SelectPharmacyPageMobile(WebDriver driver) {
		super(driver);
	...
	public SelectPharmacyPageMobile searchPharmacies(String pharmacyType,
			String distance) {
