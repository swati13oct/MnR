...
import pages.acquisition.commonpages.CoverageChoicesPageNew;
import pages.acquisition.commonpages.GlobalWebElements;
import pages.acquisition.commonpages.LearnAboutMedicareHomePageNew;

import java.util.List;

public class MedicareEligibilityPageNewMobile extends GlobalWebElements {
    public MedicareEligibilityPageNewMobile(WebDriver driver) {
        super(driver);
   ...
   /* public void checkInpageNavigation() {
    ...
    public CoverageChoicesPageNewMobile clickOnCoverageChoiceLink() {
