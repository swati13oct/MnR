...
public class AddNewDrugModalMobile extends UhcDriver {
	...
	public AddDrugDetailsMobile searchDrugWithoutAutoComplete(String DrugName) throws InterruptedException {
	...
	public AddDrugDetailsMobile searchDrugWithAutoComplete(String drug) {
