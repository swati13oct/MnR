...
public class EnterDrugPageMobile extends UhcDriver {
	...
	public EnterDrugPageMobile(WebDriver driver, boolean skipClick, String drugName) {
		super(driver);
	...
	public EnterDrugPageMobile(WebDriver driver) {
		super(driver);
	}
	...
	public EnterDrugPageMobile enterDrugName(String drugName) {
		...
		* If this happens and the page is already on the Drug Details page, send true*/
		...
		if (title.contains(
				"search")){
			return new EnterDrugPageMobile(driver, skipClick, drugName);
		}
		return null;
