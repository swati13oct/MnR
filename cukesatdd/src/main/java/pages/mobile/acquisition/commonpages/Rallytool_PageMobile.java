...
public class Rallytool_PageMobile extends UhcDriver {
	...
	public void openAndValidate(){
		...
		public Rallytool_PageMobile(WebDriver driver) {
			super(driver);
		...
		public CalpersHomePageMobile switchBack() {
			...
			{
				return new CalpersHomePageMobile(driver);
			}
	...
	public SdceraHomePage switchsdceraBack() {
		...
		public CalperFindaProviderPageMobile switchBackToCalperFindaProvider() {
			ArrayList<String> tabs = new ArrayList<String> (driver.getWindowHandles());
			driver.switchTo().window(tabs.get(0));
