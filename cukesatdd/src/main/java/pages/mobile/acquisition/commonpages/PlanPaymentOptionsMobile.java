...
public class PlanPaymentOptionsMobile extends UhcDriver{
	...
	public PlanPaymentOptionsMobile(WebDriver driver) {
		super(driver);
	...
	public OptionalRidersPageMobile navigatesToNextStepMAPDorMA() {
		pposaveandcont.click();
				return new OptionalRidersPageMobile(driver);
	
		}
	
	public ProposedEffectiveDatePageMobile navigatesToNextStepPDP() {
		pposaveandcont.click();
			return new ProposedEffectiveDatePageMobile(driver);

	}

	public OptionalRidersPageMobile clickdisclaimerbutton() {
