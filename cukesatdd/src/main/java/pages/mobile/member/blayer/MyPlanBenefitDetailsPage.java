 ...
 *
 */
public class MyPlanBenefitDetailsPage extends UhcDriver {
	...
	@FindBy(xpath = "//*[@id='wrapper']/div[1]/div[3]/div/div/div/div/div/div[2]/h1")
	private WebElement myMedicalBenefitText;

	private PageData browserCheckData;

	private JSONObject browserCheckJson;

	public MyPlanBenefitDetailsPage(WebDriver driver) {
		super(driver);
