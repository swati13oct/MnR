...
import pages.deprecated.acquisition.ulayer.BeneficiaryInformationPage;
import pages.deprecated.acquisition.ulayer.ConfirmationPage;
import pages.deprecated.acquisition.ulayer.ESRDPage;
import pages.deprecated.acquisition.ulayer.IntroductionInformationPage;
import pages.deprecated.acquisition.ulayer.LongTermCarePage;
import pages.deprecated.acquisition.ulayer.MedicaidPage;
import pages.deprecated.acquisition.ulayer.OptionalRidersPage;
import pages.deprecated.acquisition.ulayer.OtherHealthInsurancePage;
import pages.deprecated.acquisition.ulayer.PlanPaymentOptions;
import pages.deprecated.acquisition.ulayer.PrescriptionDrugCoveragePage;
import pages.deprecated.acquisition.ulayer.PrimaryCareProviderPage;
import pages.deprecated.acquisition.ulayer.ProposedEffectiveDatePage;
import pages.deprecated.acquisition.ulayer.ReviewAndSubmitPage;
import pages.deprecated.acquisition.ulayer.SpecialElectionPeriodPage;
...
public class EnrollInPlanAarpStepDefinition {
	...
	public void user_performs_planSearch_in_aarp_site(DataTable givenAttributes) {
		...
		VPPPlanSummaryPage plansummaryPage = new VPPPlanSummaryPage(wd);// VPPPlanSummaryPage
																		// plansummaryPage
																		// =
																		// (VPPPlanSummaryPage)
																		// getLoginScenario()
	...
	public void user_fill_information_plan_payment_options_aarp_step_aarp(
		...
		if (!hasEnrolled) {
			...
			IntroductionInformationPage introPage = (IntroductionInformationPage) getLoginScenario()
					.getBean(PageConstants.INTRODUCTION_INFORMATION_PAGE);
			PlanPaymentOptions ppoPage = (PlanPaymentOptions) getLoginScenario()
					.getBean(PageConstants.PLAN_PAYMENT_OPTION_PAGE);
	...
	/*
	 * public void tearDown() { WebDriver wd = (WebDriver)
	 * getLoginScenario().getBean( CommonConstants.WEBDRIVER); wd.quit();
