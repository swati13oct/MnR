...
public class MemberAuthStepDefinition {
	...
	public void click_on_the_member_displayed_in_the_search_list() throws InterruptedException {
		MemberInformationPage memberInformationPage = (MemberInformationPage) getLoginScenario()
				.getBean(PageConstants.MEMBER_AUTH_INFORMATION_PAGE);
	...
	public void i_will_see_the_disclaimer_text_at_top_of_the_page(DataTable givenAttributes) {
		...
		if (contactUsPage != null) {
			...
			Assert.assertTrue("@@@Disclaimer test:" + message + " -- is not displayed@@@",
