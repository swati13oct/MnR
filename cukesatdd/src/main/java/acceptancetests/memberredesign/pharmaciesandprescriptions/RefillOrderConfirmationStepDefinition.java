...
public class RefillOrderConfirmationStepDefinition {
	...
	public void user_will_see_Refill_order_confirmation_page() throws Throwable {
	    OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Order Confirmation Page is not displaced",orderConfirmationPage.validateOrderConfirmationThankyouMessage());	    
	}
	...
	public void user_will_see_order_number() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Order Number is not displayed on Order Confirmation Page",orderConfirmationPage.validateOrderNumber());	    	    
	}
	...
	public void user_will_see_order_placed_date() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Order Placed Date is not displayed on Order Confirmation Page",orderConfirmationPage.validateOrderPlacedDate());	    
	}
	...
	public void user_will_see_order_tracked_as_Order_Received() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Order Tracker as Order Received is not displayed on Order Confirmation Page",orderConfirmationPage.validateOrderPlacedDate());	    
	}
	...
	public void user_will_see_order_confirmation_email_messaging() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
					.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
		    Assert.assertTrue("PROBLEM - Order Confirmation Email Message is not displayed on Order Confirmation Page",orderConfirmationPage.validateEmailConfirmationMessage());	    
	}
	...
	public void user_will_see_Oreder_Confirmation_section() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Order Confirmaction section is not displayed on Order Confirmation Page",orderConfirmationPage.validateOrderConfirmation());    
	}
	...
	public void user_will_see_the_shipping_method_displayed() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Shipping method is not displayed on Order Confirmation Page",orderConfirmationPage.validateShippingMethod());	    
	}
	...
	public void user_will_see_the_shipping_address_displayed() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Shipping address is not displayed on Order Confirmation Page",orderConfirmationPage.validateShippingAddress());	    
	}
	...
	public void user_will_see_the_payment_method_displayed() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - payment method is not displayed on Order Confirmation Page",orderConfirmationPage.validatePaymentMethod());	    
	}
	...
	public void user_will_see_the_order_total_displayed() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Order Total is not displayed on Order Confirmation Page",orderConfirmationPage.validateOrderTotal());	    
	}
	...
	public void user_will_see_an_order_total_disclaimer_displayed() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Order Total Disclaimer is not displayed on Order Confirmation Page",orderConfirmationPage.validateOrderTotalDisclaimer());	    
	}
	...
	public void user_will_see_the_estimated_delivery_date() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Estimated Delivery Date is not displayed on Order Confirmation Page",orderConfirmationPage.validateEstimatedDeliveryDate());	    
	}
	...
	public void user_view_the_Medications_section() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Medication Section is not displayed on Order Confirmation Page",orderConfirmationPage.validateMedicationSection());	    	    
	}
	...
	public void user_will_see_the_drug_name_and_strength() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Drug Name and Strength is not displayed on Order Confirmation Page",orderConfirmationPage.validateDrugNameAndStrength());	    
	}
	...
	public void user_will_see_the_day_supply() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Day supply is not displayed on Order Confirmation Page",orderConfirmationPage.validateDaySupply());	    
	}
	...
	public void user_will_view_the_price() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Drug Price is not displayed on Order Confirmation Page",orderConfirmationPage.validateDrugPrice());	    
	}
	...
	public void user_will_view_the_Rx_number() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Drug Price is not displayed on Order Confirmation Page",orderConfirmationPage.validateRxNumber());   
	}
	...
	public void user_will_view_the_provider() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Drug Price is not displayed on Order Confirmation Page",orderConfirmationPage.validateRxProviderName());	    
	}
	...
	public void user_will_view_the_remaining_refills() throws Throwable {
		OrderConfirmationPage orderConfirmationPage = (OrderConfirmationPage) getLoginScenario()
				.getBean(PageConstants.CHECKOUT_SUMMARY_PAGE);
	    Assert.assertTrue("PROBLEM - Drug Price is not displayed on Order Confirmation Page",orderConfirmationPage.validateRxRefillsLeft());	    
	}
	...
	public void the_page_should_be_refreshed_so_that_the_status_of_this_refill_and_CTA_are_updated_per_this_refill_transaction() throws Throwable {	
		PharmaciesAndPrescriptionsPage pnpPg = (PharmaciesAndPrescriptionsPage) getLoginScenario()
				.getBean(PharmaciesAndPrescriptionsCommonConstants.PHARMACIES_AND_PRESCRIPTIONS_PAGE);
		pnpPg.refreshPnPPage();
		//
		getLoginScenario().saveBean(PharmaciesAndPrescriptionsCommonConstants.PHARMACIES_AND_PRESCRIPTIONS_PAGE, pnpPg);	    
	}
}
