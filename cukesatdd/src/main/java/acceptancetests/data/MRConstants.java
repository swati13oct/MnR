...
public class MRConstants {
	...
	// "https://www.awe-"+MRScenario.environment+"-aarpmedicareplans." +
	// getDomain() + "/";
	...
	// "https://www."+MRScenario.environment+"-uhcmedicarsolutions." +
	// getDomain() + "/";
	...
	// "https://www."+MRScenario.environment+"-uhcmedicaresolutions." +
	// getDomain() +
	// "/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/ma-drug-transition.html";
	 ...
	 * "-uhcmedicaresolutions.uhc.com/guest/registration.html"; public static
	 * final String MEMBER_AUTH_REDESIGN_LOGIN_URL =
	 * "https://awe-stage-generic.uhc.com/content/medicare/memberauth.html ";
	 * public static final String REDESIGN_REGISTRATION_URL =
	...
	// +"-medicare."+MRScenario.domain+"/?testharness=true";
	...
	public static String AARP_GUEST_PAYMENTS_PAGE_URL = "https://team-predators-medicare.ocp-elr-core-nonprod.optum.com/premium-payment//#/";
	public static String UHC_GUEST_PAYMENTS_PAGE_URL = "https://team-predators-medicare.ocp-elr-core-nonprod.optum.com/premium-payment//#/";
	public static String RETIREE_GUEST_PAYMENTS_PAGE_URL = "https://team-predators-medicare.ocp-elr-core-nonprod.optum.com/premium-payment//#/";
	public static String PCP_GUEST_PAYMENTS_PAGE_URL = "https://team-predators-medicare.ocp-elr-core-nonprod.optum.com/premium-payment//#/";
	public static String MEDICA_GUEST_PAYMENTS_PAGE_URL = "https://team-predators-medicare.ocp-elr-core-nonprod.optum.com/premium-payment//#/";
