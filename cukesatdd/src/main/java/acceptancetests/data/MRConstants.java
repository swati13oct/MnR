...
//public static final String UHC_URL = "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions." + getDomain() + "/";
  ...
  public static final String TEAM_MEDICARE_TESTHARNESS="https://"+MRScenario.environment+"-medicare.uhc.com";
  ...
  public static final String TeamH_ULayer_Member_URL = "https://"+MRScenario.environment+"-medicare.uhc.com";
  
  public static final String TEAMB_TIME_ADMIN_PAGE_URL = "http://apsrt0245.uhc.com:9083/DCERestWAR/dcerest/timeAdmin";
  
  public static final String Stage_UNPWAssistancePage_URL = "https://"+MRScenario.environment+"-medicare.uhc.com/content/medicare/login/reset.html#/start";
  ...
  public static final String NEW_REDESIGN_STAGE_REGISTRATION_URL = "https://"+MRScenario.environment+"-medicare.uhc.com/medicare/member-registration.html#/get-started";
  
  public static final String TeamH_BLayer_Member_URL = "https://"+MRScenario.environment+"-medicare.uhc.com/";
