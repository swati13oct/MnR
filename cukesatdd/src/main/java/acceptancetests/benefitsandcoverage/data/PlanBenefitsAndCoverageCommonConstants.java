 ...
 * 
 */
package acceptancetests.benefitsandcoverage.data;

/**
 * @author pjaising
 *
 */
public class PlanBenefitsAndCoverageCommonConstants {

	public static final String PLAN_BENEFITS_EXPECTED = "planBenefitsAndCoverageExpected";
   ...
   public static final String Language = "language";public static final String PHARMACYSEARCH_ACTUAL = "PharmacySearchActual";
	public static final String PHARMACYSEARCH_EXPECTED = "PharmacySearchExpected";
