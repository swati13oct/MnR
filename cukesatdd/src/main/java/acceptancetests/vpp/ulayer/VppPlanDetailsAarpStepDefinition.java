...
public class VppPlanDetailsAarpStepDefinition {
	...
	public void user_performs_plan_search_information_aarp(DataTable givenAttributes) {
	...
	public void user_validates_plancount_all_plantypes_aarp() {
	...
	public void views_plans_plantype_aarp(DataTable givenAttributes) {
	...
	public void user_validates_available_plans_selected_plantypes_aarp() {
		JSONObject planSummaryActualJson = (JSONObject) getLoginScenario()
				.getBean(VPPCommonConstants.VPP_PLAN_SUMMARY_ACTUAL);
		JSONObject planSummaryExpectedJson = (JSONObject) getLoginScenario()
				.getBean(VPPCommonConstants.VPP_PLAN_SUMMARY_EXPECTED);
	...
	public void user_validates_plan_summary_plan_aarp(DataTable planAttributes) {
