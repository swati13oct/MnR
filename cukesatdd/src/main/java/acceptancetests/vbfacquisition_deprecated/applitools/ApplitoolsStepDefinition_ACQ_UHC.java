package acceptancetests.vbfacquisition_deprecated.applitools;
...
import atdd.framework.ApplitoolsObjectUhc;
...
public class ApplitoolsStepDefinition_ACQ_UHC {
	...
	ApplitoolsObjectUhc appObj1;
	
	@Before
	public void setApplitools() {
		 appObj1 = new ApplitoolsObjectUhc();
		appObj1.setBatch(MRScenario.environment+" UHC batch");
		appObj1.setApplitools();
	...
	public void user_is_on_acquisition_home_page_of_AARP_Site(DataTable memberAttributes) {
		WebDriver wd = appObj1.getWebDriver();
		...
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Home Page", "homepage", flag);
		aquisitionhomepage.hoverOverOurPlanslink();
		appObj1.takeScreenshot(wd,"Acquisition AARP", "Our Plans Window Homepage", "ourPlansHomepage",flag);
		aquisitionhomepage.hoverOverMedEdlink();
		appObj1.takeScreenshot(wd,"Acquisition AARP", "Medicare Education Window Homepage", "medEdWindowHomepage",flag);
		appObj1.saveBean(PageConstants.ACQUISITION_HOME_PAGE,
				aquisitionhomepage);
		appObj1.saveBean(CommonConstants.WEBDRIVER, wd);
	}
	...
	public void user_goes_to_VPPpage(DataTable memberAttributes)throws InterruptedException{
		WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
		AcquisitionHomePage aquisitionhomepage = (AcquisitionHomePage)appObj1.getBean(PageConstants.ACQUISITION_HOME_PAGE);
		...
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "VPP Page", "vpppage",flag); 
		plansummaryPage.clickonViewPlans(); // click on View Plans for MA/MAPD 
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "VPP Page MAPD Plans", "vpppageMAPD",flag);
		
		appObj1.saveBean(PageConstants.VPP_PLAN_SUMMARY_PAGE, plansummaryPage);
	}
	...
	public void accessDCETool(DataTable attributes)throws InterruptedException{
		...
		VPPPlanSummaryPage plansummaryPage = (VPPPlanSummaryPage) appObj1.getBean(PageConstants.VPP_PLAN_SUMMARY_PAGE);
		DrugCostEstimatorPage dce = plansummaryPage.navigateToDCEFromVPP(plantype,planName);
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "DCE Step 1", "dce_step1");
		dce.addDrug(drug.split(" ")[0]);
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "DCE Step 1 Drug added", "dce_step1_drug");
		dce.navigateToStep2();
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "DCE Step 2", "dce_step2");
		dce.select_first_pharmacy();
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "DCE Step 2 Pharmacy Selected", "dce_step2_pharmacy");
		dce.navigateToStep3();
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "DCE Step 3", "dce_step3");
		dce.clicksOnReturnLink();
		
		if(dce!=null){
			appObj1.saveBean(PageConstants.DRUG_COST_ESTIMATOR_PAGE, dce);
			appObj1.saveBean(CommonConstants.WEBDRIVER, wd);
		}
	}
	...
	public void clickOnViewPlanDetailsMAPD(DataTable attributes){
		...
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Plan Details Medical Benefits Tab", "planDetails1");
		planDetailsPage.clickOnDrugTab();
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Plan Details Prescription Drug Tab", "planDetails2");
		planDetailsPage.clickOnRidersTab();
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Plan Details Riders Tab", "planDetails3");
		planDetailsPage.clickOnPlanCostsTab();
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Plan Details Plan Costs Tab", "planDetails1");
	...
	public void user_goes_to_VPPpage_PDP(DataTable memberAttributes)throws InterruptedException{
		...
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "VPP Page PDP Plans", "vpppagePDP");
	...
	public void clickOnViewPlanDetailsPDP(DataTable attributes){
		...
		VPPPlanSummaryPage plansummaryPage = (VPPPlanSummaryPage) appObj1.getBean(PageConstants.VPP_PLAN_SUMMARY_PAGE);
		PlanDetailsPage planDetailsPage = plansummaryPage.navigateToPlanDetails(planName, planType);
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Plan Details PDP Prescription Drug Tab", "planDetailsPDP1");
		planDetailsPage.clickOnPlanCostsTab();
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Plan Details PDP Plan Costs Tab", "planDetailsPDP2");
		planDetailsPage.backtoPlanSummary();
	...
	public void clickOnRequestMoreHelpAndInfoLink(){
		...
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Request More Help and Info", "requestHelpInfo");
		appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
		appObj1.saveBean(CommonConstants.WEBDRIVER, wd);
	}
	...
	public void clickOnRequestAgentAppt(){
		WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
		String url = "https://www.stage-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/request-information/agentebrc.html";
		ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
		applitoolsAcqPage.start(url);
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Agent Appointment Form", "agentAppt");
		appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void clickOnFindCommunity(){
		WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
		ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
		String url = "https://www.stage-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/request-information/attend.html";
	    applitoolsAcqPage.start(url);
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Find Uhc in community Page", "communityPage");
		appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void goesToPDPInfoEnrollmentPage(){
		...
		applitoolsAcqPage.start(url);
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "PDP Inquiry Kit Page", "pdpInquiryPage");
		appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void clickOnMedicareAdvantagePlans(){
		WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
		String url = "https://www.stage-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans.html";
		ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
		applitoolsAcqPage.start(url);
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "PDP Info and Enrollment Materials page", "pdpInfoAndEnrollment");
		appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void howDoIEnrollPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "How do I Enroll Page", "howDoIEnrollPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void resourcesMaterialsPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Resoureces Materials MA Plans Page", "resourcesMaterialsPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}	
	...
	public void pdpPlansPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Prescription Drug Plans Page", "presDrugPlansPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}	
	...
	public void howDoIEnrollPagePDP(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "How do I Enroll PDP Page", "howDoIEnrollPDPPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void resourcesMaterialsPagePDP(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Resoureces Materials PDP Page", "resourcesMaterialsPDPPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void planSelectorPage(){
			WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
			String url = "https://www.stage-uhcmedicaresolutions.uhc.com/medicare-plans.html";
			
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Plan Selector Page", "planSelectorPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void pharmacyLocatorPage(){
			WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
			String url = "https://www.stage-uhcmedicaresolutions.uhc.com/health-plans/aarp-pharmacy.html";
			
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Pharmacy Locator Page", "pharmacyLocatorPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void aboutUsPage(){
			WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
			String url = "https://www.stage-uhcmedicaresolutions.uhc.com/about-us.html";
			
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "About Us Page", "aboutUsPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void contactUsPage(){
			WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
			String url = "https://www.stage-uhcmedicaresolutions.uhc.com/contact-us.html";
			
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Contact Us Page", "contactUsPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void sitemapPage(){
			WebDriver wd = appObj1.getWebDriver();
			System.out.println("*****");appObj1.printBatchName();
			String url = "https://www.stage-uhcmedicaresolutions.uhc.com/sitemap.html";
			
			ApplitoolsAcquisitionPage applitoolsAcqPage = new ApplitoolsAcquisitionPage(wd);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Sitemap Page", "sitemapPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
			appObj1.saveBean(CommonConstants.WEBDRIVER, wd);
	}
	...
	public void privacy_policyPage(){
			WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
			String url = "https://www.stage-uhcmedicaresolutions.uhc.com/privacy_policy.html";
			
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Privacy Policy Page", "privacyPolicyPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void terms_and_conditionsPage(){
			WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
			String url = "https://www.stage-uhcmedicaresolutions.uhc.com/terms_and_conditions.html";
			
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Terms and Conditions Page", "terms_and_conditionsPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void disclaimerPage(){
			WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
			String url = "https://www.stage-uhcmedicaresolutions.uhc.com/disclaimer.html";
			
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Disclaimer Page", "disclaimerPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void agentAndBrokersPage(){
			WebDriver wd = (WebDriver)appObj1.getBean(CommonConstants.WEBDRIVER);
			String url = "https://www.stage-uhcmedicaresolutions.uhc.com/health-insurance-brokers.html";
			
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Agents & Brokers Page", "agentsBrokersPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void accessibilityPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Accessibility Page", "accessibilityPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void medicareEligibilityPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Medicare Eligibility Page", "eligibilityPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void coverageChoicesPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Coverage Choices Page", "coverageChoicesPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void providerBenefitsPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Provider Benefits Page", "proivderBenefitsPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void medicareAdvantagePage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "MA Med Ed Page", "maMedEdPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void costBasicsPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Cost Basics Page", "costBasicsPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void pdpMedEdPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "PDP Plans Med Ed Page", "pdpMedEdPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void enrollmentBasicsPage(){
			...
			ApplitoolsAcquisitionPage applitoolsAcqPage = (ApplitoolsAcquisitionPage) appObj1.getBean(PageConstants.APPLITOOLS_ACQ_PAGE);
			applitoolsAcqPage.start(url);
			appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "Enrollment Basics Med Ed Page", "enrollmentMedEdPage");
			appObj1.saveBean(PageConstants.APPLITOOLS_ACQ_PAGE, applitoolsAcqPage);
	}
	...
	public void the_user_clicks_on_Enroll_Now_to_start_the_OLE_flow(DataTable planAttributes) throws Throwable {
		...
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Welcome Page", "oleWelcomePage");
		MedicareInformationPage medicareInfoPage = welcomePage.navigate_to_medicare_info_page();
		appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Medicare Info Page", "oleMedInfoPage");
		appObj1.saveBean(OLE_PageConstants.OLE_MEDICARE_INFO_PAGE, medicareInfoPage);
	}
	...
	public void the_user_enters_Medicare_Details_in_medicare_info_page(DataTable planAttributes) throws Throwable {
		...
		MedicareInformationPage medicareInfoPage = (MedicareInformationPage) appObj1.getBean(OLE_PageConstants.OLE_MEDICARE_INFO_PAGE);
	    ...
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Preliminary Questions Page", "prelimQuestionPage");
	    ...
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Personal Info Page", "persionalInfoPage");
	    ...
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Special electtion Page", "specialElectionPage");
	    CoverageInformationPage coverageInfoPage = specialElectPage.navigate_to_Coverage_Information_page();
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Coverage Information Page", "coverageInfoPage");
	    ProposedEffectiveDatePage effectiveDatePage = coverageInfoPage.navigate_to_Proposed_Effective_Date_Page();
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Proposed Effective Date Page", "effectiveDatePage");
	    PrimaryCarePhysicianPage pcpPage = (PrimaryCarePhysicianPage) effectiveDatePage.navigate_to_PCP_Page(planType);
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Primary Care Physician Page", "pcpPage");
	    PlanPremiumPage planPremPage = pcpPage.navigate_to_Plan_Premium_Page();
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Plan Premium Page", "planPremiumPage");
	    SupplementalBenefitsPage suppBenefitsPage = planPremPage.navigate_to_Supplemental_Riders_Page();
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Supplemental Benefits Page", "suppBenefitsPage");
	    AuthorizationPage authPage =  suppBenefitsPage.navigate_to_Authorization_Page();
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Authorization Page", "authPage");
	    authPage.enter_required_fields();
	    authPage.navigate_to_Review_Submit_Page();
	    appObj1.takeScreenshotFullPage(wd,"Acquisition AARP", "OLE Review and Submit Page", "reviewSubmitPage");
	}
}