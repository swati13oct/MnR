 ...
 * 
 */
package acceptancetests.payments.data;

/**
 * @author pperugu
 *
 */
public class PaymentCommonConstants {

	public static final String BUSINESS_TYPE = "businessType";
	public static final String PAYMENT_HISTORY_EXPECTED = "paymentHistoryExpectedJson";
	public static final String PAYMENT_HISTORY_ACTUAL = "paymentHistoryActualJson";
	public static final String ONE_TIME_PAYMENT_SUCCESS_EXPECTED = "oneTimePaymentSuccessExpectedJson";
	public static final String ONE_TIME_PAYMENT_SUCCESS_ACTUAL = "oneTimePaymentSuccessActualJson";
	public static final String SETUP_PAYMENT_SUCCESS_EXPECTED = "setupPaymentSuccessExpectedJson";
