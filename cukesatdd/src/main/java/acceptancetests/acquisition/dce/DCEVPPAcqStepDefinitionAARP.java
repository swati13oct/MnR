...
public class DCEVPPAcqStepDefinitionAARP {
	...
	public void the_user_change_the_pharmacy_type_and_select_new_pharmacy_in_AARP_site(DataTable data)
			throws Throwable {
		List<DataTableRow> memberAttributesRow = data.getGherkinRows();
		String pharmacyType = memberAttributesRow.get(0).getCells().get(1);
	...
	public void the_user_clicks_on_Back_to_Plans_button_on_See_Your_Estimated_Costs_page_in_AARP_site()
			throws Throwable {
		DrugCostEstimatorPage dce = (DrugCostEstimatorPage) getLoginScenario()
				.getBean(PageConstants.DRUG_COST_ESTIMATOR_PAGE);
	...
	public void user_validates_Drug_information_is_reflected_on_plan_summary_page_in_AARP_site(DataTable data)
			throws Throwable {
		List<DataTableRow> memberAttributesRow = data.getGherkinRows();
