...
public class DCERedesignCommonConstants {

	public static final String BRAND_DRUG1 = "branddrug";
	public static final String DRUGLIST = "druglist";
	/* 
	 * Need to use only 1 common Constant for Plan type and Plan Name 
	 * Please use VPPCommonConstants - PLAN_NAME and PLAN_TYPE
	 * public static final String PLANTYPE = "plantype"; 
	 * public static final String PLANNAME = "planname";
	 */	
	public static final String AVG_MONTHLY = "avgmonthly";
