...
public class VppStepDefinitionUpdatedAARP {
	...
	@And("^user Verify Next Best Action Modal for Get Started$")
	...
	@And("^user verify and click on the NBA modal to add providers on the VPP summary page in AARP site$")
	public void user_verify_and_click_on_the_NBA_modal_to_add_providers_on_the_VPP_summary_page_in_AARP_site() {
		VPPPlanSummaryPage vppplansummarypage = (VPPPlanSummaryPage) loginScenario
				.getBean(PageConstants.VPP_PLAN_SUMMARY_PAGE);
		vppplansummarypage.validateButton("Find My Doctors");
		vppplansummarypage.clickOnButtonInPlanSummaryPage("Find My Doctors");
	}
	 ...
	 * Integer> vppSummaryPgInfo=plansummaryPage.collectInfoVppPlanSummaryPg();
	 * 
	 ...
	 * Assert.fail("Error in Loading the Plan Details Page");
	 * 
	 * //note: collect page data for email deeplink validation EmailAndPrintUtil
	 * util=new EmailAndPrintUtil(vppPlanDetailsPage.driver); //keep HashMap<String,
	 * String> infoMap=vppPlanDetailsPage.collectInfoVppPlanDetailPg(plantype,
	 * "original"); HashMap<String, String>
	 * infoMap=util.collectInfoVppPlanDetailPg(plantype, "original");
	 ...
	 * getLoginScenario().getBean(infoMapStringId);
	 * 
	 * //note: use new driver to achieve clear cache WebDriver
	 ...
	 * getLoginScenario().getBean(infoMapStringId);
	 * 
	 * //note: use new driver to achieve clear cache //keep WebDriver
	 ...
	 * PlanDetailsPage(newTestDriver);
	 * 
	 * PlanDetailsPage tmpPg=(PlanDetailsPage)
	 ...
	 * List<String> noteList=new ArrayList<String>(); noteList.
	 ...
	 * givenAttributesRow.get(i).getCells().get(1)); }
	 * 
	 * String plantype = givenAttributesMap.get("Plan Type"); String site =
	 ...
	 * .getBean(PageConstants.VPP_PLAN_SUMMARY_PAGE);
	 * plansummaryPage.viewPlanSummary(plantype);
	 * plansummaryPage.handlePlanYearSelectionPopup(plantype); } else {
