...
public class VppStepDefinitionUpdatedAARP {
	...
	public void the_user_validates_the_following_Plan_details_for_the_plan(DataTable givenAttributes) throws Throwable {
		 ...
		 * welcomeOLEPage); } else { Assert.fail(
		 * "Error Loading OLE Welcome page"); }
		 */
	}
	...
	/*
	 * @When(
	 * "^the user goes to PDP Landing and performs zipcode search using widget to welcome OLE Page using widget on the AARP site$"
	 * ) public void
	 ...
	 * memberAttributesRow = givenAttributes.getGherkinRows(); Map<String,
	 * String> memberAttributesMap = new HashMap<String, String>(); for (int i =
	 ...
	 * if (welcomeOLEPage != null) {
	 * getLoginScenario().saveBean(PageConstants.OLE_WELCOME_PAGE,
	 * welcomeOLEPage); } else { Assert.fail("Error Loading OLE Welcome page");
	 * } }
	 * 
	 * @Then("^the user validates the following Plan details for the plan$")
	 * public void
	 * the_user_validates_the_following_Plan_details_for_the_plan(DataTable
	 * givenAttributes) throws Throwable { List<DataTableRow>
	 * memberAttributesRow = givenAttributes.getGherkinRows(); Map<String,
	 * String> memberAttributesMap = new HashMap<String, String>(); for (int i =
	 * 0; i < memberAttributesRow.size(); i++) {
	 * 
	 ...
	 * benefitType, expectedText); Assert.assertTrue(
	 * "Validation failed : Expected text not displayed for Additional Benefit - "
