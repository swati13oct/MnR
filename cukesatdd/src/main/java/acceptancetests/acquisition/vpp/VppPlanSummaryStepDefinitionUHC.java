...
public class VppPlanSummaryStepDefinitionUHC {
	 ...
	 * getLoginScenario() .getBean(PageConstants.ACQUISITION_HOME_PAGE);
	 * 
	 * aquisitionhomepage.OurPlanMALanding(); VPPPlanSummaryPage plansummaryPage =
	 * aquisitionhomepage.ZipcodeSearch(zipcode);
	 * 
	 * if (plansummaryPage != null) {
	 * getLoginScenario().saveBean(PageConstants.VPP_PLAN_SUMMARY_PAGE,
	 ...
	 * getLoginScenario() .getBean(PageConstants.ACQUISITION_HOME_PAGE);
	 * 
	 * aquisitionhomepage.OurPlansPDPLanding(); VPPPlanSummaryPage plansummaryPage =
	 * aquisitionhomepage.ZipcodeSearch(zipcode);
	 * 
	 * if (plansummaryPage != null) {
	 * getLoginScenario().saveBean(PageConstants.VPP_PLAN_SUMMARY_PAGE,
	 ...
	 * ) public void
	 * the_user_clicks_enterDrugInformation_validates_dceHomePage_UMS(){ String
	 * planType = (String) getLoginScenario().getBean(VPPCommonConstants.PLAN_TYPE);
	 * if(!planType.equals("MA")){ VPPPlanSummaryPage plansummaryPage =
	 * (VPPPlanSummaryPage) getLoginScenario()
	 * .getBean(PageConstants.VPP_PLAN_SUMMARY_PAGE); String planName = (String)
	 * getLoginScenario().getBean(VPPCommonConstants.PLAN_NAME);
	 * DrugCostEstimatorPage drugCostEstimatorPage =
	 * plansummaryPage.navigatetoDCEPage(planName); if (drugCostEstimatorPage !=
