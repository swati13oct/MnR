...
public class oleStepDefinition {
	...
	public void the_user_clicks_on_Enroll_Now_to_start_the_OLE_flow() throws Throwable {
		...
		getLoginScenario().saveBean(oleCommonConstants.PLAN_NAME, PlanName);
		getLoginScenario().saveBean(oleCommonConstants.PLAN_TYPE, PlanType);
		getLoginScenario().saveBean(oleCommonConstants.ZIPCODE, ZipCode);
		getLoginScenario().saveBean(oleCommonConstants.COUNTY, County);
		...
		getLoginScenario().saveBean(oleCommonConstants.PLAN_PREMIUM, PlanPremium);
		getLoginScenario().saveBean(oleCommonConstants.TFN, TFN);
	...
	public void the_user_validates_the_Plan_details_on_OLE() throws Throwable {
		...
		PlanDetailsMap.put("Plan Name", (String) getLoginScenario().getBean(oleCommonConstants.PLAN_NAME));
		PlanDetailsMap.put("Plan Year", (String) getLoginScenario().getBean(oleCommonConstants.PLAN_YEAR));
		PlanDetailsMap.put("Zip Code", (String) getLoginScenario().getBean(oleCommonConstants.ZIPCODE));
		PlanDetailsMap.put("County", (String) getLoginScenario().getBean(oleCommonConstants.COUNTY));
		PlanDetailsMap.put("Plan Premium", (String) getLoginScenario().getBean(oleCommonConstants.PLAN_PREMIUM));
