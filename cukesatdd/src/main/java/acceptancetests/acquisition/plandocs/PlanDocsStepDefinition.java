...
public class PlanDocsStepDefinition {
	...
	// public void I_access_the_plandocs_tool_home_page_uhc() throws
	// InterruptedException {
	//
	// pages.acquisition.bluelayer.AcquisitionHomePage acquisitionHomePage =
	// (pages.acquisition.bluelayer.AcquisitionHomePage)
	// loginScenario.getBean(PageConstants.ACQUISITION_HOME_PAGE);
	// PlanDocsPage plandocsPage= (PlanDocsPage)
	// acquisitionHomePage.navigateToPlanDocsFromHome();
	// if(null!=plandocsPage){
	// loginScenario.saveBean(PageConstants.PLANDOCS_PAGE, plandocsPage);
	// }else
	// Assert.fail("Plan docs page object is not loaded");
	...
	public void the_user_validates_the_label_for_zipcode_and_enters_zipcode_on_UHC(DataTable givenAttributes)
