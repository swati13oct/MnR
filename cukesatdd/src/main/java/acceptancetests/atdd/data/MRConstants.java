...
public class MRConstants {
	...
	public static final String TESTHARNESSU_URL = "https://member." + MRScenario.environment
			+ "-aarpmedicareplans.uhc.com/content/aarpm/home/testharness.html";
	public static final String TESTHARNESS_URL = "https://member." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/content/uhcm/home/testharness.html";
	public static final String TESTHARNESS_URL2 = "https://" + MRScenario.environment
			+ "-medicare.uhc.com/content/medicare/login/overview.html/?testharness=true";
	public static final String TESTHARNESS_URL_ULAYER = "https://member.awe-" + MRScenario.environment
			+ "-aarpmedicareplans.uhc.com/content/aarpm/home/testharness.html";
	public static final String BNCBURL = "https://member." + MRScenario.environment + "-uhcmedicaresolutions.uhc.com/";
	public static final String UHCM_URL = "https://member.awe-" + MRScenario.environment+ "-uhcmedicaresolutions.uhc.com/login.html";
	
	public static final String Dashboard_URL = "https://" + MRScenario.environment+ "-werally.uhc.com?testharness=true";
	
	 //public static final String AARP_URL ="https://www.awe-"+MRScenario.environment+"-aarpmedicareplans.uhc.com/";
	public static final String AARP_URL = "https://www.awe-" + MRScenario.environment + "-aarpmedicareplans.uhc.com/";

	public static final String AARP_PLANPREVIEW_URL = "https://www." + MRScenario.environment
			+ "-aarpmedicareplans.uhc.com/plan-preview.html";

	public static final String UHC_PLANPREVIEW_URL = "https://www." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/plan-preview.html";
	...
	// "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions.uhc.com/";
	...
	public static final String AARPM_REGISTRATION_URL = "https://member.awe-" + MRScenario.environment
			+ "-aarpmedicareplans.uhc.com/guest/registration.html";
	...
	public static final String UHCM_REGISTRATION_URL = "https://member.awe-" + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/guest/registration.html";

	public static final String AARP_OUR_PLANS_URL = "https://www." + MRScenario.environment
			+ "-aarpmedicareplans.uhc.com/health-plans.html";

	public static final String UHC_OUR_PLANS_URL = "https://www." + MRScenario.environment
	...
	public static final String AARPM_MOBILE_URL = "https://member.awe-" + MRScenario.environment
	...
	public static final String UHCM_MOBILE_URL = "https://member.awe-" + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/mobile/guest/login.html";
	...
	public static final String MA_ENROLLMENT_PAGE_URL = "https://www." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/medicare-enrollment.html";

	public static final String MA_PLAN_INFORMATION_AND_PLANS_PAGE_URL = "https://www." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms.html";

	public static final String MA_PLANS_AND_GRIEVANCES_URL = "https://www." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/medicare-appeal.html";

	public static final String MA_RIGHTS_AND_RESPONSIBILITIES_PAGE_URL = "https://www." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/medicare-rights-center.html";

	public static final String AARP_SITE_MAP_PAGE_URL = "https://www.awe-" + MRScenario.environment
			+ "-aarpmedicareplans.uhc.com/sitemap.html";

	public static final String MA_PLAN_PRES_DRUGS_TRANSITION_PLANS_PAGE_URL = "https://www." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/ma-drug-transition.html";

	public static final String MA_HOW_TO_APPOINT_REPRESENTIVE_PAGE_URL = "https://www." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/how_to_appoint_a_representative.html";

	public static final String OUR_PLANS_MA_HOW_TO_PAY_YOUR_PREMIUM_URL = "https://www." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/how_to_pay_your_premium.html";

	public static final String MA_REQUEST_MORE_HELP_AND_INFORMATION_URL = "https://www." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material.html";
	...
	// "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/medicare-enrollment.html";

	// public static final String MA_PLAN_INFORMATION_AND_PLANS_PAGE_URL =
	// "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms.html";

	// public static final String MA_PLANS_AND_GRIEVANCES_URL =
	// "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/medicare-appeal.html"
	// ;

	// public static final String MA_RIGHTS_AND_RESPONSIBILITIES_PAGE_URL =
	// "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/medicare-rights-center.html"
	// ;

	// public static final String AARP_SITE_MAP_PAGE_URL =
	// "https://www.awe-"+MRScenario.environment+"-aarpmedicareplans.uhc.com/sitemap.html";

	// public static final String MA_PLAN_PRES_DRUGS_TRANSITION_PLANS_PAGE_URL =
	// "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/ma-drug-transition.html";

	// public static final String MA_HOW_TO_APPOINT_REPRESENTIVE_PAGE_URL =
	// "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/how_to_appoint_a_representative.html";

	// public static final String OUR_PLANS_MA_HOW_TO_PAY_YOUR_PREMIUM_URL =
	// "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material/ma-medicare-forms/how_to_pay_your_premium.html";

	// public static final String MA_REQUEST_MORE_HELP_AND_INFORMATION_URL =
	// "https://www.awe-"+MRScenario.environment+"-uhcmedicaresolutions.uhc.com/health-plans/medicare-advantage-plans/resources-plan-material.html";
	...
	public static final String UHCM_MEMBER_URL = "https://member." + MRScenario.environment
			+ "-uhcmedicaresolutions.uhc.com/guest/home.html";
	...
	public static final String PORTFOLIO_PAGE_URL = "https://www.awe-" + MRScenario.environment
			+ "-aarpmedicareplans.uhc.com/health-plans.html";

	public static final String AARP_PORTFOLIO_URL = "https://www." + MRScenario.environment
			+ "-aarpmedicareplans.uhc.com/health-plans/plans.html";
