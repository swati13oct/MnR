package acceptancetests.mobile.mymedicaregistration;
...
import pages.mobile.member.mymedica.CreateAccountPage;
import pages.mobile.member.mymedica.PlanConfirmationPage;
import pages.mobile.member.mymedica.RegistrationHomePage;
import pages.mobile.member.mymedica.RegistrationSuccessPage;
import pages.mobile.member.mymedica.SignInPage;

public class MobileMyMedicaRegistrationStepDefinition {
