...
public class VppStepDefinitionMobileUHC {
	...
	public void the_user_selects_plans_to_add_to_plan_compare_and_navigates_to_Plan_compare_page(
		...
		String PlanPremium;
		String ZipCode = (String) getLoginScenario().getBean(VPPMobileCommonConstants.ZIPCODE);
		String County = (String) getLoginScenario().getBean(VPPMobileCommonConstants.COUNTY);
		String PlanType = (String) getLoginScenario().getBean(VPPMobileCommonConstants.PLAN_TYPE);
		String TFN;
	...
	public void enters_data_to_resume_application(DataTable givenAttributes) throws Throwable {
		...
		String ApplicationID = (String) getLoginScenario().getBean(VPPMobileCommonConstants.RESUMEKEY);
