...
public class MedicareEducationStepDefinition {
	...
	public void the_user_navigates_to_new_Medicare_Education_homepage() {
		AcquisitionHomePageMobile aquisitionhomepageMobile = (AcquisitionHomePageMobile) getLoginScenario()
				.getBean(PageConstants.ACQUISITION_HOME_PAGE);
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNewMobile = aquisitionhomepageMobile
				.clickLearnMoreAboutMedicareOnHomePage();
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Medicare_Eligibility_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = eligibilityPage
				.backtoMedicareEducationPage();
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Coverage_Choices_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = coverageChoicesPageNew
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
	...
	public void the_user_navigates_to_new_Benefits_page() {
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = (LearnAboutMedicareHomePageNewMobile) getLoginScenario()
				.getBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE);
		PrescriptionProviderBenefitsPageNewMobile prescriptionProviderBenefitsPageNew = learnAboutMedicareHomePageNew
				.clickOnBenefitsLink();
		if (prescriptionProviderBenefitsPageNew != null) {
			getLoginScenario().saveBean(PageConstants.PRESCRIPTION_PROVIDER_BENEFITS_PAGE,
					prescriptionProviderBenefitsPageNew);
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Benefits_Page() {
		PrescriptionProviderBenefitsPageNewMobile prescriptionProviderBenefitsPageNew = (PrescriptionProviderBenefitsPageNewMobile) getLoginScenario()
				.getBean(PageConstants.PRESCRIPTION_PROVIDER_BENEFITS_PAGE);
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = prescriptionProviderBenefitsPageNew
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Cost_Basics_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = costBasicsPageNew
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Enrollment_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = whentoEnrollinMedicarePage
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Original_Medicare_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = originalMedicarePage
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
	...
	public void the_user_navigates_to_new_Medicare_Advantage_Plans_page() {
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = (LearnAboutMedicareHomePageNewMobile) getLoginScenario()
				.getBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE);
		MedicareAdvantagePartCPlansPageNewMobile medicareAdvantagePartCPlansPageNew = learnAboutMedicareHomePageNew
				.clickOnMAPlans();
		if (medicareAdvantagePartCPlansPageNew != null) {
			getLoginScenario().saveBean(PageConstants.MEDICARE_ADVANTAGE_PART_C_PLANS_PAGE,
					medicareAdvantagePartCPlansPageNew);
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Medicare_Advantage_Plans_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = medicareAdvantagePartCPlansPageNew
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
			System.out.println(
					"Returned to New Medicare Education Homepage from Medicare Advantage Plans page successful");
			getLoginScenario().saveBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE, learnAboutMedicareHomePageNew);
		} else {
			Assert.fail(
					"Returned to New Medicare Education Homepage from Medicare Advantage Plans page is not successful");
		}
	}
	...
	public void the_user_navigates_to_new_Medicare_Supplement_Plans_page() {
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = (LearnAboutMedicareHomePageNewMobile) getLoginScenario()
				.getBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE);
		MedicareSupplementInsurancePlansPageNewMobile medicareSupplementInsurancePlansPageNew = learnAboutMedicareHomePageNew
				.clickOnMedSupp();
		if (medicareSupplementInsurancePlansPageNew != null) {
			getLoginScenario().saveBean(PageConstants.MEDICARE_SUPPLEMENT_PLANS_PAGE,
					medicareSupplementInsurancePlansPageNew);
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Medicare_Supplement_Plans_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = medicareSupplementInsurancePlansPageNew
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
			System.out.println(
					"Returned to New Medicare Education Homepage from Medicare Supplement Plans page successful");
			getLoginScenario().saveBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE, learnAboutMedicareHomePageNew);
		} else {
			Assert.fail(
					"Returned to New Medicare Education Homepage from Medicare Supplement Plans page is not successful");
		}
	}
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Special_Needs_Plans_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = specialNeedsPlansPage
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
	...
	public void the_user_navigates_to_new_Medicare_Prescription_Drugs_Plans_page() {
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = (LearnAboutMedicareHomePageNewMobile) getLoginScenario()
				.getBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE);
		MedicarePrescriptionDrugPartDPlansPageNewMobile prescriptionDrugPartDPlansPageNew = learnAboutMedicareHomePageNew
				.clickOnPDPPlans();
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Medicare_Prescription_Drugs_Plans_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = prescriptionDrugPartDPlansPageNew
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
			System.out.println(
					"Returned to New Medicare Education Homepage from Medicare Prescription Drugs Plans page successful");
			getLoginScenario().saveBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE, learnAboutMedicareHomePageNew);
		} else {
			Assert.fail(
					"Returned to New Medicare Education Homepage from Medicare Prescription Drugs Plans page is not successful");
		}
	}
	...
	public void the_user_navigates_to_new_Overview_of_Plan_Types_page() {
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = (LearnAboutMedicareHomePageNewMobile) getLoginScenario()
				.getBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE);
		OverviewofPlanTypesPageMobile overviewofPlanTypesPage = learnAboutMedicareHomePageNew
				.clickOnOverviewOfPlanTypes();
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Overview_of_Plan_Types_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = overviewofPlanTypesPage
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
			System.out
					.println("Returned to New Medicare Education Homepage from Overview of Plan Types page successful");
			getLoginScenario().saveBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE, learnAboutMedicareHomePageNew);
		} else {
			Assert.fail(
					"Returned to New Medicare Education Homepage from Overview of Plan Types page is not successful");
		}
	}
	...
	public void the_user_navigates_to_Initial_Enrollment_Period_page() {
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = (LearnAboutMedicareHomePageNewMobile) getLoginScenario()
				.getBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE);
		InitialEnrollmentPeriodPageMobile initialEnrollmentPeriodPage = learnAboutMedicareHomePageNew
				.clickOnLearnMoreAboutIEP();
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Initial_Enrollment_Period_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = initialEnrollmentPeriodPage
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
			System.out.println(
					"Returned to New Medicare Education Homepage from Initial Enrollment Period page successful");
			getLoginScenario().saveBean(PageConstants.LEARN_ABOUT_MEDICARE_PAGE, learnAboutMedicareHomePageNew);
		} else {
			Assert.fail(
					"Returned to New Medicare Education Homepage from Initial Enrollment Period page is not successful");
		}
	}
	...
	public void the_user_comes_back_to_new_Medicare_Education_Page_from_Working_Past_65_Page() {
		...
		LearnAboutMedicareHomePageNewMobile learnAboutMedicareHomePageNew = workingPast65Page
				.backtoMedicareEducationPage();
		if (learnAboutMedicareHomePageNew != null) {
	...
	public void the_user_clicks_on_How_to_Enroll_link_in_Read_Next_section() {
		InitialEnrollmentPeriodPageMobile initialEnrollmentPeriodPage = (InitialEnrollmentPeriodPageMobile) getLoginScenario()
				.getBean(PageConstants.INITIAL_ENROLLMENT_PERIOD_PAGE);
		HowtoEnrollinMedicarePageMobile howtoEnrollinMedicarePage = initialEnrollmentPeriodPage
				.clickOnHowToEnrollLink();
	...
	public void theuserclicksonLearnmoreaboutMedicareAdvantagePlanslinkinReadNextSection() {
		CostBasicsPageNewMobile costBasicsPageNew = (CostBasicsPageNewMobile) getLoginScenario()
				.getBean(PageConstants.COST_BASICS_PAGE);
		MedicareAdvantagePartCPlansPageNewMobile medicareAdvantagePartCPlansPageNew = costBasicsPageNew
				.clickOnReadNextMAPlanLink();
		if (medicareAdvantagePartCPlansPageNew != null) {
			getLoginScenario().saveBean(PageConstants.MEDICARE_ADVANTAGE_PART_C_PLANS_PAGE,
					medicareAdvantagePartCPlansPageNew);
			System.out.println("New Medicare Advantage Plans page loaded");
	...
	public void theuservalidatesLearnmoreaboutMedicareSupplementinsuranceplansonMedicareAdvantagePlansPage() {
		MedicareAdvantagePartCPlansPageNewMobile medicareAdvantagePartCPlansPageNew = (MedicareAdvantagePartCPlansPageNewMobile) getLoginScenario()
				.getBean(PageConstants.MEDICARE_ADVANTAGE_PART_C_PLANS_PAGE);
		MedicareSupplementInsurancePlansPageNewMobile medicareSupplementInsurancePlansPageNew = medicareAdvantagePartCPlansPageNew
				.clickOnReadNextMedSuppPlanLink();
		if (medicareSupplementInsurancePlansPageNew != null) {
			getLoginScenario().saveBean(PageConstants.MEDICARE_SUPPLEMENT_PLANS_PAGE,
					medicareSupplementInsurancePlansPageNew);
			System.out.println("New Medicare Supplement Plans page loaded");
	...
	public void theuservalidatesLearnmoreabouthowtoenrollonMedicareAdvantagePlansPage() {
		MedicarePrescriptionDrugPartDPlansPageNewMobile prescriptionDrugPartDPlansPageNew = (MedicarePrescriptionDrugPartDPlansPageNewMobile) getLoginScenario()
				.getBean(PageConstants.PRESCRIPTION_DRUGS_PLANS_PAGE);
		HowtoEnrollinMedicarePageMobile howtoEnrollinMedicarePage = prescriptionDrugPartDPlansPageNew
				.clickOnHowToEnroll();
		if (howtoEnrollinMedicarePage != null) {
			getLoginScenario().saveBean(PageConstants.HOW_TO_ENROLL_IN_MEDICARE_PAGE, howtoEnrollinMedicarePage);
			System.out.println("How to Enroll in Medicare Page loaded");
	...
	public void theuservalidatestheLearnhowtochangeMedicareplanslinkonnewEnrollmentpage() {
		WhentoEnrollinMedicarePageMobile whentoEnrollinMedicarePage = (WhentoEnrollinMedicarePageMobile) getLoginScenario()
				.getBean(PageConstants.WHEN_TO_ENROLL_IN_MEDICARE_PAGE);
		HowtoEnrollinMedicarePageMobile howtoEnrollinMedicarePage = whentoEnrollinMedicarePage
				.clickOnNextHowToEnrollLink();
	...
	public void the_user_validate_the_state_selected_is_correct(DataTable givenAttributes) {
		...
		if (!stateSelected.contains(geoState.trim())) {
