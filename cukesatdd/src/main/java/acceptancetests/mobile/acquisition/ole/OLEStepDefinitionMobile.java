...
import pages.mobile.acquisition.ole.ProposedEffectiveDatePagemobile;
...
public class OLEStepDefinitionMobile {
	...
	public void the_user_navigates_to_Medicare_Information_Page() throws Throwable {
		PersonalInformationPageMobile personalInfoPage = (PersonalInformationPageMobile) getLoginScenario().getBean(OLE_PageConstants.OLE_PERSONAL_INFO_PAGE);
	...
	public void the_user_validates_the_dispalyed_sections_for_the_Plan_Type_in_Coverage_and_Health_Information_Page() throws Throwable {
		 ...
		 */
			MedicareInformationPageMobile medInformationPage = (MedicareInformationPageMobile) getLoginScenario().getBean(OLE_PageConstants.OLE_MEDICARE_INFO_PAGE);
...
public void the_user_validates_proposed_effective_date_display() throws Throwable {
	 ...
	 * Assert.assertTrue(true); } else{
	 */
		ProposedEffectiveDatePagemobile proposedEffectiveDatePage  = (ProposedEffectiveDatePagemobile) getLoginScenario().getBean(OLE_PageConstants.OLE_PROPOSED_EFF_DATE_PAGE);
...
public void the_user_validates_PCP_page_for_MD_and_MAPD_PFFS_plans() throws Throwable {
	 ...
	 * Assert.assertTrue(true); } else{
	 */
		pages.mobile.acquisition.ole.PrimaryCarePhysicianPage pcpPage = (pages.mobile.acquisition.ole.PrimaryCarePhysicianPage) getLoginScenario().getBean(OLE_PageConstants.OLE_PRIMARY_CARE_PHYSICIAN_PAGE);
		String planType = (String) getLoginScenario().getBean(oleCommonConstants.OLE_PLAN_TYPE);
...
public void the_user_navigates_to_PCP_Page() throws Throwable {
	 ...
	 */
		...
		if(planType.contentEquals("PDP")){
			...
			pages.mobile.acquisition.ole.PrimaryCarePhysicianPage pcpPage = (pages.mobile.acquisition.ole.PrimaryCarePhysicianPage) proposedEffectiveDatePage.navigate_to_PCP_Page(planType);
			if (pcpPage != null) {
...
public void the_user_navigates_to_SEP_Page(DataTable Medicareoptions) throws Throwable {
	...
	SpecialElectionPeriodPageMobile specialElectionPeriodPage = personalInformationPage.navigate_to_SEP_page(MedicareDetailsMap);
	if (specialElectionPeriodPage != null) {
		getLoginScenario().saveBean(OLE_PageConstants.OLE_SPECIAL_ELECTION_PERIOD_PAGE,
				specialElectionPeriodPage);
		System.out.println("OLE SEP Page is Displayed");
	...
	public void the_user_validates_requierd_fields_for_Preliminary_Questions_Page(DataTable Flags) throws Throwable {
		 ...
		 */
			...
			MedicareInformationPageMobile medInfoPage = (MedicareInformationPageMobile) getLoginScenario().getBean(OLE_PageConstants.OLE_MEDICARE_INFO_PAGE);
