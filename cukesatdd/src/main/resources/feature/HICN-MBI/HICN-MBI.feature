...
Examples:
| ServerDateMilliSeconds | MemberNo  | DOB 				| InvalidNo | HICN_MBI_Value | ErrorMessage |
| 1522562400000 				 | 001742786 | 11/01/1939 | Invalid Value		 | 	163344396	 | Your Medicare ID number was entered incorrectly. For help, call Customer Service at the number listed on the back of your member ID card (health insurance card). |
