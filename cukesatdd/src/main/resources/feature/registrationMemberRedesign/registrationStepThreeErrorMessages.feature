...
Feature: To test the error messages on create account page in redesign portal
  ...
  Scenario Outline: To verify correct error message appears if password field is left blank on create account page
    ...
    Examples: 
      ...
      | PDP      |    829072104 | 09-03-1942  | UnitedHealthcare MedicareComplete Plan 1 (HMO) | DFADC BBCBEFCEE | Us1@       | Password@1 | Us1@       | member@uhc.com | member@uhc.com |
      | PDP      |    829072104 | 09-03-1942  | UnitedHealthcare MedicareComplete Plan 1 (HMO) | DFADC BBCBEFCEE | User@      | Password@1 | User@      | member@uhc.com | member@uhc.com |
      | PDP      |    829072104 | 09-03-1942  | UnitedHealthcare MedicareComplete Plan 1 (HMO) | DFADC BBCBEFCEE | 13645@     | Password@1 | 13645@      | member@uhc.com | member@uhc.com |
      | PDP      |    829072104 | 09-03-1942  | UnitedHealthcare MedicareComplete Plan 1 (HMO) | DFADC BBCBEFCEE | @1user     | Password@1 | @1user      | member@uhc.com | member@uhc.com |
      | PDP      |    829072104 | 09-03-1942  | UnitedHealthcare MedicareComplete Plan 1 (HMO) | DFADC BBCBEFCEE | user 12@   | Password@1 | Password@1      | member@uhc.com | member@uhc.com |
