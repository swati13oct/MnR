...
Scenario Outline:Verify drug search in UHCRetiree through Understand Prescription Drug Coverage Options tab
Given user navigates to the UHCRetiree site
...
Scenario Outline:Verify drug search in UHCRetiree through Understand Prescription Drug Coverage Options link
Given user navigates to the UHCRetiree site
When the user selects on the group from the Retirees of selected group plans drop down
	   | <group> |
