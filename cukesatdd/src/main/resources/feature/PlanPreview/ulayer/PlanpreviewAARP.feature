...
## Scenario Outline: Verify provider search and pharmacy locatorlink on Plan Preview Page in AARP site
##Given the user is on the Plan Preview Page of AARP medicare site landing page
##When the user validates the multicounty popup on ulayer
##| Zip Code    | <zipcode> |
##| County Name | <county>  |
...
#|90210|                        |AARP MedicareComplete SecureHorizons Plan 2 (HMO)| MAPD| 
 ...
 ##Scenario Outline: Verify Rally connect  on Plan Preview Page in AARP site
##Given the user is on the Plan Preview Page of AARP medicare site landing page
##When the user validates the multicounty popup on ulayer
##| Zip Code    | <zipcode> |
##| County Name | <county>  |
