...
Then the user validates the enrollment application confirmation in UHC site
 ...
 |90210   | | MA         |AARP MedicareComplete SecureHorizons Essential (HMO)|No    | First   |  m          |  last  |01/01/1940 |  Male                | 111-11-1111-A      |07/01/1988                   |07/01/1988                  |1234            | Colorado    | UHG       |9999911111      |1111199999      | test@uhc.com   | test@uhc.com        |  English           |
 |90210  | | PDP        |AARP MedicareRx Preferred (PDP)                     |No    | miller  |  j          |desh    |11/12/1950 |  Male                | 222-22-2222-C      |07/01/1989                   |07/01/1989                  |7890   | Colorado  | a-12    |  9999922222                |8888811111             | testpdp@uhc.com       | testpdp@uhc.com             |English               | 
...
Then the user validates the enrollment application confirmation in UHC site
  ...
  Examples:
  |zipcode |countyName   | planType   | planName                           |answer|firstName|middleInitial|lastName|birthDate  |selectedGender        | medicareClaimNumber|hospitalEffectiveDate        |medicalEffectiveDate        |address    |  city          | apartment |mainPhoneNumber |otherPhoneNumber| emailAddress   | confirmEmailAddress | languagePreference |
  |90210   | | PDP         |AARP MedicareRx Preferred (PDP)    |No |First   |  m          |  last  |01/01/1940 |  Male                | 111-11-1111-A      |07/01/1988                   |07/01/1988                  |1234            | Colorado    | UHG       |9999911111      |1111199999      | test@uhc.com   | test@uhc.com        |  English           |
  |90210   | | PDP         |AARP MedicareRx Preferred (PDP)    |No |First   |  m          |  last  |01/01/1940 |  Male                | 222-22-2222-A      |07/01/1988                   |07/01/1988                  |1234            | Beverly Hills    | UHG       |1111199999      |9999911111      | test@uhc.com   | test@uhc.com        |  English           |
...
# And the user select the answer for this question "Do you want to add a dental supplemental benefit?" in supplemental benefits 
 ...
 Then the user validates the enrollment application confirmation in UHC site
  ...
  Examples:
            ...
            |90210   | | MAPD       |AARP MedicareComplete SecureHorizons Plan 2 (HMO)   |No    |  First  |  m          |  last  |01/01/1940 |  Male                | 111-11-1111-A      |07/01/1988                   |07/01/1988          	    |1234     	| Colorado       | UHG       |9999911111      |1111199999      | test@uhc.com   | test@uhc.com        |  English           |Yes					   |	Yes				   	  |			No						 |		Yes					 |    No                    |    No             |    Yes                  |brok1234|
