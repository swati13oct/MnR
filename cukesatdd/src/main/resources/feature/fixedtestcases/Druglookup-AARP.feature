...
Examples:
		| planType | category    	| drugInitials | drugName     | drugDosage          | drugQuantity | drugFrequency  | packages       | drugType    | pharmacyType                | distance | pharmacyName        |
		| MAPD     | COSMOS_drug	|  lipi        | Lipitor      | Lipitor TAB 10MG    | 30           | Every 1 month  | null           | Brand            | Standard Network Pharmacy   | 15 miles | Brockie Pharmatech   |
