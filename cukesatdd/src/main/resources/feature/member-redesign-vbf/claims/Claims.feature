...
Feature: 1.02-VBF-MemRedesign-To test claim functionality
  ...
  Scenario Outline: To validate that claims are present on claims summary page and claims details page
    ...
    Examples: 
      | memberType   | claimPeriod    | domain | claimssystem | friendname | favcolor | phonenumber |
    #  | BlueLayerInd |  Last 24 months | COSMOS | COSMOSCLAIMS | name1      | color1   | number1     |
    #  | BlueLayerInd |  Last 24 months | NICE   | NICECLAIMS   | name1      | color1   | number1     |
   #  |  ULayerInd 	 |  Last 24 months | COSMOS | COSMOSCLAIMS |name1      | color1   | number1     |
   #  |  ULayerInd		 |  Last 24 months | NICE   | NICECLAIMS   |name1      | color1   | number1     |
     |  GroupRetiree |  Last 24 months | COSMOS | COSMOSCLAIMS |name1      | color1   | number1     |
   #  |  GroupRetiree |  Last 24 months | NICE   | NICECLAIMS   |name1      | color1   | number1     |
