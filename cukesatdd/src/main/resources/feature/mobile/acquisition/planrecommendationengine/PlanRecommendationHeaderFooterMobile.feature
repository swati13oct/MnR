...
Feature: Plan Selector Tool flow - Verify Header and Footer in plan recommendation engine using mobile
  ...
  @PRE @planrecommandonationmobile @headerfootermobile @headerelements @F383639
 ...
 # @PRE @planrecommandonationmobile @headerfootermobile @headerlinksvalidation @HFlinkvalidation @F383639
 # Scenario: - To validate mobile header links in medicare page
 #   Given the user is on UHC medicare acquisition site mobile
 #   When user navigates to PRE landing page mobile
 #   Then user validates all Links from header mobile

 # @PRE @planrecommandonationmobile @headerfootermobile @footerlinksvalidation @HFlinkvalidation @F383639
