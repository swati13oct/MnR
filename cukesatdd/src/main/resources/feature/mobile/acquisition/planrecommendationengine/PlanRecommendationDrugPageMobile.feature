...
Feature: Plan Recommendation Engine flow - Verify Drugs page functionalities in PRE using mobile
  ...
  @PRE @planrecommandonationmobile @drugpagemobile @autoSuggestion @drugpageadddrugmobile @F374225
  Scenario Outline: Zipcode: <Zipcode> -MultiCountyOptions: <isMultiCounty> -CoverageOptions: <isCoverageOpt> -SNP: <SpecialNeeds> -Travel: <TravelOption> -Doctors: <DoctorsSelection> -DrugOption: <DrugSelection> - To validate Drug page function with auto search in PRE Mobile
    ...
    Then user selects add drug option in Drug page mobile
      | Drug Selection | <DrugSelection>                                              |
      | Drug Details   | <DrugName-AutoSearch-Package-Qty-Frequency-Isgeneric-Switch> |

    Examples: 
      | Zipcode | isMultiCounty | County   | isCoverageOpt | SpecialNeeds | TravelOption | DoctorsSelection | DoctorsName | isMultiDoctor | DrugSelection | DrugName-AutoSearch-Package-Qty-Frequency-Isgeneric-Switch |
      |   10001 | NO            | New York | MA            | None         | Travel       | want to use      |             |               | add           | Imuran,YES,Imuran TAB 50MG,,25,1,YES,YES:                  |

  @PRE @planrecommandonationmobile @drugpagemobile @manualSuggestion @drugpageadddrugmobile @F374225
  ...
  Scenario Outline: Zipcode: <Zipcode> -MultiCountyOptions: <isMultiCounty> -CoverageOptions: <isCoverageOpt> -SNP: <SpecialNeeds> -Travel: <TravelOption> -Doctors: <DoctorsSelection> -DrugOption: <DrugSelection> - To validate Drug page error function in PRE Mobile
    ...
    Examples: 
      | Zipcode | isMultiCounty | County   | isCoverageOpt | SpecialNeeds | TravelOption | DoctorsSelection | DoctorsName | isMultiDoctor | DrugSelection | DrugName-AutoSearch-Package-Qty-Frequency-Isgeneric-Switch |
      |   10001 | NO            | New York | MA            | None         | Travel       | want to use      |             |               | add           | Imuran,YES,,,25,1,YES,NO:                                  |
  ...
  Scenario Outline: Zipcode: <Zipcode> -MultiCountyOptions: <isMultiCounty> -CoverageOptions: <isCoverageOpt> -SNP: <SpecialNeeds> -Travel: <TravelOption> -Doctors: <DoctorsSelection> -DrugOption: <DrugSelection> - To validate Drug page choose function in PRE Mobile
    ...
    Examples: 
      | Zipcode | isMultiCounty | County   | isCoverageOpt | SpecialNeeds | TravelOption | DoctorsSelection | DoctorsName | isMultiDoctor | DrugSelection | SearchText | DrugName-AutoSearch-Package-Qty-Frequency-Isgeneric-Switch |
