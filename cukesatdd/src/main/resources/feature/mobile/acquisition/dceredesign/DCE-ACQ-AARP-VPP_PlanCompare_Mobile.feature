...
Feature: 1.10.3 ACQ-DCERedesign-VPP_PlanCompare - To test DCE - VPP Plan Compare Integration
  ...
  @DCE_Redesign_VPP_PlanCompare @OnlyProd
  Scenario Outline: 1.10.2.1 To test the DCE Redesignflow for PlanType :  <plantype> from vpp Plan Details
    ...
    @DCE_Redesign_VPP_PlanCompare_AARP @OnlyProd
    Examples: 
    ...
    Examples: 
      | site | zipcode | plantype | county       | isMultutiCounty | drug1     | drug2                | drug3      | drug4         | drug5            | drug6   | planname                        | planyear |
      | AARP |   80002 | PDP      | Adams County | yes             | meloxicam | diclofenac potassium | febuxostat | buprenorphine | fentanyl citrate | Lipitor | AARP MedicareRx Walgreens (PDP) | current  |
