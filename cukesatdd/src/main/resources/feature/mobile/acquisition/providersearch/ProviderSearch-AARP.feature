...
Feature: 1.07 .ACQ- Provider Search Flow in AARP
  ...
  @ProviderSearchUlayerSmoke @ProviderSearchUlayerCurrentSmoke @OnlyProd @prod_regression
  ...
  Scenario Outline: Verify Provider Search plan count in AARP site from Global Header -plan count-<plancount>
    ...
    @AcqRegressionProviderSearchUlayer @regressionAARP @prod_regression
    Examples: 
  ...
  @ProviderSearchFromVppPlanDetailsPageUlayer @AcqRegressionProviderSearchUlayer @regressionAARP @prodRegression 
  ...
  @ProviderSearchFromHomePageUlayer @AcqRegressionProviderSearchUlayer @regressionAARP @ProviderSearchFromHomePageNextYrUlayerSmoke @prodRegression 
