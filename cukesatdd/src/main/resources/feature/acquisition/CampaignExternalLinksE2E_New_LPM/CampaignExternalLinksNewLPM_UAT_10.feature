...
Feature: 1.10 ACQ - UAT Scripts Campaign External Links scenario 10 related to New Medicare Advantage Plans page
  ...
  Scenario Outline: TID: <Scenario> To verify zipcode,TFN,form,links on Medicare Advantage Plans Landing Page
   ...
   Then user verify TFN on AARP external links page
    ...
    Examples:
      | Scenario                                      | externallink                                                                   |zipcodeSingle |zipcodeMulti| isMultiCounty | county       | TFNNo         | TFNxpath1                   | workingHrs                              | TFNNo2         |externallink2                                                                                   | 
      | Campaign External Links - E2E Scenario 10_AMP | https://www.stage-aarpmedicareplans.uhc.com/lp/medicare-advantage-plans.html   | 33111        |65656       |Yes            | Stone County |1-855-264-3792 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | 1-877-322-0782 |https://www.stage-aarpmedicareplans.uhc.com/lp/medicare-advantage-plans.html?wt.mc_id=8014272   |  
    
    @CampaignExternal_Scenario10_UHC  @StageLP
    Examples:
      | Scenario                                      | externallink                                                                   |zipcodeSingle |zipcodeMulti| isMultiCounty | county       | TFNNo         | TFNxpath1                   | workingHrs                              | TFNNo2         |externallink2                                                                                     | 
      | Campaign External Links - E2E Scenario 10_UMS | https://www.stage-uhcmedicaresolutions.uhc.com/lp/medicare-advantage-plans.html| 33111        |65656       |Yes            | Stone County |1-877-801-0043 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | 1-877-322-0782 |https://www.stage-uhcmedicaresolutions.uhc.com/lp/medicare-advantage-plans.html?wt.mc_id=8014272  |        
    
    @CampaignExternal_Scenario10_AARP @OfflineLP
    Examples:
      | Scenario                                      | externallink                                                             |zipcodeSingle |zipcodeMulti| isMultiCounty | county       | TFNNo         | TFNxpath1                   | workingHrs                              | TFNNo2         |externallink2                                                                             |
      | Campaign External Links - E2E Scenario 10_AMP | https://offline.aarpmedicareplans.com/lp/medicare-advantage-plans.html   | 33111        |65656       |Yes            | Stone County |1-855-264-3792 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | 1-877-322-0782 |https://offline.aarpmedicareplans.com/lp/medicare-advantage-plans.html?wt.mc_id=8014272   |
   
    @CampaignExternal_Scenario10_UHC  @OfflineLP
    Examples:
      | Scenario                                      | externallink                                                                   |zipcodeSingle |zipcodeMulti| isMultiCounty | county       | TFNNo         | TFNxpath1                   | workingHrs                              | TFNNo2   |externallink2                                                                               | 
      | Campaign External Links - E2E Scenario 10_UMS | https://offline.uhcmedicaresolutions.com/lp/medicare-advantage-plans.html| 33111        |65656       |Yes            | Stone County |1-877-801-0043 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | 1-877-322-0782 |https://offline.uhcmedicaresolutions.com/lp/medicare-advantage-plans.html?wt.mc_id=8014272  |
      
    @CampaignExternal_Scenario10_AARP @ProdLP
    Examples:
      | Scenario                                      | externallink                                                             |zipcodeSingle |zipcodeMulti| isMultiCounty | county       | TFNNo         | TFNxpath1                   | workingHrs                              | TFNNo2         |externallink2                                                                             |
      | Campaign External Links - E2E Scenario 10_AMP | https://www.aarpmedicareplans.com/lp/medicare-advantage-plans.html   | 33111        |65656       |Yes            | Stone County |1-855-264-3792 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | 1-877-322-0782 |https://www.aarpmedicareplans.com/lp/medicare-advantage-plans.html?wt.mc_id=8014272   |
  ...
  @CampaignExternal_Scenario10_AARP @OfflineLP
    Examples:
      | Scenario                                       | zipcode| isMultiCounty | county       | MAplantype | TFNNo          | TFNxpath1                   | workingHrs                              | plantype | planname                             | TFNxpath                                                                                   | planIndex | planIndex1 | PDPplantype | PDPplanname                     | planyear | TFNxpath3                         | Medsupplantype | SNPPlanName | testPlans                                         | TFNxpath2                                                                                          | drug1 | drug2   | drug3   | drug4   | zipCode | TFNNo1         | pscCode | Drug Selection | DrugName-AutoSearch-Dosage-Package-Qty-Frequency-IsNotgeneric-Switch                                         | specialNeeds | isCoverageOpt | TFNxpath4             | TFNxpath5                           | defaultPharmacy                                                                           | externallink |
      | Campaign External Links - E2E Scenario 10_AMP |   33111 |No           | Miami-Dade County | MAPD       | 1-855-264-3792 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | MAPD     | AARP Medicare Advantage Choice Plan 2 (PPO) | //button[contains(@id,'sam-call-button')]//*[contains(@class,'sam__button__text desktop')] |         1 |          2 | PDP         | AARP MedicareRx Walgreens (PDP) | future   | (//a[contains(@class, 'tel')])[1] | MS             | SNP         | UnitedHealthcare Dual Complete Choice (PPO D-SNP) | //span[contains(@class,'sam__button__container')]//*[contains(@class,'sam__button__text desktop')] | Emsam | Lipitor | Orfadin | Humalog |   27053 | 1-866-408-5545 | 8012871 | Yes            | Lipitor,NO,Lipitor TAB 20MG,,,Month,1,YES,NO:morphine sulfate,NO,morphine sulfate CAP 10MG ER,,,Week,1,NO,NO | None         | PDP           | //*[@id='tty-number'] | (//span[contains(@class, 'tel')])[1]| Retail Chain Pharmacy (Pricing is based off of a Preferred Pharmacy for applicable plans.)| https://offline.aarpmedicareplans.com/lp/medicare-advantage-plans.html   |

  @CampaignExternal_Scenario10_UHC  @OfflineLP
    Examples:
      | Scenario                                       |zipcode| isMultiCounty | county       | MAplantype | TFNNo          | TFNxpath1                   | workingHrs                              | plantype | planname                             | TFNxpath                                                                                   | planIndex | planIndex1 | PDPplantype | PDPplanname                     | planyear | TFNxpath3                         | Medsupplantype | SNPPlanName | testPlans                                         | TFNxpath2                                                                                          | drug1 | drug2   | drug3   | drug4   | zipCode | TFNNo1         | pscCode | Drug Selection | DrugName-AutoSearch-Dosage-Package-Qty-Frequency-IsNotgeneric-Switch                                         | specialNeeds | isCoverageOpt | TFNxpath4             | TFNxpath5                           | defaultPharmacy                                                                           | externallink |
      | Campaign External Links - E2E Scenario 10_UMS    |33111 |No     | Miami-Dade County | MAPD       | 1-877-801-0043 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | MAPD     |AARP Medicare Advantage Choice Plan 2 (PPO) | //button[contains(@id,'sam-call-button')]//*[contains(@class,'sam__button__text desktop')] |         1 |          2 | PDP         | AARP MedicareRx Walgreens (PDP) | future   | (//a[contains(@class, 'tel')])[1] | MS             | SNP         | UnitedHealthcare Dual Complete Choice (PPO D-SNP) | //span[contains(@class,'sam__button__container')]//*[contains(@class,'sam__button__text desktop')] | Emsam | Lipitor | Orfadin | Humalog |   27053 | 1-866-408-5545 | 8012871 | Yes            | Lipitor,NO,Lipitor TAB 20MG,,,Month,1,YES,NO:morphine sulfate,NO,morphine sulfate CAP 10MG ER,,,Week,1,NO,NO | None         | PDP           | //*[@id='tty-number'] | (//span[contains(@class, 'tel')])[1]| Retail Chain Pharmacy (Pricing is based off of a Preferred Pharmacy for applicable plans.)| https://offline.uhcmedicaresolutions.com/lp/medicare-advantage-plans.html   |
