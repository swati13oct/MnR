...
#      | Working hrs | <workingHrs> |
    ...
    @CampaignExternal_Scenario11_AARP  @teamAvengersLP  @featureGate
    Examples:
      | Scenario                                      | zipcodeMulti | zipcodeSingle | isMultiCounty | county       | MAplantype | tfnFlag | TFNNo          | TFNxpath1                   | workingHrs                              | plantype | planname                             | TFNxpath                                                                                   | planIndex | planIndex1 | PDPplantype | PDPplanname                     | planyear | TFNxpath3                         | Medsupplantype | SNPPlanName | testPlans                                         | TFNxpath2                                                                                          | externallink                                                                                     |TFNNo2        |externallink2                                                                                                              |
      | Campaign External Links - E2E Scenario 11_AMP | 65656        | 33111         | Yes           | Stone County | MAPD       | true    | 1-855-264-3792 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | MAPD     | AARP Medicare Advantage Choice (PPO) | //button[contains(@id,'sam-call-button')]//*[contains(@class,'sam__button__text desktop')] | 1         | 2          | PDP         | AARP MedicareRx Walgreens (PDP) | future   | (//a[contains(@class, 'tel')])[1] | MS             | SNP         | UnitedHealthcare Dual Complete Choice (PPO D-SNP) | //span[contains(@class,'sam__button__container')]//*[contains(@class,'sam__button__text desktop')] | https://www.team-avengers-aarpmedicareplans.ocp-ctc-dmz-nonprod.optum.com/lp/medicare-plans.html |1-877-731-9158|https://www.team-avengers-aarpmedicareplans.ocp-ctc-dmz-nonprod.optum.com/lp/medicare-advantage-plans.html?wt.mc_id=8022212|


    @CampaignExternal_Scenario11_AARP   @StageLP @regressionAARP
    Examples:
      | Scenario                                      | zipcodeMulti | zipcodeSingle | isMultiCounty | county       | MAplantype | tfnFlag | TFNNo          | TFNxpath1                   | workingHrs                              | plantype | planname                             | TFNxpath                                                                                   | planIndex | planIndex1 | PDPplantype | PDPplanname                     | planyear | TFNxpath3                         | Medsupplantype | SNPPlanName | testPlans                                         | TFNxpath2                                                                                          | externallink                                                       |TFNNo2        |externallink2                                                                      |
      | Campaign External Links - E2E Scenario 11_AMP | 65656        | 33111         | Yes           | Stone County | MAPD       | true    | 1-855-264-3792 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | MAPD     | AARP Medicare Advantage Choice (PPO) | //button[contains(@id,'sam-call-button')]//*[contains(@class,'sam__button__text desktop')] | 1         | 2          | PDP         | AARP MedicareRx Walgreens (PDP) | future   | (//a[contains(@class, 'tel')])[1] | MS             | SNP         | UnitedHealthcare Dual Complete Choice (PPO D-SNP) | //span[contains(@class,'sam__button__container')]//*[contains(@class,'sam__button__text desktop')] | https://www.stage-aarpmedicareplans.uhc.com/lp/medicare-plans.html |1-877-731-9158|https://www.stage-aarpmedicareplans.uhc.com/lp/medicare-plans.html?wt.mc_id=8022212|

    @CampaignExternal_Scenario11_AARP    @OfflineLP 
    Examples:
      | Scenario                                      | zipcodeMulti | zipcodeSingle | isMultiCounty | county       | MAplantype | tfnFlag | TFNNo          | TFNxpath1                   | workingHrs                              | plantype | planname                             | TFNxpath                                                                                   | planIndex | planIndex1 | PDPplantype | PDPplanname                     | planyear | TFNxpath3                         | Medsupplantype | SNPPlanName | testPlans                                         | TFNxpath2                                                                                          | externallink                                                 |TFNNo2        |externallink2                                                                |
      | Campaign External Links - E2E Scenario 11_AMP | 65656        | 33111         | Yes           | Stone County | MAPD       | true    | 1-855-264-3792 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | MAPD     | AARP Medicare Advantage Choice (PPO) | //button[contains(@id,'sam-call-button')]//*[contains(@class,'sam__button__text desktop')] | 1         | 2          | PDP         | AARP MedicareRx Walgreens (PDP) | future   | (//a[contains(@class, 'tel')])[1] | MS             | SNP         | UnitedHealthcare Dual Complete Choice (PPO D-SNP) | //span[contains(@class,'sam__button__container')]//*[contains(@class,'sam__button__text desktop')] | https://offline.aarpmedicareplans.com/lp/medicare-plans.html |1-877-731-9158|https://offline.aarpmedicareplans.com/lp/medicare-plans.html?wt.mc_id=8022212|

    @CampaignExternal_Scenario11_AARP    @ProdLP @prodRegression
    Examples:
      | Scenario                                      | zipcodeMulti | zipcodeSingle | isMultiCounty | county       | MAplantype | tfnFlag | TFNNo          | TFNxpath1                   | workingHrs                              | plantype | planname                             | TFNxpath                                                                                   | planIndex | planIndex1 | PDPplantype | PDPplanname                     | planyear | TFNxpath3                         | Medsupplantype | SNPPlanName | testPlans                                         | TFNxpath2                                                                                          | externallink                                             |TFNNo2        |externallink2                                                            |
      | Campaign External Links - E2E Scenario 11_AMP | 65656        | 33111         | Yes           | Stone County | MAPD       | true    | 1-855-264-3792 | //a[@data-asset-name='TFN'] | Hours: 8 a.m. to 8 p.m., 7 days a week* | MAPD     | AARP Medicare Advantage Choice (PPO) | //button[contains(@id,'sam-call-button')]//*[contains(@class,'sam__button__text desktop')] | 1         | 2          | PDP         | AARP MedicareRx Walgreens (PDP) | future   | (//a[contains(@class, 'tel')])[1] | MS             | SNP         | UnitedHealthcare Dual Complete Choice (PPO D-SNP) | //span[contains(@class,'sam__button__container')]//*[contains(@class,'sam__button__text desktop')] | https://www.aarpmedicareplans.com/lp/medicare-plans.html |1-877-731-9158|https://www.aarpmedicareplans.com/lp/medicare-plans.html?wt.mc_id=8022212|
...
#      | TFN Xpath | <TFNxpath> |
    ...
    @CampaignExternalLink_E2E_Scenario_11_AARP    @StageLP @regressionAARP
    Examples:
      | Scenario                       | site | externallink                                                       | pscCode | workingHrs                              | zipcode | zipcodeMS | isMultiCounty | county            | MAplantype | planyear | plantype | planname                             | tfnFlag | TFNNo          | TFNxpath                                                                                   | TFNxpath1                            | PDPplantype | MSplantype | PDPplanName                     | SNPplanName                                       | TFNxpath3                         | TFNxpathMS1                      | TFNxpathMS2                      | planIndex | planIndex1 | TFNNo1         | TFNxpath5                            | testPlans                                         |
    ...
    @CampaignExternalLink_E2E_Scenario_11_AARP    @ProdLP @prodRegression
    Examples:
      | Scenario                       | site | externallink                                             | pscCode | workingHrs                              | zipcode | zipcodeMS | isMultiCounty | county            | MAplantype | planyear | plantype | planname                             | tfnFlag | TFNNo          | TFNxpath                                                                                   | TFNxpath1                            | PDPplantype | MSplantype | PDPplanName                     | SNPplanName                                       | TFNxpath3                         | TFNxpathMS1                      | TFNxpathMS2                      | planIndex | planIndex1 | TFNNo1         | TFNxpath5                            | testPlans                                         |
