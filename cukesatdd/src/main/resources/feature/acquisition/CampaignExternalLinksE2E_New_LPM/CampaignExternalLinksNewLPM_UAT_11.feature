...
#      | County Name     | <county>        |
    ...
    Examples:
      | Scenario                       | site | externallink                                                       | pscCode | workingHrs                              | zipcode | isMultiCounty | county            | MAplantype | planyear | plantype | planname                             | TFNNo          | TFNxpath                                                                                   | TFNxpath1                            | PDPplantype | MSplantype | PDPplanName                     | SNPplanName                                       | TFNxpath3                         | planIndex | planIndex1 | TFNNo1         | TFNxpath5                            | testPlans                                         |
      | E2E Scenario 11_medicare-plans | AARP | https://www.stage-aarpmedicareplans.uhc.com/lp/medicare-plans.html | 8012869 | Hours: 8 a.m. to 8 p.m., 7 days a week* | 33111   | NO            | Miami-Dade County | MAPD       | future   | MAPD     | AARP Medicare Advantage Choice (PPO) | 1-855-264-3792 | //button[contains(@id,'sam-call-button')]//*[contains(@class,'sam__button__text desktop')] | (//a[contains(@class,'tel tfn')])[1] | PDP         | MS         | AARP MedicareRx Walgreens (PDP) | UnitedHealthcare Dual Complete Choice (PPO D-SNP) | (//a[contains(@class, 'tel')])[3] | 1         | 2          | 1-866-408-5545 | (//span[contains(@class, 'tel')])[1] | UnitedHealthcare Dual Complete Choice (PPO D-SNP) |

    @CampaignExternalLink_E2E_Scenario_11_AARP    @OfflineLP
    Examples:
      | Scenario                       | site | externallink                                                 | pscCode | workingHrs                              | zipcode | isMultutiCounty | county            | MAplantype | planyear | plantype | planname                             | TFNNo          | TFNxpath                                                                                   | TFNxpath1                                    | PDPplantype | MSplantype | PDPplanName                     | SNPplanName                                       | TFNxpath3                         | planIndex | planIndex1 | TFNNo1         | TFNxpath5                            | testPlans                                         |
      | E2E Scenario 11_medicare-plans | AARP | https://offline.aarpmedicareplans.com/lp/medicare-plans.html | 8012869 | Hours: 8 a.m. to 8 p.m., 7 days a week* | 33111   | NO              | Miami-Dade County | MAPD       | future   | MAPD     | AARP Medicare Advantage Choice (PPO) | 1-855-264-3792 | //button[contains(@id,'sam-call-button')]//*[contains(@class,'sam__button__text desktop')] | (//a[contains(@class,'tel tfn desktop')])[1] | PDP         | MS         | AARP MedicareRx Walgreens (PDP) | UnitedHealthcare Dual Complete Choice (PPO D-SNP) | (//a[contains(@class, 'tel')])[1] | 1         | 2          | 1-866-408-5545 | (//span[contains(@class, 'tel')])[1] | UnitedHealthcare Dual Complete Choice (PPO D-SNP) |
