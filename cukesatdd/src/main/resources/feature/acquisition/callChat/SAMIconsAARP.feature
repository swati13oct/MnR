...
@samChatCall
	Scenario Outline: 1.19.1.1 To test the SAM chat Call icons on AARP site
...
@samChatVPULayer
 Scenario Outline: 1.19.1.1 To test the SAM chat Call icons on AARP site on Visitor Profile Page to intiate a chat
...
@samChat
Scenario Outline: 1.19.1.1 To test the SAM  Call icons on AARP site on <pagename> to intiate a chat
    Given the user is on the AARP medicare site landing page
	And user opens the page to validate on AARP
 	| pagename | <pagename> |
	Then the user validates whether call icon is visible on AARP 	
...
@header_1 @samChatCall_1 @samChatCallRegression
Examples: 
| pagename |
|/|
