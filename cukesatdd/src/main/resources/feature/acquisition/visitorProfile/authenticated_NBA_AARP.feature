...
Feature: 1.08. ACQ- Visitor Profile Authenticated NBA AARP
  ...
  Scenario Outline: Verify get started NBA for authenticated user on VPP page for <plantype> plantype
    ...
    Examples: 
      ...
      | AARP | chargersqa@23 | Password@4 | NO            |   10001 | New York County | MAPD     |

    @getStartedNBA_PDP_AARP @authenticatedNBAPDPAARP01
    Examples: 
      | site | userName      | password   | isMultiCounty | zipcode | county          | plantype |
      | AARP | chargersqa@23 | Password@4 | NO            |   10001 | New York County | PDP      |

    @getStartedNBA_MAPD_UHC01 @authenticatedNBAMAPDUHC01
    Examples: 
      | site | userName      | password   | isMultiCounty | zipcode | county          | plantype |
      | UHC  | chargersqa@23 | Password@4 | NO            |   10001 | New York County | MAPD     |

    @getStartedNBA_PDP_UHC02 @authenticatedNBAPDPUHC02
    Examples: 
      | site | userName      | password   | isMultiCounty | zipcode | county          | plantype |
      | UHC  | chargersqa@23 | Password@4 | NO            |   10001 | New York County | PDP      |
  ...
  Scenario Outline: Verify NBA for authenticated Visitor Profile VPP summary page for <plantype> plantype
    ...
    Examples: 
      ...
      | AARP | chargersqa@23 | Password@4 | NO            |   10001 | New York County | MAPD     | Lipitor  | AARP Medicare Advantage Prime (HMO) |
    ...
    Examples: 
      ...
      | UHC  | chargersqa@23 | Password@4 | NO              |   10001 | New York County | MAPD     | Lipitor  | TAB 10MG |       30 | Every 1 month |   90210 | 15 miles |       30 | Every 1 month | yes     | AARP Medicare Advantage Prime (HMO) |
