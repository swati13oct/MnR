...
Feature: 1.08 UAT-Site Search Flows
  ...
  Scenario Outline: <Scenario>: Verify Error handling on page mentioned -<pageName> : <searchValue> - <NewSearchValue>
    ...
    Examples: 
      ...
      | E2E Scenario 2_AMP | AARP | shop/compare/compare-ms.html              | ShopPlan: Compare           | Medicare    | Medicare | Empty          | [blank]     | Medicare         | InvalidCharacter | medicareeee | Medicare         | InvalidCharacter                                                            | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare         | InvalidCharacter | Unicorn |
      | E2E Scenario 2_AMP | AARP | shop/estimate/ms-costs.html               | ShopPlan: Estimate          | Medicare    | Medicare | Empty          | [blank]     | Medicare         | InvalidCharacter | medicareeee | Medicare         | InvalidCharacter                                                            | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare         | InvalidCharacter | Unicorn |
      | E2E Scenario 2_AMP | AARP | shop/compare/compare-ma-ms.html           | ShopPlan: Compare           | Medicare    | Medicare | Empty          | [blank]     | Medicare         | InvalidCharacter | medicareeee | Medicare         | InvalidCharacter                                                            | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare         | InvalidCharacter | Unicorn |
      | E2E Scenario 2_AMP | AARP | safe-shopping.html                        | ShopPlan: Shop              | Medicare    | Empty    | [blank]        | Medicare    | InvalidCharacter | medicareeee      | Medicare    | InvalidCharacter | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare                                                                    | InvalidCharacter | Unicorn          |         |
    ...
    Examples: 
      ...
      | E2E Scenario 2_UMS | UHC  | shop/compare/compare-ms.html              | ShopPlan: Compare           | Medicare    | Empty    | [blank]        | Medicare    | InvalidCharacter | medicareeee      | Medicare    | InvalidCharacter | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare                                                                    | InvalidCharacter | Unicorn          |         |
      | E2E Scenario 2_UMS | UHC  | shop/estimate/ms-costs.html               | ShopPlan: Estimate          | Medicare    | Empty    | [blank]        | Medicare    | InvalidCharacter | medicareeee      | Medicare    | InvalidCharacter | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare                                                                    | InvalidCharacter | Unicorn          |         |
      | E2E Scenario 2_UMS | UHC  | shop/compare/compare-ma-ms.html           | ShopPlan: Compare           | Medicare    | Empty    | [blank]        | Medicare    | InvalidCharacter | medicareeee      | Medicare    | InvalidCharacter | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare                                                                    | InvalidCharacter | Unicorn          |         |
      | E2E Scenario 2_UMS | UHC  | safe-shopping.html                        | ShopPlan: Shop              | Medicare    | Medicare | Empty          | [blank]     | Medicare         | InvalidCharacter | medicareeee | Medicare         | InvalidCharacter                                                            | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare         | InvalidCharacter | Unicorn |
    ...
    Examples: 
      ...
      | E2E Scenario 2_AMP | AARP | enroll/ms-apply.html                                       | ShopPlan: Enroll                        | Medicare    | Empty | [blank]        | Medicare    | InvalidCharacter | medicareeee    | Medicare    | InvalidCharacter | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare    | InvalidCharacter | Unicorn        |
    ...
    Examples: 
      ...
      | E2E Scenario 2_UMS | UHC  | enroll/ms-apply.html                                       | ShopPlan: Enroll                        | Medicare    | Empty | [blank]        | Medicare    | InvalidCharacter | medicareeee    | Medicare    | InvalidCharacter | ggahjkllllllllllllllllllllllllllllllllllllllllllljjjjjjjjjjjjjjjjjjjjjjjjjj | Medicare    | InvalidCharacter | Unicorn        |
