...
Feature: 1.13 ACQ AARP- To test SAM Icons in AARP site
  ...
  Scenario Outline: 1.19.1.1 To test the SAM icons on AARP site on <pagename>
    ...
    @header_1 @samChatCall_1 @samChatRegression @samChatRegression_AARP @prodRegression @globalfooter1
    Examples: 
      | site | pagename |
      | AARP | /        |
    ...
    @header_1 @samChatCall_1 @samChatRegression @samChatRegression_UHC @prodRegression
    Examples: 
      | site | pagename                              |
      | UHC  | /                                     |
