Feature:Medicare Education Pages flows for New Pages
  ...
  Scenario Outline: To validate components on New Medicare Education Page: <pageName> : <tfnXpath>
    ...
    Examples:
      ...
      | Avengers AMP | AARP | Alabama  | Medicare Education Hub Page | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    |
  ...
  Scenario Outline: To validate components on New Medicare Education Page: <pageName> : <tfnXpath>
    ...
    Examples:
      | Scenario           | site | geoState | pageName             | tfnXpath                                                       | tfnFlag | UHCUrl                      |
      | E2E Scenario 2_AMP | AARP | Alabama  | Coverage Options New | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: To validate components on New Medicare Education Page: <pageName> : <tfnXpath>
    ...
    Examples:
      | Scenario           | site | geoState | pageName             | tfnXpath                                                       | tfnFlag | UHCUrl                      |
      | E2E Scenario 4_AMP | AARP | Alabama  | Cost Basics Page New | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: To validate components on New Medicare Education Page :<pageName> : <tfnXpath>
    ...
    Examples:
      | Scenario           | site | geoState | pageName                           | tfnXpath                                                       | tfnFlag | UHCUrl                      |
      | E2E Scenario 5_AMP | AARP | Alabama  | Medicare Advantage Part C Plan New | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: To validate components on New Medicare Education Page :<pageName> : <tfnXpath>
    ...
    Examples:
      | Scenario           | site | geoState | pageName                     | tfnXpath                                                       | tfnFlag | UHCUrl                      |
      | E2E Scenario 5_AMP | AARP | Alabama  | Prescription Drugs Plans New | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: To validate components on New Medicare Education Page: <pageName> : <tfnXpath>
    ...
    Examples:
      | Scenario     | site | geoState | pageName                | tfnXpath                                                       | tfnFlag | UHCUrl                      |
      | Avengers AMP | AARP | Alabama  | Special Needs Plans New | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: To validate components on New Medicare Education Page: <pageName> : <tfnXpath>
    ...
    Examples:
      | Scenario     | site | geoState | pageName          | tfnXpath                                                       | tfnFlag | UHCUrl                      |
      | Avengers AMP | AARP | Alabama  | Original Medicare | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: To validate components on New Medicare Education Page: <pageName> : <tfnXpath>
    ...
    Examples:
      | Scenario     | site | geoState | pageName               | tfnXpath                                                       | tfnFlag | UHCUrl                      |
      | Avengers AMP | AARP | Alabama  | Overview of Plan Types | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: To validate components on New Medicare Education Page: <pageName> : <tfnXpath>
    ...
    Examples:
      | Scenario           | site | geoState | pageName      | tfnXpath                                                       | tfnFlag | UHCUrl                      |
      | E2E Scenario 6_AMP | AARP | Alabama  | How to Enroll | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: To validate components on New Medicare Education Page: <pageName> : <tfnXpath>
    ...
    Examples:
      | Scenario           | site | geoState | pageName                | tfnXpath                                                       | tfnFlag | UHCUrl                      |
      | E2E Scenario 6_AMP | AARP | Alabama  | Changing Medicare Plans | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: To validate components on New Medicare Education Page :<pageName> : <path>:<tfnXpath>
    ...
    Examples:
      ...
      | Avengers AMP | AARP | Alabama  | iep-guide.html  | Initial Enrollment Period Guide | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
      | Avengers AMP | AARP | Alabama  | wp65-guide.html | Working Past 65 Guide           | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | true    | https://www.myuhcagent.com/ |
