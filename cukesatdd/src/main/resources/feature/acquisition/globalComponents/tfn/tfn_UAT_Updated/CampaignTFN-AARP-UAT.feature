...
Feature: 1.19.1 UAT Scripts-To test Campaign TFN in all flows on AARP site
  ...
  Scenario Outline: <scenario> <zipcode> 1.0 Verify TFN through External Links
    ...
    Examples: 
      ...
      | Scenerio 9-ExternalLink - AMP | AARP |   97266 | MA         | 8000158 | Alabama | health-plans.html?zipcode=97266&WT.mc_id=8000158&county=420&state=36#/plan-summary | medicare-articles/medicare-made-clear.html | (//span[@class='heading-6']//u)[1] | shop/medicare-supplement-plans.html | //button[@id='sam-call-button']//span[contains(@class,'sam__button__text desktop')] | TiggerOptumID3331 | FebruarY##123$! | 1-844-850-6592 | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] | 1-844-850-6592 | 1-844-850-6592 | RRZ        |
