...
Feature: 1.19.1 UAT Scripts-To test Campaign TFN in all flows on AARP site
  ...
  Scenario Outline: <scenario> <zipcode>1.0 Verify TFN in VPP Plan Details and OLE pages, DCE,
    ...
    @Scenario_1_2_DirectTraffic_UAT_Medsup3.0 @campaignTFNStageMS
    Examples: 
  ...
  Scenario Outline: <scenario> <zipcode>Verify TFN for different plan types through Campaign Traffic
    ...
    @Scenario_2_CampaignTraffic_UAT_Medsup3.0 @campaignTFNProd @campaignTFNProdMS @campaignTFNStageMS
    Examples: 
      | scenario         | planyear | zipcode | MSplantype | dob        | UHCUrl                      | planName                            | MAplantype | PDPplantype | isMultutiCounty | county         | pscCode | site   | campaignUrl                                                   | maUrl                     | maTFN                                                   | pdpUrl                     | pdpTFN                                                         | snpUrl                                                                                                                                                                                                                                                                                                                      | snpTFN                       | decisionGuideUrl                                                          | decisionGuideTFN | agentApptUrl                                                  | agentApptTFN   | medSuppUrl                          | shoppages        | campaignUrl2       | TFNNo          | TFNxpath                          | MedsuppTFNNo   | MedsuppTFNxpath1                  | MedsuppTFNxpath                   | EnrollTFNxpath                    | MedsuppShopTFNxpath               | ShopTFNxpath                                                              | agentTFN       | agentXpath                          | planyear | FedTFNNo       | MedSupTFNNo    | sourceCode | MedsuppFormTFNxpath               | Precedence1PSC | sourceCode1 |
      | Scenario 2 - AMP | future   |   23666 | MS         | 01/01/1950 | https://www.myuhcagent.com/ | AARP Medicare Advantage Prime (HMO) | MA         | PDP         | NO              | Baldwin County | 8001038 | ulayer | /shop/medicare-advantage-plans?zipcode=97266&WT.mc_id=8001038 | enroll/ma-enrollment.html | //*[contains(@class,'call')]//a[contains(@class,'tel')] | enroll/pdp-enrollment.html | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | health-plans.html?zipcode=97266&deepLink=favPlansDeepLink&plantype=MA&year=2020&planId=H5253041000&planYear=2020&systemYear=2020&zipcode=97266&fipsCode=119&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=897749&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::897749!/details | //a[contains(@class, 'tel')] | health-plans/medicare-supplement-plans/medicare-information.html?vpp=true | //*[@id='tfn']   | health-plans/medicare-supplement-plans/agent-appointment.html | //*[@id='tfn'] | shop/medicare-supplement-plans.html | /contact-us.html | /?wt.mc_id=8001038 | 1-877-541-7755 | (//a[contains(@class, 'tel')])[3] | 1-844-887-2813 | //*[contains(@class,'tel right')] | (//a[contains(@class, 'tel')])[2] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[2] | //*[@id='sam-call-button']//span[contains(@class,'sam__button__text')][2] | 1-877-596-3258 | //*[contains(@class,'headline')]//a | future   | 1-877-541-7755 | 1-844-887-2813 | 9C9        | //*[contains(@class,'tel right')] |        8001038 | 9C9         |

    @Scenario_2_CampaignTraffic_UAT_Medsup4.0 @campaignTFNProd @campaignTFNProdMS @campaignTFNProdMS @campaignTFNStageMS
    Examples: 
      | scenario         | planyear | zipcode | MSplantype | dob        | UHCUrl                      | planName                            | MAplantype | PDPplantype | isMultutiCounty | county         | pscCode | site   | campaignUrl                                                   | maUrl                     | maTFN                                                   | pdpUrl                     | pdpTFN                                                         | snpUrl                                                                                                                                                                                                                                                                                                                      | snpTFN                       | decisionGuideUrl                                                          | decisionGuideTFN                            | agentApptUrl                                                  | agentApptTFN   | medSuppUrl                          | shoppages        | campaignUrl2       | TFNNo          | TFNxpath                          | MedsuppTFNNo   | MedsuppTFNxpath1                                   | MedsuppTFNxpath                   | EnrollTFNxpath                    | MedsuppShopTFNxpath               | ShopTFNxpath                                                              | agentTFN       | agentXpath                          | planyear | FedTFNNo       | MedSupTFNNo    | sourceCode | MedsuppFormTFNxpath                         | Precedence1PSC | sourceCode1 |
      | Scenario 2 - AMP | future   |   90210 | MS4.0      | 01/01/1950 | https://www.myuhcagent.com/ | AARP Medicare Advantage Prime (HMO) | MA         | PDP         | NO              | Baldwin County | 8001038 | ulayer | /shop/medicare-advantage-plans?zipcode=90210&WT.mc_id=8001038 | enroll/ma-enrollment.html | //*[contains(@class,'call')]//a[contains(@class,'tel')] | enroll/pdp-enrollment.html | //*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')] | health-plans.html?zipcode=90210&deepLink=favPlansDeepLink&plantype=MA&year=2020&planId=H5253041000&planYear=2020&systemYear=2020&zipcode=90210&fipsCode=119&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=897749&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::897749!/details | //a[contains(@class, 'tel')] | health-plans/medicare-supplement-plans/medicare-information.html?vpp=true | //span[contains(@class, 'invoca_swap_sam')] | health-plans/medicare-supplement-plans/agent-appointment.html | //*[@id='tfn'] | shop/medicare-supplement-plans.html | /contact-us.html | /?wt.mc_id=8001038 | 1-877-541-7755 | (//a[contains(@class, 'tel')])[3] | 1-844-887-2813 | //*[contains(@class, 'invoca_swap text-bold tel')] | (//a[contains(@class, 'tel')])[2] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[2] | //*[@id='sam-call-button']//span[contains(@class,'sam__button__text')][2] | 1-877-596-3258 | //*[contains(@class,'headline')]//a | future   | 1-877-541-7755 | 1-844-887-2813 | 9C9        | //span[contains(@class, 'invoca_swap_sam')] |        8001038 | 9C9         |

  ############################ Script 4: AMS Referral Traffic & Referral Visit###########################################
  @Scenario4_1_ExternalLink_AARP_UAT @UATRegression @campaignTFNProdMS @campaignTFNStageMS
  Scenario Outline: <scenario> <zipcode>4.7.1 Verify Externals referral plan functionalities
    ...
    Examples: 
      ...
      | Sc. 04.01 - 4.02 | ulayer |   23666 | 8003093 | shop.html | (//a[contains(@class, 'tel')])[1] | shop/compare/compare-ms.html | (//a[contains(@class, 'tel')])[1] | shop/dual-special-needs-plans.html | (//a[contains(@class, 'tel')])[1] | contact-us.html | (//*[contains(@class,'callus')]//a[contains(@class, 'tel tfn')])[1] | enroll/ma-enrollment.html | (//a[contains(@class, 'tel')])[2] | health-plans.html?product=medsup&EBRC=https://www.aarpmedicaresupplement.com/medicare-information-guide.html&intref=AARPMedicareSupplement.com&zipcode=97266&WT.mc_id=23W&#/plan-summary | 11/13/1940 | John      | Carry    | 1-866-242-0247 | 1-855-888-1640 | //*[@id='sam-call-button']//span[contains(@class,'sam__button__text')][2] | (//a[contains(@class, 'tel')])[4] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] | (//span[contains(@class,'telephone')])[1] | PDP         | MA         | MS             | next     | 1-855-888-1640 | 1-866-242-0247 | 23W        |
  ...
  @Scenario_7_DirectTraffic_Email_UAT @UATRegression @campaignTFNProdMS @campaignTFNStageMS
  ...
  Scenario Outline: <scenario> <zipcode> Verify TFN through External Links PDP
    ...
    @Scenario_8_External_Link_PDP_UAT_Medsup3.0 @campaignTFNProdMS @campaignTFNStageMS
    Examples: 
  ...
  Scenario Outline: <scenario> <zipcode> 1.0 Verify TFN through External Links
    ...
    @Scenario_9_External_Link_UAT_Medsup3.0 @campaignTFNStageMS
    Examples: 
      ...
      | Scenerio 9-ExternalLink - AMP | AARP |   23666 | MA         | 8000158 | Alabama | health-plans.html?zipcode=97266&WT.mc_id=8000158&county=420&state=36#/plan-summary | medicare-articles/medicare-made-clear.html | (//span[@class='heading-6']//u)[1] | shop/medicare-supplement-plans.html | //button[@id='sam-call-button']//span[contains(@class,'sam__button__text desktop')] | TiggerOptumID3331 | FebruarY##123$! | 1-844-850-6592 | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] | 1-844-850-6592 | 1-844-850-6592 | RRZ        |

    @Scenario_9_External_Link_UAT_Medsup4.0 @campaignTFNStageMS
    Examples: 
      | scenario                      | site | zipcode | MAplantype | pscCode | state   | campaignUrl                                                                        | medEdURL1                                  | medEdTFN                           | shoppagesUrl                        | shoppagesTFN                                                                        | userName          | password        | TFNNo          | TFNxpath                          | EnrollTFNxpath                    | ShopTFNxpath                      | FedTFNNo       | MedSupTFNNo    | sourceCode |
  ...
  Scenario Outline: <scenario> <zipcode>1.0 Verify TFN and source code from URL
    ...
    @Scenario_10_SourceCodeInURL_UAT_Medsup3.0 @IS_TFN_E2E_Scenario_5 @campaignTFNStageMS
    Examples: 
