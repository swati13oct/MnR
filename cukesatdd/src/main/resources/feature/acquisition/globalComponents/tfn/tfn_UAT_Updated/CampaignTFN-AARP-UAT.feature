...
Feature: 1.19.1 UAT Scripts-To test Campaign TFN in all flows on AARP site
  ...
  Scenario Outline: <scenario> 1.0 Verify TFN through External Links
    ...
    Examples: 
	  ...
	  | Scenerio 9-ExternalLink - AMP |  AARP| 10001 | MA         | 8016308 | Alabama | health-plans.html?zipcode=90210&WT.mc_id=8016308&county=200&state=06#/plan-summary | medicare-articles/medicare-made-clear.html | (//span[@class='heading-6']//u)[1] | shop/medicare-supplement-plans.html | //button[@id='sam-call-button']//span[contains(@class,'sam__button__text desktop')] | TiggerOptumID39 | TiggerTigger7 | 1-844-850-6592 | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] |1-877-755-5067|1-877-755-5067|2DA|
