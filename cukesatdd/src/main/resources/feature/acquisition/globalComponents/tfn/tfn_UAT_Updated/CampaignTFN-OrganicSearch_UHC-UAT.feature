...
Feature: UAT-Scripts-To test Organic Search Campaign TFN on UHC site
  ...
  Scenario Outline: - <scenario> <zipcode> 3.1 Google search UHC Medicare Advantage Plan
    ...
    @Scenario3_1_GoogleBingSearch_UHC_UAT_Medsup3.0 @prodRegression @campaignTFNProdMS
    Examples: 
...
# Removing prod tag and adding regression tag - scenario taking more time in prod thus inclusing coverage in lower env.
    ...
    Examples: 
      | scenario       | pscCode | Precedence1PSC | zipcode | county          | isMultutiCounty | maUrl                              | medicareeduUrl                                    | shoppages        | medicarearicleUrl       | medicareMadeclearUrl                       | medicareEligibilityUrl                            | MAplantype | MSplantype | PDPplantype | TFNNo          | MedsuppTFNNo   | TFNNo2         | TFNxpath                                    | MedsuppTFNxpath                   | TFNxpath2                           | plantype | planyear | FedTFNNo       | MedSupTFNNo    | sourceCode | FedTFNNo1      | MedSupTFNNo1   | sourceCode1 |
      | Sc. 3.08.01 - UMS_MS_3.0 |  880188 |         880187 |   24010 | New York County | NO              | shop/medicare-advantage-plans.html | /medicare-education/medicare-advantage-plans.html | /contact-us.html | /medicare-articles.html | medicare-articles/medicare-made-clear.html | medicare-articles/eligibility-and-enrollment.html | MA         | MS         | PDP         | 1-800-607-2877 | 1-888-378-0849 | 1-800-811-2341 | //span[contains(@class, 'invoca_swap_sam')] | //*[contains(@class,'tel right')] | (//a[contains(@class, 'tel')])[1]/u | MAPD     | future   | 1-800-607-2877 | 1-888-378-0849 | 8EC        | 1-800-811-2341 | 1-888-378-0849 | 8EC         |
  ...
  @Scenario_4_1to8_Precedence_1_UHC_UAT @UATRegression @campaignTFNProdMS
  Scenario Outline: <scenario> Campaign Precedence Logic No 1 for UHC
    ...
    Examples: 
      ...
      | Scenario 4a: Campaign Precedence- UMS | blayer |   24010 | MA         | MS         |         800085 |         800086 |         800086 |         880180 |         880188 |         880189 | /?WT.mc_id=800085 | /?WT.mc_id=800086 | /health-plans/medicare-advantage-plans/available-plans.html?WT.mc_id=8001533&county=053&state=27#/plan-summary | //*[contains(@class,'tel right')] | (//a[contains(@class, 'tel')])[3] | 1-888-262-3289 | 1-866-260-5005 | 1-888-581-8578 | 1-877-596-3258 | 1-800-607-2877 | 1-888-378-0849 | 1-800-850-8659 | 1-888-262-3289 | 1-866-260-5005 | 22A         | 1-888-581-8578 | 1-866-260-5005 | 22A         | 1-888-581-8578 | 1-866-260-5005 | 22A         | 1-877-596-3258 | 1-888-378-0254 | AEP         | 1-800-607-2877 | 1-888-378-0849 | 8EC         |
  ...
  Scenario Outline: <scenario> <zipcode> Campaign Precedence Logic No 4b for UHC
    ...
    @Scenario_4_1to8_Precedence_1_UHC_UAT_Medsup3.0 @campaignTFNProdMS
    Examples: 
      ...
      | Scenario 4b: Campaign Precedence- UMS | blayer |   24010 | MA         | MS         |         800085 |         800086 |         800086 |         880180 |         880188 |         880189 | /?WT.mc_id=800085 | /?WT.mc_id=800086 | /health-plans/medicare-advantage-plans/available-plans.html?WT.mc_id=8001533&county=053&state=27#/plan-summary | //*[contains(@class,'tel right')] | //span[contains(@class, 'invoca_swap_sam')] | 1-888-262-3289 | 1-866-260-5005 | 1-888-581-8578 | 1-877-596-3258 | 1-800-607-2877 | 1-888-378-0849 | 1-800-850-8659 | future   | 1-800-850-8659 | 1-888-378-0849 | 8EC         |

    @Scenario_4_1to8_Precedence_1_UHC_UAT_Medsup4.0 @prodRegression @campaignTFNProdMS
    Examples: 
      | scenario                              | site   | zipcode | MAplantype | MSplantype | Precedence1PSC | Precedence2PSC | Precedence3PSC | Precedence4PSC | Precedence5PSC | Precedence6PSC | campaign2Url      | campaign3Url      | campaign4Url                                                                                                   | MedsuppTFNxpath                                    | TFNxpath                                    | TFNNo          | MedsuppTFNNo   | TFNNo1         | MedsuppTFNNo1  | TFNNo2         | MedsuppTFNNo2  | TFNNo3         | planyear | FedTFNNo6      | MedSupTFNNo6   | sourceCode6 |
