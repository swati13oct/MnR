...
Feature: UAT-SCripts To test Campaign TFN in all flows on UHC site
  ...
  Scenario Outline: <scenario> <zipcode> Verify TFN for different plan types through Campaign Traffic
    ...
    Examples: 
      ...
      | Scenario 2 - UMS Medsup 3.0| blayer | 8003728 |   23666 | health-plans/medicare-advantage-plans/available-plans.html?WT.mc_id=8003728&county=053&state=27#/plan-summary | enroll/ma-enrollment.html | /contact-us.html | 1-855-448-4586 | 1-866-271-0607 | (//a[contains(@class, 'tel')])[3] | //*[@id='sam-call-button']//span[contains(@class,'sam__button__text')][2] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | MA         | MS         | PDP         | SNP         | 1-855-448-4586 | 1-866-271-0607 | G3Y        | //*[contains(@class,'tel right')] | 01/01/1950 | //*[@id='tfn']   | //*[contains(@class,'headline')]//a |
  ...
  Scenario Outline: <scenario>  Verify TFN through External Links
    ...
    @Scenario_6_External_Link_UHC_UAT_Medsup3.0 @campaignTFNStageMS @campaignProdMS
    Examples: 
      ...
      | Scenerio 6-ExternalLink - UMS1 Medsup 3.0 | blayer | Alabama | 8002977 | health-plans/medicare-advantage-plans/available-plans.html?zipcode=23666&WT.mc_id=8002977&county=420&state=36&coveragePerson=M&originatingSite=https%253A%252F%252Fwww.myuhcplans.com%252Fmorganstanley&subdomain=group#/plan-summary | /medicare-articles.html | (//span[@class='heading-6']//u)[1] | shop/medicare-supplement-plans.html | TiggerOptumID3331 | FebruarY##123$! | 1-877-755-5345 | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] | MA         | 1-877-755-5345 | 1-877-755-5345 | MOR        |

    @Scenario_6_External_Link_UHC_UAT_Medsup4.0 @campaignTFNStageMS @campaignProdMS
    Examples: 
      | scenario                       | site   | state   | pscCode | campaignUrl                                                                                                                                                                                                                           | medEdURL1               | medEdTFN                           | shoppagesUrl                        | userName          | password        | TFNNo          | TFNxpath                          | EnrollTFNxpath                    | ShopTFNxpath                      | MAplantype | FedTFNNo       | MedSupTFNNo    | sourceCode |
      | Scenerio 6-ExternalLink - UMS2 Medsup 4.0| blayer | Alabama | 8002977 | health-plans/medicare-advantage-plans/available-plans.html?zipcode=90210&WT.mc_id=8002977&county=420&state=36&coveragePerson=M&originatingSite=https%253A%252F%252Fwww.myuhcplans.com%252Fmorganstanley&subdomain=group#/plan-summary | /medicare-articles.html | (//span[@class='heading-6']//u)[1] | shop/medicare-supplement-plans.html | TiggerOptumID3331 | FebruarY##123$! | 1-877-755-5345 | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] | MA         | 1-877-755-5345 | 1-877-755-5345 | MOR        |
  ...
  Scenario Outline: <scenario> <zipcode>1.0 Verify TFN and source code from URL
    ...
    @Scenario_7_SourceCodeInURL_UAT_Medsup3.0 @campaignTFNStageMS @campaignTFNProdMS
    Examples: 
      ...
      | Scenerio 7-SourceCodeInURL - UMS Medsup 3.0 | BLayer |   23666 | MA         | MS         |  810106 | Alabama | ?WT.mc_id=5T9 | medicare-education/medicare-advantage-plans.html | (//span[@class='heading-6']//u)[1] | shop/medicare-supplement-plans.html | //button[@id='sam-call-button']//span[contains(@class,'sam__button__text desktop')] | TiggerOptumID3331 | FebruarY##123$! | 1-844-850-6592 | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] | 1-800-850-6807 | 1-866-327-1593 | 5T9        |

    @Scenario_7_SourceCodeInURL_UAT_Medsup4.0 @campaignTFNStageMS @campaignTFNProdMS
    Examples: 
      | scenario                         | site   | zipcode | MAplantype | MSPlantype | pscCode | state   | campaignUrl   | medEdURL1                                        | medEdTFN                           | shoppagesUrl                        | shoppagesTFN                                                                        | userName          | password        | TFNNo          | TFNxpath                          | EnrollTFNxpath                    | ShopTFNxpath                      | FedTFNNo       | MedSupTFNNo    | sourceCode |
      | Scenerio 7-SourceCodeInURL - UMS Medsup 4.0| BLayer |   90210 | MA         | MS4.0      |  810106 | Alabama | ?WT.mc_id=5T9 | medicare-education/medicare-advantage-plans.html | (//span[@class='heading-6']//u)[1] | shop/medicare-supplement-plans.html | //button[@id='sam-call-button']//span[contains(@class,'sam__button__text desktop')] | TiggerOptumID3331 | FebruarY##123$! | 1-844-850-6592 | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] | 1-800-850-6807 | 1-866-327-1593 | 5T9        |
  ...
  Scenario Outline: <scenario> <zipcode>1.0 Verify TFN show correctly from UHC Referral Traffic
    ...
    @Scenario_IS-4_UHCReferralTraffic_UAT_Medsup4.0 @campaignTFNStageMS @IS_TFN_E2E_Scenario_4 @campaignTFNProdMS
    Examples: 
  ...
  Scenario Outline: <scenario> <zipcode>1.0 Verify TFN in MS Plan Details, MS Summary, MS Visitor profie, and MS OLE pages
    ...
    Examples: 
      @Scenario_1_2_DirectTraffic__UHC_UAT_medsup4.0 @campaignTFNStageMS @IS_TFN_Scenario_6  @campaignTFNProdMS
      Examples:
