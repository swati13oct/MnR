...
Feature: UAT-SCripts To test Campaign TFN in all flows on UHC site
  ...
  Scenario Outline: <scenario> <zipcode> Verify TFN for different plan types through Campaign Traffic
    ...
    Examples: 
      ...
      | Scenario 2 - UMS | blayer | 8003728 |   23666 | health-plans/medicare-advantage-plans/available-plans.html?WT.mc_id=8003728&county=053&state=27#/plan-summary | enroll/ma-enrollment.html | /contact-us.html | 1-855-448-4586 | 1-866-271-0607 | (//a[contains(@class, 'tel')])[3] | //*[@id='sam-call-button']//span[contains(@class,'sam__button__text')][2] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | MA         | MS         | PDP         | SNP         | 1-855-448-4586 | 1-866-271-0607 | G3Y        | //*[contains(@class,'tel right')] | 01/01/1950 | //*[@id='tfn']   | //*[contains(@class,'headline')]//a |
  ...
  Scenario Outline: <scenario>  Verify TFN through External Links
    ...
    Examples: 
      ...
      | Scenerio 6-ExternalLink - UMS1 | blayer | Alabama | 8002977 | health-plans/medicare-advantage-plans/available-plans.html?zipcode=23666&WT.mc_id=8002977&county=420&state=36&coveragePerson=M&originatingSite=https%253A%252F%252Fwww.myuhcplans.com%252Fmorganstanley&subdomain=group#/plan-summary | /medicare-articles.html | (//span[@class='heading-6']//u)[1] | shop/medicare-supplement-plans.html | TiggerOptumID3331 | FebruarY##123$! | 1-877-755-5345 | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[3] | (//a[contains(@class, 'tel')])[4] | MA         | 1-877-755-5345 | 1-877-755-5345 | MOR        |
