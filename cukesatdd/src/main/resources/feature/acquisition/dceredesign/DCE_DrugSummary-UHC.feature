...
@DCE_DrugSummary_ValidatePage_UHC
  ...
  Scenario Outline: Test to verify plan toggle is visible on Drug summary page
   ...
   # And user selects plan year on UHC
    ...
    And user clicks on change pharmacy link from details page in UHC
    Then details page change pharmacy modal should be displayed in UHC
    And user verify details page change pharmacy modal in UHC
      ...
      | health-plans/estimate-drug-costs.html/getstarted | DCE Redesign - Get Started |Lipitor|10001 |
        ...
        @dceRedesignExtraHelpAlert_UHC @F477268
   ...
   # And user selects plan year on UHC
    ...
    And user should be navigated to Review drug cost estimate page on UHC
    And user should be able to see Medicare Advantage plan by default on UHC
     And user should verify the Extra help in UHC
     And user click on View Drug Pricing Modal in UHC
     And user should verify the drug extra qualification in drug pricing popup in UHC
