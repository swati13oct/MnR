...
Feature: 1.10.3 DCE-REDESIGN- To test integration flows between DCE and VPP from various pages
  ...
  Scenario Outline: 1.10.3.2 To test the DCE Redesign flow for PlanType :  <plantype> from vpp Plan Summary
    ...
    Examples: 
      ...
      | AARP |   90210 | future   | MAPD     | none   | no              | Orkambi | Lipitor | AARP Medicare Advantage Prime (HMO) | Every 3 Months | true       |
    ...
    Examples: 
      ...
      | UHC  |   90210 | future   | MAPD     | none   | no              | Orkambi | Lipitor | AARP Medicare Advantage Prime (HMO) | Every 3 Months |
