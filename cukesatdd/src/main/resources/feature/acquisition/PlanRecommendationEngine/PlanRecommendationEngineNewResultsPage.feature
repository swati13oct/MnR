...
Feature: Plan Recommendation Engine flow - Verify PRE New Results page in plan Recommendation Engine
  ...
  Scenario Outline: <Zipcode>, <isMultiCounty> , <county> , <isCoverageOpt> , <specialNeeds>  , <doctors> , <DoctorsName> , <isMultiDoctor> , <Drug Selection> , <DrugName-AutoSearch-Dosage-Package-Qty-Frequency-IsNotgeneric-Switch>  , <Dental-Hearing-Vision-Fitness> , <costPreferenceOption> - To validate MAPD Tile in PRE Result page
    ...
    Examples: 
      ...
      | AARP |   35035 | YES           | Bibb County | MAPD          | Chronic      | Lookup  | Michael W Luther MD:Watkins Roschanda NP:Preston Loretta NP:Gantt Emily NP | No            | Yes            | Lipitor,NO,Lipitor TAB 20MG,,,Day,1,YES,NO                                   | No,No,Yes,No                  | Lower                | both           | Doctors, Vision | Plan K,Burnestine P Taylor MD,N/A        |
    ...
    Examples: 
      ...
      | UHC  |   35035 | YES           | Bibb County | MAPD          | Chronic      | Lookup  | Michael W Luther MD:Watkins Roschanda NP:Preston Loretta NP:Gantt Emily NP | No            | Yes            | Lipitor,NO,Lipitor TAB 20MG,,,Day,1,YES,NO                                   | No,No,Yes,No                  | Lower                | both           | Doctors, Vision | Plan K,Burnestine P Taylor MD,N/A        |
