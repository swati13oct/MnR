...
Feature: Plan Recommendation Engine Ranking - Verify PRE flows functionalities with recommendation and Ranking with API results
  ...
  @PRE @FutureAPIRanking @MAPDFlowRanking @SanityTest
  Scenario Outline: <Zipcode>, <isMultiCounty> , <county> , <isCoverageOpt> , <specialNeeds> , <travel> , <doctors> , <DoctorsName> , <isMultiDoctor> , <Drug Selection> , <DrugName-AutoSearch-Dosage-Package-Qty-Frequency-IsNotgeneric-Switch> , <pharmacyoption> , <Dental-Hearing-Vision-Fitness> , <costPreferenceOption> - To validate API Ranking for MA plans in PRE future year
    ...
    Examples: 
      ...
      |   90210 | NO            | Los Angeles | MAPD          | Nursing | withinUS | Lookup  | Jennifer T. Dixon, NP | NO            | Yes            | Lipitor,NO,Lipitor TAB 20MG,,,3,YES,NO:morphine sulfate,NO,morphine sulfate CAP 10MG ER,,,1,NO,NO | Online         | Yes,Yes,Yes,Yes                  | Lower                |
  ...
  @PRE @planrecommendation @APIRanking @MAFlowRanking @SanityTest @PRERegression6
  Scenario Outline: <Zipcode>, <isMultiCounty> , <county> , <isCoverageOpt> , <specialNeeds> , <travel> , <DoctorsName> , <Dental-Hearing-Vision-Fitness> , <costPreferenceOption> - To validate MA flow functions for MA and MS plans in PRE
    ...
    Examples: 
      ...
      |   30012 | YES           | Walton County | MA            | Medicaid,Nursing | withinUS | Lookup     | Tommy Tally | NO            | Yes,Yes,Yes,Yes               | Lower                |
