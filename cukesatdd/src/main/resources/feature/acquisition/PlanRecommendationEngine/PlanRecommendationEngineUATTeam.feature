...
Feature: PRE_UAT - Verify UAT Scenarios in PRE
  ...
  @PRE @PRE_UAT_DCE_VPP_Scenario-4_Updated @F550383 @MDScenario
  Scenario Outline: <Zipcode>, <isMultiCounty> , <county> , <isCoverageOpt> , <specialNeeds> , <travel> , <DoctorsName> , <Dental-Hearing-Vision-Fitness> , <costPreferenceOption> - To validate Drugs in VPP page when MA flow complete in PRE and Add drugs in DCE
    Given the user is on UHC medicare acquisition site PRE landing page
      | Site | <site> |
    ...
    Examples: 
      ...
      | AARP |   65656 | NO            | Christian | MA            | Medicaid,chronic,nursing | Lookup  | Higgins, Mina K, FNP   | NO            | Yes,No,Yes,No                 | Lower                | both           | Dental , Doctors | Lipitor,YES,Lipitor TAB 10MG,,,Month,1,YES,NO                                | PDP            | LP (HMO D-SNP),Link | Medicaid       |     21213 | Baltimore City |
    ...
    Examples: 
      ...
      | UHC  |   65656 | NO            | Christian | MA            | Medicaid,chronic,nursing | Lookup  | Higgins, Mina K, FNP   | NO            | Yes,No,Yes,No                 | Lower                | both           | Dental , Doctors | Lipitor,YES,Lipitor TAB 10MG,,,Month,1,YES,NO                                | PDP            | LP (HMO D-SNP),Link | Medicaid       |     21213 | Baltimore City |
