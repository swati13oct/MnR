...
Feature: To test DCE to VPP plan Summary flow  in UMS site
  ...
  @dceThroughPlanSummaryNonAepUHC @uhc @DCE_Regression_Blayer04 @dce1 @uhcDce1
  ...
  @dceThroughPlanDetailsUHC1 @uhc @DCE_Regression_Blayer05 @dce2 @uhcDce
  ...
  @dceThroughPlanDetailsUHC2 @uhc @DCE_Regression_Blayer06 @dce3 @uhcDce
