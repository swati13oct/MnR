...
Feature: To test VPP Plan Summary Page in AARP Site
  ...
  Scenario Outline: TID: <TID> -plan type: <plantype> - Verify plan cards on plan summary page in AARP site
    ...
    Examples: 
      ...
      | 15545 |   90210 | NO              | Los Angeles County | MAPD     | AARP MedicareComplete SecureHorizons Plan 1 (HMO)    | $0             | $0  copay            | $0  copay  | Yes              | $3,400             | $4  copay                                  |                                                       |  |
      | 15546 |   28105 | YES             | Mecklenburg County | SNP      | UnitedHealthcare Dual Complete (HMO SNP)             | $0             | $0  copay            | $0  copay  | No               | $0 - $6,700        | $0, $1.25, $3.40 copay, or 15% coinsurance |                                                       |  |
      | 15551 |   90210 | NO              | Los Angeles County | MA       | AARP MedicareComplete SecureHorizons Essential (HMO) | $0             | $5  copay            | $10  copay | Yes              | $4,900             | No drug coverage                           |                                                       |  |
