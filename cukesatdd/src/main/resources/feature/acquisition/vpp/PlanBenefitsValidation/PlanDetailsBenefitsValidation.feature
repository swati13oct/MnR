...
Feature: ACQ-Plan benefits validation
  ...
  Scenario Outline: Verify plan benefits on the Plan Details Page for provided plan provided in Excel : <excelPath> and Sheet : <workSheet>
    ...
    @planDetailsBenefitsAARP01 @planDetailsBenefits
    Examples: 
      ...
      | Plan Details Benefits_Data | PDPSheet2021_1 | UHC  |
      | Plan Details Benefits_Data | PDPSheet2021_2 | UHC  |

    # Prod runners
    @planDetailsBenefitsProd
    Examples: 
      | excelPath                  | workSheet   | site |
      | Plan Details Benefits_Data | Prod_Sheet1 | UHC  |
      | Plan Details Benefits_Data | Prod_Sheet2 | UHC  |
      | Plan Details Benefits_Data | Prod_Sheet3 | UHC  |
      | Plan Details Benefits_Data | Prod_Sheet4 | UHC  |
      | Plan Details Benefits_Data | Prod_Sheet1 | AARP |
      | Plan Details Benefits_Data | Prod_Sheet2 | AARP |
      | Plan Details Benefits_Data | Prod_Sheet3 | AARP |
      | Plan Details Benefits_Data | Prod_Sheet4 | AARP |

    # Old code below to be removed later
    @planDetailsBenefitsAARP01_NextYear @planDetailsBenefitsAARP
    Examples: 
      | excelPath | workSheet | site |

    #    | Plan Details Benefits_Data | Sheet2021_1  | AARP |
    @planDetailsBenefitsAARP02_NextYear @planDetailsBenefitsAARP
    Examples: 
      | excelPath | workSheet | site |

    #    | Plan Details Benefits_Data | Sheet2021_2  | AARP |
    @planDetailsBenefitsAARP03_NextYear @planDetailsBenefitsAARP
    Examples: 
      | excelPath | workSheet | site |
    ...
    #     | Plan Details Benefits_Data | Prod_Sheet1   | UHC |
    @planDetailsBenefitsUHC02_Prod
    Examples: 
      | excelPath | workSheet | site |

    #     | Plan Details Benefits_Data | Prod_Sheet2   | UHC |
    @planDetailsBenefitsUHC03_Prod
    Examples: 
      | excelPath | workSheet | site |

    #     | Plan Details Benefits_Data | Prod_Sheet3  | UHC |
    @planDetailsBenefitsUHC04_Prod
    Examples: 
      | excelPath | workSheet | site |

    #     | Plan Details Benefits_Data | Prod_Sheet4   | UHC |
    @planDetailsBenefitsAARP01_Prod
    Examples: 
      | excelPath | workSheet | site |

    #     | Plan Details Benefits_Data | Prod_Sheet1   | AARP |
    @planDetailsBenefitsAARP02_Prod
    Examples: 
      | excelPath | workSheet | site |

    #     | Plan Details Benefits_Data | Prod_Sheet2   | AARP |
    @planDetailsBenefitsAARP03_Prod
    Examples: 
      | excelPath | workSheet | site |

    #      | Plan Details Benefits_Data | Prod_Sheet3  | AARP |
    @planDetailsBenefitsAARP04_Prod
    Examples: 
      | excelPath | workSheet | site |
  #    | Plan Details Benefits_Data | Prod_Sheet4   | AARP |
