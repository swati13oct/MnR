...
Feature: VPP Testharness flow Navigations for AARP Site
  ...
  Scenario Outline: TID: <TID> -zipcode: <zipcode> - Navigation from Med Sup Deeplink with below parameters to plan summary page
    ...
    Examples: 
      ...
      | 00021 | vppdeeplink | Ulayer   |   10001 | No            | Los Angeles County | MAPD     | Plan F   | health-plans/medicare-supplement-plans.html | 2018-01-01 | https://www.aarpmedicaresupplement.uhc.com/medicare-information-guide.html | 2020-09-01 | AARPMedicareSupplement.com | 2018-01-01 | Male       | Yes         | 1950-03-25 |
      | 00022 | vppdeeplink | Ulayer   |   10001 | No            | Los Angeles County | MAPD     | Plan F   | health-plans.html                           | 2018-01-01 |                                                                            | 2020-09-01 |                            | 2018-01-01 | Male       | Yes         | 1950-03-25 |
  ...
  Scenario Outline: TID: <TID> -zipcode: <zipcode> - Navigation from Provider Search with below parameters to plan summary page
    Given the user is on VPP TestHarness page for AARP
      | Site Name       | <siteName> |
      | TestHarnessPage | <THPage>   |
    When the user enters Mandatory fields on ProviderSearch Navigates to provider Page for AARP
      | Zip Code        | <zipcode>       |
      | County Name     | <county>        |
      | Is Multi County | <isMultiCounty> |
      | Plan Year       | <planyear>      |
