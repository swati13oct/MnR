...
Feature: 1.10-VBF-Acq-To test plan summary in vpp flow AARP site
  ...
  Scenario Outline: UserStory: <UID> -plan type: <PlanType> - Verify Eyewear Credit Benefits in Plan Details for provided plan
    ...
    Examples: 
      ...
      | US1580458 - AARP - Multiple Eyewear Credit |   80920 | No              | El Paso County      | MAPD     | AARP MedicareComplete SecureHorizons Essential (HMO)     | Eyewear     | limit up to $70 for frames or $105 for contacts per every 2 years  |
