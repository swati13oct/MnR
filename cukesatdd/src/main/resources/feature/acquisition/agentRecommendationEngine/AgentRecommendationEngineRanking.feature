...
Feature: Agent Recommendation Engine - Verify ARE elements
  ...
  Scenario Outline: - <Email> To Verify agent login and validate ARE dropdown UI
    ...
    Examples: 
      ...
      | ocpuser | Password@123 | ATDD1STG@MEMBERDD.COM | None          | current  |
  ...
  Scenario Outline: - <Email> To Verify agent login and validate Plans reorder in ARE
    ...
    Examples: 
      ...
      #| ocpuser  | Password@123 | ATDD5STG@MEMBERDD.COM | None          | current  |          10001 | fitness,lowpremium | YES                | YES           | Mosaic(HMO),Choice(PPO),Essential(HMO),Essential(RegionalPPO),Plan2(HMO),Plan1(RegionalPPO),Plan3(RegionalPPO),Plan1(HMO),Plan4(RegionalPPO) |
      | ocpuser | Password@123 | ATDD5STG@MEMBERDD.COM | None          | current  |          10001 | fitness,lowpremium                    | YES                | YES           | [blank]    |
      | ocpuser | Password@123 | APISTG@MEMBERDD.COM   | None          | current  |          10001 | hearing,vision,lowpremium,drug,doctor | YES                | YES           | [blank]    |
  ...
  Scenario Outline: - <Email> To Verify agent login and validate Plans reorder in ARE for MCE
    ...
    Examples: 
      ...
      | ocpuser | Password@123 | ATDD2STG@MEMBERDD.COM | None          | current  | YES        |          10001 | mce,lowpremium | YES                | YES           | [blank]    |
