@agentRecommendationEngine @AREAEPRegression @regressionAARP @nextYear
Feature: 1.17.1 Agent Recommendation Engine - Verify ARE elements
  ...
  Scenario Outline: - <Email> To Verify agent login and validate plan year Auto Ranking in ARE
    ...
    Examples: 
      ...
      | mnracq@givmail.com | Password@12345 | ATDD5STG@MEMBERDD.COM    | OCT-15   | None          | future   |          10001 | fitness,lowpremium                    | NO                 | YES           | [blank]                                                                                                                                 |
      | mnracq@givmail.com | Password@12345 | ATDD3STG@NONMEMBERDD.COM | DEC-31   | None          | future   |          10001 | hearing,vision,lowpremium,drug,doctor | NO                 | YES           | Choice(PPO),Plan1(RegionalPPO),Prime(HMO),Plan3(RegionalPPO),Plan4(RegionalPPO),Patriot(RegionalPPO),Plan2(HMO),Plan1(HMO),Patriot(HMO) |
  ...
  Scenario Outline: - <Email> To Verify agent login and validate Plans reorder in AEP ARE for MCE
    ...
    Examples: 
      ...
      | mnracq@givmail.com | Password@12345 | ATDD2STG@MEMBERDD.COM | DEC-01   | None          | future   | YES        |          10001 | mce,lowpremium | NO                 | YES           | [blank]    |
