...
Feature: 1.11. ACQ-Pharmacy Locator AARP
  ...
  Scenario Outline: TID: <TID> -zipcode: <zipcode> - Part 1 of 2 - To verify end-to-end behavior for pharmacy locator page in English on acquisition site
    ...
    Examples: 
      ...
      | 15582 | Ulayer   |   00602 |       15 | Aguada Municipio    |        2020 | AARP MedicareRx Preferred (PDP) |        2020 | AARP MedicareRx Walgreens (PDP) | Open 24 hours | True                  | True             | True                 |
      | 15582 | Ulayer   |   96950 |       15 | Saipan Municipality |        2020 | AARP MedicareRx Preferred (PDP) |        2020 | AARP MedicareRx Walgreens (PDP) | Open 24 hours | True                  | True             | True                 |
