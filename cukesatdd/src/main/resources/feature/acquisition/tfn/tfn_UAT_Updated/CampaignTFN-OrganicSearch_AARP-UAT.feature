Feature: UAT Scripts-To test Organic SearchCampaign TFN on AARP site
 ...
 ######## Precedence 6.11 - Visit AMP using organic traffic from Google search URL , PSC code 810106##############
   ...
   Then the user validates PSC code
    ...
    |Scenario 6a: Campaign Precedence- AMP | ulayer |10001  |        810106  |         860002 | 8001533          |  8001533        |        810027 | 810106          |  8001533        |        810105 | shop/medicare-supplement-plans.html | (//*[contains(@class,'call')]//a[contains(@class,'tel')])[2]   | /shop/medicare-advantage-plans.html?WT.mc_id=860002&zipcode=90210|/shop/medicare-advantage-plans.html?WT.mc_id=8001533|/health-plans/medicare-advantage-plans/available-plans.html?WT.mc_id=8001533&county=053&state=27#/plan-summary|/shop/medicare-advantage-plans.html|(//*[contains(@class,'call')]//a[contains(@class,'tel')])[1]| (//a[contains(@class, 'tel')])[1] | (//a[contains(@class, 'tel')])[2] |1-800-850-6807  |1-866-327-1593  |1-866-327-1593   | 1-877-610-2672 |1-888-708-8922  |1-877-656-8358 |1-844-891-4867  | 1-877-699-5710  |1-800-850-8230 |(//a[contains(@class, 'tel')])[3] |
