...
Feature: 1.06-UAT Scripts to test Federal Agent Link and request an appointment with an agent flow
  ...
  Scenario Outline: <scenario> Verify request an appointment through <pageName> for <site> site
    ...
    Examples: 
      ...
      | E2E Scenario 1_UMS | UHC  | health-plans.html?zipcode=90210&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=H0543168000&planYear=2021&systemYear=2021&zipcode=90210&fipsCode=037&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=8016371&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::8016371!/details | VPP: Plan Details MAPD | https://www.myuhcagent.com/ |
      | E2E Scenario 1_UMS | UHC  | health-plans.html?zipcode=28035&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=H5253041000&planYear=2021&systemYear=2021&zipcode=28035&fipsCode=119&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=897749&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::897749!/details   | VPP: Plan Details DSNP | https://www.myuhcagent.com/ |

    @sanity
    Examples: 
      | scenario           | site | path                                                                                                                                                                                                                                                                                                                        | pageName               | UHCUrl                      |
      | E2E Scenario 1_UMS | UHC  | health-plans.html?zipcode=10011&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=H3307018000&planYear=2021&systemYear=2021&zipcode=10011&fipsCode=061&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=897749&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::897749!/details | VPP: Plan Details MA   | https://www.myuhcagent.com/ |
    ...
    Examples: 
      ...
      | E2E Scenario 1_UMS | UHC  | health-plans.html?zipcode=90210&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=H0543168000&planYear=2021&systemYear=2021&zipcode=90210&fipsCode=037&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=8016371&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::8016371!/details | VPP: Plan Details MAPD       | https://www.myuhcagent.com/ |
      | E2E Scenario 1_UMS | UHC  | health-plans.html?zipcode=28035&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=H5253041000&planYear=2021&systemYear=2021&zipcode=28035&fipsCode=119&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=897749&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::897749!/details   | VPP: Plan Details DSNP       | https://www.myuhcagent.com/ |
      | E2E Scenario 1_UMS | UHC  | health-plans.html?zipcode=55344&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=S5921370000&planYear=2021&systemYear=2021&zipcode=55344&fipsCode=053&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=8016371&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::8016371!/details | VPP: Plan Details PDP        | https://www.myuhcagent.com/ |
      | E2E Scenario 1_UMS | UHC  | health-plans.html?zipcode=10011&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=H3307018000&planYear=2021&systemYear=2021&zipcode=10011&fipsCode=061&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=897749&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::897749!/details   | VPP: Plan Details MA         | https://www.myuhcagent.com/ |
      | E2E Scenario 2_UMS | UHC  | shop/medicare-advantage-plans.html                                                                                                                                                                                                                                                                                            | ShopPlan: Shop MA Plan       | https://www.myuhcagent.com/ |
    ...
    Examples: 
      ...
      | E2E Scenario 1_AMP | AARP | health-plans.html?zipcode=28035&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=H5253041000&planYear=2021&systemYear=2021&zipcode=28035&fipsCode=119&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=897749&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::897749!/details   | VPP: Plan Details DSNP       | https://www.myuhcagent.com/ |
      | E2E Scenario 1_AMP | AARP | health-plans.html?zipcode=55344&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=S5921370000&planYear=2021&systemYear=2021&zipcode=55344&fipsCode=053&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=8016371&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::8016371!/details | VPP: Plan Details PDP        | https://www.myuhcagent.com/ |
      | E2E Scenario 1_AMP | AARP | health-plans.html?zipcode=10011&deepLink=favPlansDeepLink&plantype=MA&year=2021&planId=H3307018000&planYear=2021&systemYear=2021&zipcode=10011&fipsCode=061&product=MAPD&yearDisclaimer=undefined&month=2&yearToggle=undefined&deepLink=plandetail&WT.mc_id=897749&mrcid=em:Acq:MR%7cFederal%7cEGEM3011%7c::897749!/details   | VPP: Plan Details MA         | https://www.myuhcagent.com/ |
  ...
  Scenario Outline: <scenario> Verify request an appointment for Medsupp <site> site flows
    ...
    Examples: 
      ...
      | E2E Scenario 4_UMS |   10001 | NO              | Los Angeles County | MS       | 11/13/1940 | John      | Carry    | AARP | https://www.myuhcagent.com/ |
