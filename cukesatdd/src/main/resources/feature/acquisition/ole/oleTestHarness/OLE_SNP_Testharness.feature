...
Feature: OLE Testharness page for AARP for SNP
  ...
  Scenario Outline: TID: <TID> -plan type: <PlanType> - Ole Testharness page to confirmation page for SNP
    ...
    Examples: 
      | TID   | isMultutiCounty | plantype | siteName | THPage | siteId | pBPNumber | clientCode | segmentId | PlanTypeTH   | TFN            | PlanName                                              | psc    | Year | env     | Zip   | CountyName   | FipsCode | StateCode | CMScode | HNumber | cardtype | firstname | lastname | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | permstreet    | permcity    | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                                                                                                                                                                       | optiondata              | pdpFlag | longTermFlag | riderflag | providername | provideraddress | providercity | providerzipcode | providernumber | emailConfirmation | goGreen |
      | 00001 | NO              | SNP      | Ulayer   | ole    | aarp   |       037 | UHCMS1     |       000 | CSNPStandard | 1-877-596-3258 | UnitedHealthcare Chronic Complete (HMO C-SNP)         | 880180 | 2020 | nonProd | 78006 | Bexar County |      029 | TX        |     130 | H4590   | MBI      | John      | Doe      | 2n22C33YK33    | false   |  01012010 |  01012010 |      431665465 | true     | 01011903 | Male   | 003 Morris Rd | Los Angeles | Yes                    |               |             | CA           |      90210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | John         | address of prov | Palmer       |           99645 |     1231231234 | NO                | NO      |
      | 00002 | NO              | SNP      | Blayer   | ole    | uhc    |       037 | UHCMS1     |       000 | CSNPStandard | 1-877-596-3258 | UnitedHealthcare Chronic Complete (HMO C-SNP)         | 880180 | 2020 | nonProd | 78006 | Bexar County |      029 | TX        |     130 | H4590   | MBI      | John      | Doe      | 2n22C33YK33    | false   |  01012010 |  01012010 |      431665465 | true     | 01011903 | Male   | 003 Morris Rd | Los Angeles | Yes                    |               |             | CA           |      90210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | John         | address of prov | Palmer       |           99645 |     1231231234 | NO                | NO      |
      | 00003 | NO              | SNP      | Ulayer   | ole    | aarp   |       008 | UHCMS1     |       000 | CSNPSilver   | 1-877-596-3258 | UnitedHealthcare Medicare Silver (Regional PPO C-SNP) | 880180 | 2020 | nonProd | 78006 | Bexar County |      029 | TX        |     130 | R6801   | MBI      | John      | Doe      | 2n22C33YK33    | false   |  01012010 |  01012010 |      431665465 | true     | 01011903 | Male   | 003 Morris Rd | Los Angeles | Yes                    |               |             | CA           |      90210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | John         | address of prov | Palmer       |           99645 |     1231231234 | NO                | NO      |
