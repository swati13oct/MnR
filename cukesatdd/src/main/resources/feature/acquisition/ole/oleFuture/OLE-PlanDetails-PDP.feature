...
#    Then the user navigates to Coverage and Health Information Page
  ...
  @PDP_OLE_Ulayer_Future @PDP_OLE_Ulayer_Future_PD @prodRegression_AARP
    ...
    Examples: 
      ...
      | 15526 | AARP|PDP-MBI  | future|future|  80210 | NO              | Denver County      | PDP      | AARP MedicareRx Saver Plus (PDP) | MBI      | John      | Doe      | 3A33C22YK25    | false   |           |  11012015 |   0123456789              | false    | 01011902 | Female | 002 Morris Rd | Los Angeles | No                   | 802 MailingSt | Mailing LA  | CO           |      80210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO			|PrescriptionCoverage            |PD5646136   | BCD12345EFG |InValid |  K              |Test_K|Test_M|122 2ND AVE|655|MINNEAPOLIS|55455|1235678901|FRIEND|MN|Agree|566|677|true|Social Security or Railroad Retirement Benefit||||
