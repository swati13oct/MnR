...
Feature: 1.05.1. OLE common tool flow E2E Plan Compare Page MAPD
  ...
  Given the user is on medicare acquisition site landing page
   ...
   Then the user validates cancellation modal for Welcome OLE
    ...
    @MAPD_OLE_Ulayer_Future_compare @prodRegression_AARP
    Examples: 
