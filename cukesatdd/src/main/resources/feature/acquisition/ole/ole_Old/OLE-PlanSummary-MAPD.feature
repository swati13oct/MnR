...
Feature: 1.05.2 OLE common tool flow E2E MAPD
  ...
  Scenario Outline: TID: <TID> -plan type: <plantype> - OLE End to end from <site> Acquisition site VPP Plan Summary
    ...
    @MAPD_OLE_Ulayer_Future1 @regressionAARP1 @OLE1
    Examples: 
