...
Feature: To test OLE common tool flow flow UMS site
  ...
  Scenario Outline: OLE Landing from UHC Acquisition site VPP Plan Summary
    ...
    Examples: 
      ...
      |   28035 | Mecklenburg County | SNP      | UnitedHealthcare Dual Complete (HMO SNP)          | MBI      | John      | Doe      | 2A22C22YK22    | true    |  01012010 |  01012010 |
      |   90210 | Los Angeles County | PDP      | AARP MedicareRx Walgreens (PDP)                   | MBI      | John      | Doe      | 2A22C22YK22    | false   |  01012010 |  01012010 |
      |   35045 | Chilton County     | SNP      | UnitedHealthcare Dual Complete (HMO SNP)          | MBI      | John      | Doe      | 2A22C22YK22    | false   |  01012010 |  01012010 |
