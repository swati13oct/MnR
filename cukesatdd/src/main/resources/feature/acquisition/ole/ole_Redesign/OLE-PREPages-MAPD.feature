 ...
 #   Then the user validates the Online Enrollment details on Review and Submit Page
  ...
  @nextYear @nonProd @PRE_E2E_AARP_future @OLE_Redesign @OLE @nonProd @regressionAARP
    Examples:
      ...
      | AARP | TiggerOptumID66|TiggerTigger1|MAPD-RRID-MBI | next     | next   |   10001 | No            | New York County |MAPD          | Chronic,Nursing | AcceptsMedicare | [blank]     | [blank]       | Yes            | Lipitor,NO,Lipitor TAB 20MG,,,Day,1,YES,NO                                   | No,No,Yes,No                  | Lower                | both           | Doctors, Vision    |   10001 | MAPD     | UnitedHealthcare Medicare Advantage Choice Plan 3 (Regional PPO)  | MBI      | TEST_PORTALS_PRE | TEST_PORTALS_PRE|5N60TE6RQ50    | false   |  10011995 |  10011995 |     0123456789 | true     | 10261930| Male   | 003 Morris Rd | Los Angeles | Yes                    | [blank]       | [blank]     | NY           |      10001 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | yes          | true_yes      | NO                | NO      | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    | Valid         | 1st            | Dental, None | Social Security or Railroad Retirement Benefit | [blank] | [blank]             | [blank]            |TEST_PORTALS_M         | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     |123456 |5544567890  |5544567891  |

  @nextYear @PRE_E2E_UHC_future @OLE @nonProd @regressionUHC @OLE_Redesign
    Examples:
      | site | username       | password   | PlanType      | planyear | planYear | Zipcode | isMultiCounty | county          | isCoverageOpt | specialNeeds    | doctors         | DoctorsName | isMultiDoctor | Drug Selection | DrugName-AutoSearch-Dosage-Package-Qty-Frequency-SLength-IsNotgeneric-Switch | Dental-Hearing-Vision-Fitness | costPreferenceOption | priorityOption | priorities       | zipcode | plantype | planName                                                         | cardtype | firstname | lastname | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | permstreet    | permcity    | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                                                                                                                                                                       | optiondata              | pdpFlag | longTermFlag | riderflag | emailConfirmation | goGreen | healthinsurancename | groupnumber | membernumber | prescriptioncoveragename | pdgroupnumber | pdmembernumber | inputdataType | priorityOption | priorities   | paymentType                                    | cardno  | cardexpirationmonth | cardexpirationyear | middlename         | authorizefirstN | authorizelastN | authorizeaddress | authorizeapartment | authorizecity | authorizezip | authorizephonenumber | authorizeRelationship | authorizestate | authorizationagree | permaptno | mailingaptno | authflag |rxBinnumber |phoneno |mobileno|
      | UHC  | TiggerOptumID66|TiggerTigger1|MAPD-RRID-MBI| next     | next   |   10001 | No            | New York County |MAPD          | Chronic,Nursing | AcceptsMedicare | [blank]     | [blank]       | Yes            | Lipitor,NO,Lipitor TAB 20MG,,,Day,1,YES,NO                                   | No,No,Yes,No                  | Lower                | both           | Doctors, Vision    |   10001 | MAPD     | UnitedHealthcare Medicare Advantage Choice Plan 3 (Regional PPO) | MBI      | TEST_PORTALS_PRE | TEST_PORTALS_PRE|5N60TE6RQ50    | false   |  10011995 |  10011995 |     0123456789 | true     | 10261930| Male   | 003 Morris Rd | Los Angeles | Yes                    | [blank]       | [blank]     | NY           |      10001 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | yes          | true_yes      | NO                | NO      | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    | Valid         | 1st            | Dental, None | Social Security or Railroad Retirement Benefit | [blank] | [blank]             | [blank]            |TEST_PORTALS_M         | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     |123456 |5544567890  |5544567891  |
