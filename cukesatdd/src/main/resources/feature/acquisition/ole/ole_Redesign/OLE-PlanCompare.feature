...
Feature: 1.05.1. OLE common tool flow E2E Plan Compare Page
  ...
  Scenario Outline: TID: <TID> -plan type: <PlanType> - OLE End to end from AARP Acquisition site VPP Plan Compare Page
   ...
   # Then the user validates the OLE Submission Details in GPS
    ...
    @MAPD_OLE_Redesign_Ulayer_Future @prodRegression_AARP  @regressionAARP @OLE_Redesign
    Examples: 
...
Then the user validates the Plan details on OLE
   ...
   # Then the user validates the OLE Submission Details in GPS
    ...
    @PDP_OLE_Redesign_Ulayer_Future  @regressionAARP @OLE_Redesign
    Examples: 
      ...
      | 15526 | AARP |           3 | PDP-MBI  | future   | future   |   55411 | NO              | Hennepin County | PDP      | AARP MedicareRx Saver Plus (PDP) | MBI      | John      | Doe      | 3A33C22YK25    | false   | [blank]   |  11012015 |     0123456789 | false    | 01011902 | Female | 002 Morris Rd | Los Angeles | No                     | 802 MailingSt | Mailing LA  | MN           |      55411 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO      | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |789456| InValid       | [blank]    | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Social Security or Railroad Retirement Benefit | [blank] | [blank]             | [blank]            |

    @PDP_OLE_Redesign_UHC_Future  @regressionUHC @OLE_Redesign
    Examples: 
      | TID   | site | planIndices | PlanType | planyear | planYear | zipcode | isMultutiCounty | county          | plantype | planName                         | cardtype | firstname | lastname | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | permstreet    | permcity    | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                                                                                                                                                                       | optiondata              | pdpFlag | longTermFlag | riderflag | emailConfirmation | goGreen | prescriptioncoveragename | pdgroupnumber | pdmembernumber | rxBinnumber    |inputdataType | middlename | authorizefirstN | authorizelastN | authorizeaddress | authorizeapartment | authorizecity | authorizezip | authorizephonenumber | authorizeRelationship | authorizestate | authorizationagree | permaptno | mailingaptno | authflag | paymentType | cardno  | cardexpirationmonth | cardexpirationyear |
      | 15526 | UHC  |           3 | PDP-MBI  | future   | future   |   55411 | NO              | Hennepin County | PDP      | AARP MedicareRx Saver Plus (PDP) | MBI      | John      | Doe      | 3A33C22YK25    | false   | [blank]   |  11012015 |     0123456789 | false    | 01011902 | Female | 002 Morris Rd | Los Angeles | No                     | 802 MailingSt | Mailing LA  | MN           |      55411 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO      | PrescriptionCoverage     | PD5646136     | BCD12345EFG    | 589456| InValid       | [blank]    | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |
