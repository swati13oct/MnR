Feature: 1.05.1. OLE common tool flow E2E through VisitorProfile
  ...
  Scenario Outline: <UID> - Verify user is save <plantype>plans from VPP to the unauthenticated->Guest User visitor profile and complete OLE
 ...
 Scenario Outline: TID: <TID> -plan type: <plantype> - OLE End to end from <site> Acquisition site -Enroll for a Plan-save a plan in OLE Page as authenticated user  and complete OLE for MA Plans
    Given the user is on medicare acquisition site landing page
      | Site | <site> |
    When the user performs plan search using following information
      | Zip Code        | <zipcode>         |
   ...
   #Then the user validates Look up Provider for MA MAPD and DSNP plans.
    ...
    Examples:
      ...
      | 15501 | AARP | MNRAQ1 | TiggerTigger1 |MAPD-RRID-MBI | next     | next   |   10001 | NO              | New York County | MAPD     | AARP Medicare Advantage Plan 1 (HMO)                | MBI      | TEST_PORTALS_MAPD | TEST_PORTALS_MAPD|2W10TE1RH40    | false   |  03012000 |  01012014 |     0123456789 | false     | 05011960| Male   | no|001 Morris Rd | New York    | No                     | 801 MailingSt | Mailing LA  | NY           |      10001 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / / | yes     | yes          | true_yes      | yes               | yes     | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |123456         | Valid         | TEST_PORTALS_K   | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |

   @OLE_Visitor1 @nextYear @VP_OLE_UHC_Future @regressionUHC @OLE @nonProd
    Examples:
      | TID   | site |username   | password   |PlanType      | planyear | planYear | zipcode | isMultutiCounty | county          | plantype | planName                                            | cardtype | firstname              | lastname              | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | autoaddress|permstreet    | permcity    | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                                                                                                                                                                       | optiondata                | pdpFlag | longTermFlag | riderflag     | emailConfirmation | goGreen | phoneno    | mobileno   | healthinsurancename | groupnumber | membernumber | prescriptioncoveragename | pdgroupnumber | pdmembernumber |rxBinnumber    | inputdataType | middlename         | authorizefirstN | authorizelastN | authorizeaddress | authorizeapartment | authorizecity | authorizezip | authorizephonenumber | authorizeRelationship | authorizestate | authorizationagree | permaptno | mailingaptno | authflag | paymentType | cardno  | cardexpirationmonth | cardexpirationyear |
      | 15502 | UHC | MNRAQ1 | TiggerTigger1 |MA-MBI | next     | next   |   10001 | NO              | New York County | MA     | AARP Medicare Advantage Patriot (HMO)               | MBI      | TEST_PORTALS_MAPD | TEST_PORTALS_MAPD|2W10TE1RH40    | false   |  03012000 |  01012014 |     0123456789 | false     | 05011960| Male   | no|001 Morris Rd | New York    | No                     | 801 MailingSt | Mailing LA  | NY           |      10001 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / / | yes     | yes          | true_yes      | yes               | yes     | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |123456         | Valid         | TEST_PORTALS_K   | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |

Scenario Outline: TID: <TID> - plan type: <PlanType> - OLE End to end from <site> Acquisition site -Enroll for a Plan-save a plan in OLE Page as authenticated user  and complete OLE for DSNP Plans
    Given the user is on medicare acquisition site landing page
      | Site | <site> |
    When the user performs plan search using following information
      | Zip Code        | <zipcode>         |
