Feature: 1.05.3 OLE common tool flow E2E PDP Plan Details Page
  ...
  Scenario Outline: TID: <TID> -plan type: <plantype> - OLE End to end from <site> Acquisition site VPP Plan Details Page
    ...
    #Then the user Validates Next Steps in Confirmation Page for the Plan Type
    #@PDP_OLE_Ulayer_Future @regressionAARP @sanity  @OLE @OLE_Redesign @ole_Redesign_Gating @OLEGating @nonProd @sanity_OLE
    Examples:
      ...
      | 15526 | AARP | PDP-MBI  | current   | current   |   80210 | NO              | Denver County | PDP      | AARP MedicareRx Saver Plus (PDP) | MBI      | TEST_PORTALS_John      | MILLS     | 9TG0PC4TT18    | false   |  06011992 |  06011992 |     0123456789 | false    | 01251957 | Female | 002 Morris Rd | Los Angeles | No                     | 802 MailingSt | Mailing LA  | CO           |      80210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO      | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |156789| InValid       | TEST_PORTALS_K         | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |

    #@PDP_OLE_UHC_Future @prodRegression_UHC @regressionUHC @OLE @sanity @ole_Redesign_Gating @OLEGating @nonProd
    Examples: 
      | TID   | site | PlanType | planyear | planYear | zipcode | isMultutiCounty | county        | plantype | planName                         | cardtype | firstname | lastname | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | permstreet    | permcity    | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                                                                                                                                                                       | optiondata              | pdpFlag | longTermFlag | riderflag | emailConfirmation | goGreen | phoneno    | mobileno   | healthinsurancename | groupnumber | membernumber | prescriptioncoveragename | pdgroupnumber | pdmembernumber |rxBinnumber| inputdataType | middlename | authorizefirstN | authorizelastN | authorizeaddress | authorizeapartment | authorizecity | authorizezip | authorizephonenumber | authorizeRelationship | authorizestate | authorizationagree | permaptno | mailingaptno | authflag | paymentType | cardno  | cardexpirationmonth | cardexpirationyear |
      | 15526 | UHC  | PDP-MBI  | current   | current   |   80210 | NO              | Denver County | PDP      | AARP MedicareRx Saver Plus (PDP) | MBI      | TEST_PORTALS_PDP | TEST_PORTALS_PDP  |2EE4TE2UG10    | false   |  08011996 |  08011996 |     0123456789 | false     | 08161931  | Female | 002 Morris Rd | Los Angeles | No                     | 802 MailingSt | Mailing LA  | CO           |      80210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO      | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    | 789456 |InValid       | TEST_PORTALS_K        | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |

  @nextYear @regressionAARP @sanity  @OLE @OLE_Redesign @ole_Redesign_Gating @OLEGating @nonProd @sanity_OLE @featureGate
    Examples:
      ...
      | 15526 | AARP | PDP-MBI  | next     | next   |   80210 | NO              | Denver County | PDP      | AARP MedicareRx Saver Plus (PDP) | MBI      | TEST_PORTALS_PDP | TEST_PORTALS_PDP  |2EE4TE2UG10    | false   |  08011996 |  08011996 |     0123456789 | false     | 08161931  | Female | No|002 Morris Rd | Los Angeles | No                     | 802 MailingSt | Mailing LA  | CO           |      80210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO      | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |156789| InValid       | TEST_PORTALS_K         | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |

  @nextYear @prodRegression_UHC @regressionUHC @OLE @sanity @ole_Redesign_Gating @OLEGating @nonProd
    Examples:
      ...
      | 15526 | UHC  | PDP-MBI  | next     | next   |   80210 | NO              | Denver County | PDP      | AARP MedicareRx Saver Plus (PDP) | MBI      | TEST_PORTALS_PDP | TEST_PORTALS_PDP  |2EE4TE2UG10    | false   |  08011996 |  08011996 |     0123456789 | false     | 08161931  | Female | No|002 Morris Rd | Los Angeles | No                     | 802 MailingSt | Mailing LA  | CO           |      80210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO      | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    | 789456 |InValid       | TEST_PORTALS_K       | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |
