...
Feature: 1.10 <----UAT Scripts OLE common tool flow E2E- MA,MAPD,DSNP,ExternalLink MA----->
  ...
  @OLE_Redesign @OLE_UATRegression @prodRegression @UATRegression @regressionAARP @OLE @OLE_Redesign_Campaign
    Examples: 
      ...
      | E2E Scenario_UMS External Link (Deep link ) PST |1-833-988-1569 | UHC  | MA-MBI   | /health-plans/medicare-advantage-plans/available-plans.html?zipcode=55344&WT.mc_id=8002977&county=260&state=27&coveragePerson=M&originatingSite=https%253A%252F%252Fwww.myuhcplans.com%252Fmorganstanley&subdomain=group#/plan-summary | current   | current   |   55344 | NO              | Hennepin County | MA       | current   | AARP Medicare Advantage Headwaters (PPO) | MBI      | TEST_PORTALS_GOTTFRIED | MARBLE  |9PU0FN3FY03  | false   |  06012017 |  06012017 |     0123456789 | true     | 07181979 | Male   | 003 Morris Rd | Los Angeles | No                    | 155 2nd ave	       | Minneapolis    | MN           |      55344 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | yes          | false     | NO                | NO      | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |567890| Valid         | 5N69QY6ET32     |Test_MiddleName    | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]         |1234567890 | 2345678901 |

  @nextYear @nextyear_External
    Examples:
      | Scenario                                        |TFNNo          | site | PlanType | path                                                                                                                                                                                                                                   | planyear | planYear | zipcode | isMultutiCounty | county          | plantype | planyear | planName                              | cardtype | firstname | lastname | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | permstreet    | permcity    | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                                                                                                                                                                       | optiondata              | pdpFlag | longTermFlag | riderflag | emailConfirmation | goGreen | healthinsurancename | groupnumber | membernumber | prescriptioncoveragename | pdgroupnumber | pdmembernumber | rxBinnumber|inputdataType | medicarenumber1 |middlename         | authorizefirstN | authorizelastN | authorizeaddress | authorizeapartment | authorizecity | authorizezip | authorizephonenumber | authorizeRelationship | authorizestate | authorizationagree | permaptno | mailingaptno | authflag | paymentType | cardno  | cardexpirationmonth | cardexpirationyear |phoneno    | mobileno   |
      | E2E Scenario_UMS External Link (Deep link ) PST |1-833-988-1569 | UHC  | MA-MBI   | /health-plans/medicare-advantage-plans/available-plans.html?zipcode=55344&WT.mc_id=8002977&county=260&state=27&coveragePerson=M&originatingSite=https%253A%252F%252Fwww.myuhcplans.com%252Fmorganstanley&subdomain=group#/plan-summary | next     | next   |   55344 | NO              | Hennepin County | MA       | next   | AARP Medicare Advantage Headwaters (PPO) | MBI      | TEST_PORTALS_GOTTFRIED | MARBLE  |9PU0FN3FY03   | false   |  06012017 |  06012017 |     0123456789 | true     | 07181979 | Male   | 003 Morris Rd | Los Angeles | No                    | 155 2nd ave	       | Minneapolis    | MN           |      55344 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | yes          | false     | NO                | NO      | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |567890| Valid         | 5N69QY6ET32     |Test_MiddleName    | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]         |1234567890 | 2345678901 |
