Feature:  OLE common tool flow E2E for Medicare Card Scan

  Scenario Outline: TID: <TID> OLE Medicare Scan feature for  <plantype> - plantype
...
Scenario Outline: TID: <TID> - OLE Medicare Scan feature for  <plantype> - plantype
 ...
 @OLE_MedicareScan_DSNP @OLE_MedicareScan
   Examples:
      ...
      | 15504 | true|AARP | DSNP-MBI |  1-888-510-0371 | next     | next    | 27007   | No           | Surry County| SNP      |   UnitedHealthcare Dual Complete RP (Regional PPO D-SNP) | MBI      |TEST_PORTALS_C&DSNP | TEST_PORTALS_C&SDSNP|5N60TE6RQ50    | true   | 123456789 |  10011995 |  10011995 |    WX14595H | true | 10261930 | Female | No|123 Perm Rd | Los Angeles | No                     | 876 MailingSt | Mailing LA  | AK           |      27007 | test@test.com | losing coverage/ moved outside of the service area | 01012018/01012018 | yes     | yes          | false     | Yes     | Yes     | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    | 123456    |Valid         | 1234567890 | 2345678901 | TEST_PORTALS_M          | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | AL             | Agree              |       566 |          677 | true     |[blank]  | [blank] | [blank]             | [blank]            |2W10TE1RH40     |


Scenario Outline: TID: <TID> -plan type: <plantype> - OLE Medicare Scan feature Error Message validation
    Given the user is on medicare acquisition site landing page
      | Site | <site> |
    When the user performs plan search using following information
      | Zip Code        | <zipcode>         |
   ...
   # Then the user validates the Plan details on OLE
    ...
    @OLE_MedicareScan @OLE_MedicareScan_Error
        Examples:
        #  | TID   |UploadBtn| errorMessage|site | PlanType      | planyear | planYear | zipcode | isMultutiCounty | county          | plantype | planName                                            | cardtype | firstname              | lastname              | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | permstreet    | permcity    | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                                                                                                                                                                       | optiondata                | pdpFlag | longTermFlag | riderflag     | emailConfirmation | goGreen | phoneno    | mobileno   | healthinsurancename | groupnumber | membernumber | prescriptioncoveragename | pdgroupnumber | pdmembernumber |rxBinnumber    | inputdataType | middlename         | authorizefirstN | authorizelastN | authorizeaddress | authorizeapartment | authorizecity | authorizezip | authorizephonenumber | authorizeRelationship | authorizestate | authorizationagree | permaptno | mailingaptno | authflag | paymentType | cardno  | cardexpirationmonth | cardexpirationyear |medicarenumber1 |
       #   | 15504 | true|wrong image |AARP | MAPD-RRID-MBI | next     | next   |   10001 | NO              | New York County | MAPD     | AARP Medicare Advantage Prime (HMO)                 | MBI      | TEST_PORTALS_MAPD | TEST_PORTALS_MAPD|5N60TE6RQ50    | false   |  10011995 |  10011995 |     0123456789 | false         | 10261930     | Male   | 001 Morris Rd | New York    | No                     | 801 MailingSt | Mailing LA  | AK           |      10001 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / / | yes     | yes          | true_yes      | yes               | yes     | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |123456         | Valid         | TEST_PORTALS_K   | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | AL             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |2W10TE1RH40|
      #    | 15505 | true|timeout     |UHC  | MAPD-RRID-MBI | next     | next   |   10001 | NO              | New York County | MAPD     | AARP Medicare Advantage Prime (HMO)                 | MBI      | TEST_PORTALS_MAPD | TEST_PORTALS_MAPD|5N60TE6RQ50    | false   |  10011995 |  10011995 |     0123456789 | false         | 10261930     | Male   | 001 Morris Rd | New York    | No                     | 801 MailingSt | Mailing LA  | AK           |      10001 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / / | yes     | yes          | true_yes      | yes               | yes     | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |123456         | Valid         | TEST_PORTALS_K   | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | AL             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |2W10TE1RH40|
        | TID   | UploadBtn| errorMessage|site | PlanType | planyear | planYear | zipcode | isMultutiCounty | county        | plantype | planName                         | cardtype | firstname | lastname | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | permstreet    | autoaddress|permcity    | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                                                                                                                                                                       | optiondata              | pdpFlag | longTermFlag | riderflag | emailConfirmation | goGreen | phoneno    | mobileno   | healthinsurancename | groupnumber | membernumber | prescriptioncoveragename | pdgroupnumber | pdmembernumber | rxBinnumber|inputdataType | middlename | authorizefirstN | authorizelastN | authorizeaddress | authorizeapartment | authorizecity | authorizezip | authorizephonenumber | authorizeRelationship | authorizestate | authorizationagree | permaptno | mailingaptno | authflag | paymentType | cardno  | cardexpirationmonth | cardexpirationyear |medicarenumber1 |
        | 15504 | true     | wrong image |AARP | PDP-MBI  | next     | next   |   90210 | NO              | Los Angeles County  | PDP      | AARP MedicareRx Walgreens (PDP) | MBI      | TEST_PORTALS_PDP | TEST_PORTALS_PDP|5N60TE6RQ50    | false   |  10011995 |  10011995|     0123456789 | false     | 10261956  | Female | No|002 Morris Rd | Los Angeles | No                     | 802 MailingSt | Mailing LA  | AK           |      90210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO      | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |156789| Valid       | TEST_PORTALS_K         | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | AL             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |2EE4TE2UG10|
       # | 15505 | true     | timeout     |AARP | PDP-MBI  | next     | next   |   90210 | NO              | Los Angeles County  | PDP      | AARP MedicareRx Preferred (PDP) | MBI      | TEST_PORTALS_PDP | TEST_PORTALS_PDP|5N60TE6RQ50    | false   |  10011995 |  10011995|     0123456789 | false     | 10261956  | Female | No|002 Morris Rd | Los Angeles | No                     | 802 MailingSt | Mailing LA  | AK          |      90210 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO      | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |156789| Valid       | TEST_PORTALS_K         | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | AL             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |2EE4TE2UG10|
