...
Feature: 1.05.1.ACQ-OLE common tool flow E2E MA AARP
  ...
  @MA_OLE_Ulayer @acquisitionRegression @MA_OLE_AARP @junerelease2018 @september_release_2018 @december_release_2018 @OLE_PCP_Medica_AARP @MACRAvalidation @OEP_CHANGES @OLE_Regression_Ulayer
