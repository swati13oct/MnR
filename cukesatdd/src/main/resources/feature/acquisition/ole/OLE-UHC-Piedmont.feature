#@spartans @OLE @Piedmont_OLE_UHC @prodRegression
Feature: 2.05.1.ACQ-OLE Piedmont UMS

  #@Piedmont_OLE_UHC @decrelease2019 @OLE_Regression_Blayer @F365255
  Scenario Outline: TID: <TID> - plan type: <PlanType> - OLE Landing from UHC Acquisition site VPP Plan Summary for Piedmont plans
...
#    Then the user navigates to Coverage and Health Information Page
    ...
    Examples: 
      ...
      | F365255 | MA-MBI      | current| current| 24526 | NO              | Bedford County | MAPD     | Piedmont Select Medicare Option Three (PPO) | MBI      | GOTTFRIED | GARRAND     | 5N69QY6ET34    | false|   09011997 |  11012002 |      431665465 | true     | 04261944 | Male   | 003 Morris Rd | Los Angeles | Yes                    |               |             | VA           |      24526 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / | yes     | no           | false     | NO                | NO      |HealthInsurance             |HI1562759    | ABC12345DEF     |PrescriptionCoverage            |PD5646136   | BCD12345EFG |Valid|
