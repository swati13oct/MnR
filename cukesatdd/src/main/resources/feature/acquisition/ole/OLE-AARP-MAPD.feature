@fastandfurious @OLE @MAPD_OLE_AARP
Feature: 1.05.2.ACQ-OLE  common tool flow E2E MAPD AARP

  @MAPD_OLE_AARP @acquisitionRegression @junerelease2018 @september_release_2018 @december_release_2018 @OLE_PCP_Medica_AARP @MACRAvalidation @OEP_CHANGES @OLE_Regression_Ulayer
...
#    Then the user navigates to Coverage and Health Information Page
    ...
    Examples: 
      ...
      | 15557 | MAPD-PFFS-MBI   |   85923 | NO              | Navajo County     | MAPD     | UnitedHealthcare MedicareDirect Rx (PFFS) | MBI      | GOTTFRIED | GARRAND     | 5N69QY6ET34    | false|   09011997 |  11012002   |      231665465 | true     | 04261944 | Female | 123 Perm Rd | Los Angeles | Yes                    |               |             | AZ           |      85923 | test@test.com | None apply                        |            | yes     | no           | false     | NO                | NO      |Valid|
      | 15555 | Medica-MAPD-MBI |   33143 | NO              | Miami-Dade County | MAPD     | Medica HealthCare Plans MedicareMax (HMO) | MBI      | GOTTFRIED | GARRAND     | 5N69QY6ET34    | false|   09011997 |  11012002  |                | false    | 04261944 | Female | 123 Perm Rd | Los Angeles | Yes                    | 876 MailingSt | Mailing LA  | FL           |      33143 | test@test.com | moved outside of the service area |   01012018 | yes     | no           | false     | NO                | NO      |Valid|
 		#	| 15578 | MAPD-PFFS-MBI   |   85923 | NO              | Navajo County     | MAPD     | UnitedHealthcare MedicareDirect Rx (PFFS) | MBI      | John      | Doe      | 3A33C22YK22    | false   |  01012010 |  01012010 |      231665465 | true     | 01011941 | Female | 123 Perm Rd | Los Angeles | Yes                    |               |             | AZ           |      85923 | test@test.com | None apply                        |            | yes     | no           | false     | NO                | NO      |Invalid|
      #| 15579 | Medica-MAPD-MBI |   33143 | NO              | Miami-Dade County | MAPD     | Medica HealthCare Plans MedicareMax (HMO) | MBI      | John      | Doe      | 3A33C22YK22    | false   |  01012010 |  01012010 |                | false    | 01011941 | Female | 123 Perm Rd | Los Angeles | Yes                    | 876 MailingSt | Mailing LA  | FL           |      33143 | test@test.com | moved outside of the service area |   01012018 | yes     | no           | false     | NO                | NO      |Invalid|
    ...
    Examples: 
      | TID   | PlanType      | zipcode | isMultutiCounty | county          | plantype | planName                             | cardtype | firstname | lastname | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | permstreet    | permcity | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                                                                                                                                                                       | optiondata                | pdpFlag | longTermFlag | riderflag | emailConfirmation | goGreen |inputdataType|
      | 15556 | MAPD-RRID-MBI |   10001 | NO              | New York County | MAPD     | AARP Medicare Advantage Plan 1 (HMO) | MBI      | GOTTFRIED | GARRAND     | 5N69QY6ET34    | false|   09011997 |  11012002  |      631665465 | false    | 04261944 | Male   | 001 Morris Rd | New York | No                     | 801 MailingSt | Mailing LA  | NY           |      10001 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / / | yes     | no           | true      | NO                | NO      |Valid|
			#| 15555 | MAPD-RRID-MBI |   10001 | NO              | New York County | MAPD     | AARP Medicare Advantage Plan 1 (HMO) | MBI      | John      | Doe      | 3A33C22YK22    | false   |  01012010 |  01012010 |      631665465 | false    | 01011983 | Male   | 001 Morris Rd | New York | No                     | 801 MailingSt | Mailing LA  | NY           |      10001 | test@test.com | Medicare Advantage Open Enrollment Period (MA OEP)/change in my Medicaid (newly got Medicaid)/Medicare (or my state)/(or my state helps pay for my Medicare premiums)/major disaster (as declared by the Federal Emergency Management Agency (FEMA) | /12202018/12202018/ / / / | yes     | no           | true      | NO                | NO      |Invalid|
