Feature: 1.05.2 OLE common tool SEP Validation for No Selection& Skip SEP Page
  ...
  @OLE_Redesign_SEP_MAPD @OLE_Redesign_SEP
    Examples:
      ...
      | 15513 | AARP | MAPD-RRID-MBI | current   | current    |   10001 | NO              | New York County | MAPD     | AARP Medicare Advantage Plan 1 (HMO)                | MBI      | TEST_SEP2_NS_MAPD      | TEST_SEP2_NS_MAPD   | 3A33C22YK14    | false   |  07012021 |  07012021 |     0123456789 | false    | 01011952 | Male   | 001 Morris Rd | New York    | No                     | 801 MailingSt | Mailing LA  | NY           |      10001 | test@test.com | [blank]                           |  [blank]                  | No     | No          | true_No      | No               | No     | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |123456         | Valid         | Test_MiddleName    | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |

  @OLE_Redesign_SEP_MA @OLE_Redesign_SEP
    Examples:
      | TID   | site | PlanType | planyear | planYear | zipcode | isMultutiCounty | county          | plantype | planName                                            | cardtype | firstname              | lastname            | medicarenumber | ssnflag | partadate | partbdate | medicaidnumber | esrdflag | dob      | gender | permstreet    | permcity    | mailingaddressquestion | mailingstreet | mailingcity | mailingstate | mailingzip | email         | selectoptions                                                                                    | optiondata                | pdpFlag | longTermFlag | riderflag     | emailConfirmation | goGreen | phoneno    | mobileno   | healthinsurancename | groupnumber | membernumber | prescriptioncoveragename | pdgroupnumber | pdmembernumber |rxBinnumber    | inputdataType | middlename         | authorizefirstN | authorizelastN | authorizeaddress | authorizeapartment | authorizecity | authorizezip | authorizephonenumber | authorizeRelationship | authorizestate | authorizationagree | permaptno | mailingaptno | authflag | paymentType | cardno  | cardexpirationmonth | cardexpirationyear |
      | 15513 | AARP | MA-MBI  | current   | current    |   10001 | NO              | New York County | MA    | AARP Medicare Advantage Patriot (HMO)               | MBI      | TEST_SEP2_NS_MA      | TEST_SEP2_NS_MA   | 3A33C22YK13    | false   | 07012021 |  07012021 |     0123456789 | false    | 02011953 | Male   | 001 Morris Rd | New York    | No                     | 801 MailingSt | Mailing LA  | NY           |      10001 | test@test.com | [blank]                         |  [blank]                  | No     | No          | true_No      | No               | No     | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |123456         | Valid         | Test_MiddleName    | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | true     | Pay By Mail | [blank] | [blank]             | [blank]            |
  ...
  @OLE_Redesign_SEP  @OLE_Redesign_SEP_CSNP
    Examples:
      ...
      | 15513 | CSNP-MBI | AARP | current   | current    |   78006 | Yes             | Bexar County | SNP      | UnitedHealthcare Medicare Silver (Regional PPO C-SNP) | MBI      | TEST_SEP2_NS_CSNP      |TEST_SEP2_NS_CSNP | 5N69QY6ET32    | false   |  07012021 |  07012021|      431665465 | true     | 05011956 | Male   | 003 Morris Rd | Los Angeles | No                     | 123 Mcgee st  | IRVING      | TX           |      78006 | test@test.com | [blank]    | [blank]   | No     | No          | false     | John         | address of prov | Palmer       |           99645 |     1231231234 | NO                | NO      | 1234567890 | 2345678901 | HealthInsurance     | HI1562759   | ABC12345DEF  | PrescriptionCoverage     | PD5646136     | BCD12345EFG    |135617      | Valid         | [blank]    | Test_K          | Test_M         | 122 2ND AVE      |                655 | MINNEAPOLIS   |        55455 |           1235678901 | FRIEND                | MN             | Agree              |       566 |          677 | No        | No         | No        | No        | No        | No       | No       | No       | No       | No       | No       | true     | Pay By Mail                                    | [blank] | [blank]             | [blank]            |
