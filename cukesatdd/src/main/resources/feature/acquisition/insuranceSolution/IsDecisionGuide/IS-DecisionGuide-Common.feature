Feature: 1.14 Med Supp Plans (IS) Decision Guide flow E2E Scripts
  ...
  Scenario Outline: <Scenario> - To Test E2E IS Decision Guide E2E on <site> site thorugh Shop Pages for <firstname>
   ...
   Then the user validates Decision Guide Step 2 page info is same as the saved information from Pre-entry page on site
    ...
    Examples: 
      | Scenario                                        | site | zipcode | isMultutiCounty | county             | plantype | firstname  | lastname     | distributionmethod | email                      | dob        | partBmonth | partByear | aarpNo     | phNo       | mobileFlag | partAmonth | partAyear | startDate | gender |
     # | IS Decision Guide Request - E2E Scenario 1_AARP | AARP |   23452 | NO              |  Virginia Beach City | MS       | MNRtestKumar | MNRtestSai | mail               | [blank]                    | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
      | IS Decision Guide Request - E2E Scenario 1_AARP | AARP |   23452 | NO              |  Virginia Beach City | MS       | MNRtestSai | MNRtestKumar | email              | venkata.kanagala@optum.com | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |

    @insuranceSolution_DecisionGuide_Common_UHC @UATRegression @regressionUHC @insuranceSolution @sanity @nonProd @featureGate
    Examples: 
      | Scenario                                       | site | zipcode | isMultutiCounty | county             | plantype | firstname  | lastname     | distributionmethod | email                    | dob        | partBmonth | partByear | aarpNo     | phNo       | mobileFlag | partAmonth | partAyear | startDate | gender |
     # | IS Decision Guide Request - E2E Scenario 1_UMS | UHC  |   23452 | NO              |  Virginia Beach City | MS       | MNRtestKumar | MNRtestSai | mail               | [blank]                  | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
      | IS Decision Guide Request - E2E Scenario 1_UMS | UHC  |   23452 | NO              | C Virginia Beach City | MS       | MNRtestSai | MNRtestKumar | email              | prashant_kadus@optum.com | 01/01/1946 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
