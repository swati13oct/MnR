Feature: 1.14 Med Supp Plans (IS) Decision Guide flow UAT Scripts
  ...
  Scenario Outline: <Scenario> - To Test IS Decision Guide E2E on <site> site
    ...
    Examples: 
      ...
      | IS Decision Guide Request - E2E Scenario_AARP | AARP |   90210 | NO              | Los Angeles County | MS       |TEST_PORTALS_S | TEST_PORTALS_S | mail               | [blank]                    | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
      | IS Decision Guide Request - E2E Scenario_AARP | AARP |   90210 | NO              | Los Angeles County | MS       | TEST_PORTALS_k | TEST_PORTALS_S | email              | test123@optum.com | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |

    @insuranceSolution_DecisionGuide_Common_UHC @UATRegression @regressionUHC @insuranceSolution
    Examples: 
      | Scenario                                     | site | zipcode | isMultutiCounty | county             | plantype | firstname  | lastname     | distributionmethod | email                    | dob        | partBmonth | partByear | aarpNo     | phNo       | mobileFlag | partAmonth | partAyear | startDate | gender |
      | IS Decision Guide Request - E2E Scenario_UMS | UHC  |   90210 | NO              | Los Angeles County | MS       | TEST_PORTALS_k | TEST_PORTALS_S | mail               | [blank]                  | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
      | IS Decision Guide Request - E2E Scenario_UMS | UHC  |   90210 | NO              | Los Angeles County | MS       | TEST_PORTALS_S | TEST_PORTALS_k | email              | test123@optum.com | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
  ...
  Scenario Outline: <Scenario> - To Test UAT IS Decision Guide E2E on <site> site thorugh Shop Pages
    ...
    Examples: 
      | Scenario                                        | site | zipcode | isMultutiCounty | county             | plantype | firstname  | lastname     | distributionmethod | email                      | dob        | partBmonth | partByear | aarpNo     | phNo       | mobileFlag | partAmonth | partAyear | startDate | gender |
      | IS Decision Guide Request - E2E Scenario 1_AARP | AARP |   90210 | NO              | Los Angeles County | MS       | TEST_PORTALS_testSai | TEST_PORTALS_testKumar | mail               | [blank]                    | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
      | IS Decision Guide Request - E2E Scenario 1_AARP | AARP |   90210 | NO              | Los Angeles County | MS       | TEST_PORTALS_MNRSai | TEST_PORTALS_MNRKumar | email              | test123@optum.com | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |

    @insuranceSolution_DecisionGuide_Common_UHC @UATRegression @regressionUHC @insuranceSolution
    Examples: 
      | Scenario                                       | site | zipcode | isMultutiCounty | county             | plantype | firstname  | lastname     | distributionmethod | email                    | dob        | partBmonth | partByear | aarpNo     | phNo       | mobileFlag | partAmonth | partAyear | startDate | gender |
      | IS Decision Guide Request - E2E Scenario 1_UMS | UHC  |   90210 | NO              | Los Angeles County | MS       | TEST_PORTALS_MNRtestSai | TEST_PORTALS_MNRtestKumar | mail               | [blank]                  | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
      | IS Decision Guide Request - E2E Scenario 1_UMS | UHC  |   90210 | NO              | Los Angeles County | MS       | TEST_PORTALS_MNRtestSai | TEST_PORTALS_MNRtestKumar | email              | test123@optum.com | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
