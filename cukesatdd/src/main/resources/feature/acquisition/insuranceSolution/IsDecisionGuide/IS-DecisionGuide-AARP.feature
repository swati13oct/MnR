...
Feature: 1.14 Med Supp Plans (IS) Decision Guide flow in AARP site
  ...
  Scenario Outline: UID: <UID> - To Test IS Decision Guide E2E on AARP site
    ...
    Then the user validates Decision Guide Step 2 page info is same as the saved information from Pre-entry page
    ...
    Examples: 
      ...
      | 0001 |   90210 | NO              | Los Angeles County | MS       | test-mnr-first | test-mnr-last | mail               | [blank]       | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
      | 0002 |   90210 | NO              | Los Angeles County | MS       | test-mnr-first | test-mnr-last | email              | test@test.com | 01/01/1945 | January    |      2020 | 0321323215 | 3216549871 | N          | February   |      2020 | June      | male   |
