...
@AEP_US627344(10/15/2017)
Scenario Outline: Verify Enroll now link on plan summary page for 2017 and 2018 in AARP site for AEP only from 15th October till 30th November
Given the user is on the vpp portfolio page
Then the user performs plan serach using zipcode
                | Zip Code |<zipCode>|
                | County   |<county> |
...
Examples:
          |zipCode|county            |planType|planName                        |
          |02322  |Norfolk County    |PDP    |AARP MedicareRx Walgreens (PDP)  | 
