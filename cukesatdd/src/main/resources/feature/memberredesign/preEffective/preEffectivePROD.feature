Feature: 1.15 Member pre-effective functionality
  ...
  Scenario Outline: -planType: <planType> - Member Type: - <memberType> - Verify that correct links and messages are displayed on Dashboard and Secondary Page.
    ...
    Examples: 
      ...
      | IndMAPD  | preeffectiveIndMAPD | NON LIS       | 1-888-980-8125 |       000 | jkuma14  | Brock@04 | Charlybirdnyc          | 03/01/2021    |
  ...
  Scenario Outline: -planType: <planType> - Member Type: - <memberType> - Verify that correct links and messages are displayed on Dashboard and Secondary Page.
    ...
    Examples: 
      | planType | memberType          | copayCategory | technicalTFN   | segmentId | username | password | member            | planstartdate |
      | IndPDP   | preeffectiveIndPDP  | NON LIS       | 1-888-980-8125 |       000 | jkuma14  | Brock@04 | wsowell@gmail.com | 03/01/2021    |
       #Commenting tag due to unavailability of prod data - Pooja  01/04/2021
  ...
  Scenario Outline: -planType: <planType> - Member Type: - <memberType> - Verify that correct links and messages are displayed on Dashboard and Secondary Page.
    ...
    Examples: 
      | planType  | memberType            | copayCategory | technicalTFN   | segmentId | username | password | member                   | planstartdate |
      | GroupMAPD | preeffectiveGroupMAPD | NON LIS       | 1-888-980-8125 |       000 | jkuma14  | Brock@04 | karen.stook.us@gmail.com | 02/01/2021    |
      | SHIP      | preeffectiveSHIPOnly  | NON LIS       | 1-866-254-3132 |       000 | jkuma14  | Brock@04 | Terrielewis56            | 03/01/2021    |
  ...
  Scenario Outline: -planType: <planType> - Member Type: - <memberType> - Verify that correct links and messages are displayed on Dashboard and Secondary Page.
    ...
    Examples: 
      ...
      | IndPDP   | preeffectivePDPSHIPCOMBO | NON LIS       | 1-888-980-8125 |       000 | jkuma14  | Brock@04 | Deboss24       | 02/01/2021    | 1-866-254-3132   |
