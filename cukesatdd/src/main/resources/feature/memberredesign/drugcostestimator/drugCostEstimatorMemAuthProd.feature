...
Feature: 1.07.1 Member DCE Page - Member Auth - PROD
  ...
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> -I1.2 To Verify MR portal members DCE should not come for AARP federal members
   ...
   Then I should not see drug look up on home page
    ...
    Examples: 
     ...
     # | 15327 | ashah120 | Mnrqa002 |   			| SSUP     | SSUP_DCE     |
  ...
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> - Pharmacy saver results
    ...
    Examples: 
      ...
      | 15325 | ashah120 | Mnrqa002 | BILL.ROSNER123# | MAPD     | MAPD_DCE   | 06450   | 25 miles | Pharmacy Saver |Lipitor | Lipitor TAB 10MG |        31 | Every 1 month |

  @drugCostEstimator4 @prod 
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> -I1.1 To Verify MR portal DCE flow covering step1 step 2 and step3 .
    ...
    Examples: 
      ...
      | 15325 | ashah120 | Mnrqa002 | BILL.ROSNER123# | MAPD     | MAPD_DCE  | Lipitor| Lipitor TAB 10MG |        31 | Every 1 month | Lipitor TAB 20MG | Lipitor TAB 20MG | atorvastatin calcium TAB 20MG |   00820 | 25 miles |    100 | Every 3 months |
