...
Feature: To test branding functionality
  ...
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> - Verify that correct brand logos are displayed on Dashboard and Secondary Pages for members.
    ...
    Examples: 
     ...
     | 15153   | MAPD     | Medica_Branding           | NON LIS       | images/branding/medicahealthcare.svg | dam/UCP/Images/logo/MEDICA.svg      | TC_08_ Branding for Branding for Medica Plan member                          |
     | 15152   | MAPD     | PCP_Branding              | NON LIS       | images/branding/preferredcare.svg    | dam/UCP/Images/logo/PCP.svg         | TC_07_ Branding for Branding for PCP Plan member                             |
