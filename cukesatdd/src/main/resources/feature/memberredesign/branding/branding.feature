Feature: To test branding functionality
  ...
  Scenario Outline: Verify that correct brand logos are displayed on Dashboard and Secondary Pages for Non-Group members.
    ...
    Examples: 
        ...
        | MAPD     | PCP      | NON LIS       |images/branding/preferredcare.svg      | dam/UCP/Images/logo/PCP.svg   |TC_08_ Branding for Branding for Medica Plan member|
