Feature: 1.14 Member Branding functionality
  ...
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> - Verify_<Test Case>
    ...
    Examples: 
      ...
      | 15146 | MAPD     | AARPIndividual_Branding | NON LIS       | AARP                         | dam/UCP/Images/logo/AARP.svg     | TC_01_Branding for AARP Plan member - Federal Member  | jkuma14  | Brock@04 | TELGUY1@HOTMAIL.COM   |
