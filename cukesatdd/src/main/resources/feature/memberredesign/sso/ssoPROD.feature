...
Feature: 1.13 Member Outbound SSO functionality for M&R Member Portal
  ...
  Scenario Outline: Verify that member of <Test Scenario> is able to perfom Outbound SSO - University of Kentucky - Express Scripts SSO
    ...
    Examples: 
      | TID   | planType | memberType              | copayCategory | Test Scenario          | username | password | member      |
      | XXXXX | MAPD     | universityofkentuckySSO | NON LIS       | University Of Kentucky | jkuma14  | Brock@05 | Kywoman1953 |
  ...
  Scenario Outline: Verify that user is able to perfom Outbound SSO - MyHCE_<Test Scenario>
    ...
    Examples: 
      | TID   | planType | memberType | copayCategory | zipCode | Test Scenario             | username | password | member                    |
      | XXXXX | MAPD     | myhce      | NON LIS       |   30527 | TC_SSO_SHBP_Georgia_myHCE | jkuma14  | Brock@05 | Andersonga1@Bellsouth.Net |
  ...
  Scenario Outline: Verify that user is able to perfom Outbound SSO - OptumRx from Benefits and Coverage Page from <optumrxssolink>
    ...
    Examples: 
      | TID   | planType | memberType | copayCategory | Test Scenario   | optumrxssolink                                                  | username | password | member                    |
      | TC001 | MAPD     | optumrx    | NON LIS       | TC_OptumxRX_SSO | VIEW YOUR CURRENT PRESCRIPTION DRUG COST SUMMARY AT OPTUMRX.COM | jkuma14  | Brock@05 | Andersonga1@Bellsouth.Net |
      | TC002 | MAPD     | optumrx    | NON LIS       | TC_OptumxRX_SSO | LookUpDrugsButton                                               | jkuma14  | Brock@05 | Andersonga1@Bellsouth.Net |
      | TC003 | MAPD     | optumrx    | NON LIS       | TC_OptumxRX_SSO | viewDetailsAtOptumrxLink                                        | jkuma14  | Brock@05 | Andersonga1@Bellsouth.Net |
  ...
  #  Examples:
  #    | TID   | planType                | memberType | copayCategory | Test Scenario   | optumrxssolink           | username | password | member                    |
  #     | TC004 | GroupMAPDWithoutPayment | optumrx    | NON LIS       | TC_OptumxRX_SSO | LookUpDrugsButton        | jkuma14  | Brock@05 | Andersonga1@Bellsouth.Net |
  #    | TC005 | IndividualWithPayment   | optumrx    | NON LIS       | TC_OptumxRX_SSO | orderPrescriptionsButton | jkuma14  | Brock@05 | dbar3322                  |
  #  | TC006 | IndividualWithPayment   | optumrx    | NON LIS       | TC_OptumxRX_SSO | checkDelieryStatusButton | jkuma14  | Brock@05 | dbar3322                  |
  # | TC007 | GroupMAPDWithoutPayment | optumrx    | NON LIS       | TC_OptumxRX_SSO | drugCostSummaryButton    | jkuma14  | Brock@05 | Andersonga1@Bellsouth.Net |
