Feature: 1.13 Member Inbound SSO functionality tested from TestHarness page for M&R Member Portal
  ...
  Scenario Outline: Verify that user is able to perfom Inbound SSO for <Scenario> from Ping Federate Test Harness Page
    ...
    Examples: 
      ...
      | canopyhealth  | NICOLETTE | WOLTZ      |    06291942 | 5AK3Q74MP80 | https://stage-medicare.uhc.com/sso/inbound/canopy         | Canopy Health      |          | https://www.team-h-medicare.ocp-ctc-dmz-nonprod.optum.com/sso/inbound/canopy         | https://offline-stage-medicare.uhc.com/sso/inbound/canopy         |
