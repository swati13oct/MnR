@thePredators @pharmacylocator @regressionMember
Feature: P1.6To test Locate a Pharmacy tool in Redesign site
  ...
  @pharmacylocator1 @ValidateLanguageandZIPcode
  ...
  @pharmacylocator2 @ZipCodeErrorMessages
  ...
  @pharmacylocator3 @NegativeScenario
