...
Feature:To test HSID functionality on Medicare site
   ...
   @CMDBConnect
    ...
    @US968323
    Scenario Outline: Verify HSID Assistive Flow page
   ...
   | MAPD    |  Individual  |  NON LIS      | ACACBAA   | CBEFABBB        | 09/15/1944          | 008540905-1 | 97106	 |q1_aarp_apr258  | Password@1 | codetransformers@gmail.com | number1   | name1     | color1    |