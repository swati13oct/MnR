 ...
 @prod__benefitsAndCoverage24 @CMpdpindlis @prod_BnC_Part8 
  ...
  Scenario Outline: Index: <index> -FID: <FID> -plan: <planType> -memberType: <memberType> - Verify  Medical copays or coinsurance section and Out-of-pocket maximum section for DSNP members
    ...
    Examples: 
      ...
      | 20-c1 | F494433,F506320 |kkumard  | mnrs786@ |Filbert44  | DSNP_MAPD  | Individual_CnS01_BnC | LIS 2         | ENGLISH  | DREENA KIMURA| 971949191-00 | 01/01/2020    | Not Available  | Extra Help Level : 2 | IndEffectiveAARP |     6 | H0624-001| NoRider|
      | 21-c2 | F494433,F506320 |kkumard  | mnrs786@ |Arm8bur    | DSNP_MAPD  | Individual_CnS02_BnC | LIS 1         | ENGLISH  | EBER KRYSTEK| 903010063-00 | 01/01/2020    | Not Available  | Extra Help Level : 1 | IndEffectiveAARP |     6 | H2228-045| NoRider|
   ...
   #  @prod_DSNP_CnS03
    #Examples: 
      | index | FID    		    |username |password  |MemUserName | planType   | memberType           | copayCategory | language | name         | memberid     | effectivedate | monthlypremium| extrahelp | Identifier      | count | H-PBP    | rider  |
     # | 35-c6 | F494433,F506320 |kkumard  | mnrs786@ |testUserName| DSNP_MAPD  | Individual_CnS06_BnC | Non Lis       | ENGLISH  | EBER KRYSTEK| 903010063-00 | 01/01/2020    | Not Available  | 		   |IndEffectiveAARP |     6 | H4527-015| NoRider|
     # | 36-c7 | F494433,F506320 |kkumard  | mnrs786@ |testUserName| DSNP_MAPD  | Individual_CnS07_BnC | Non Lis       | ENGLISH  | EBER KRYSTEK| 903010063-00 | 01/01/2020    | Not Available  |           | IndEffectiveAARP|     6 | H5322-030| NoRider|
      
      
    @prod_DSNP_MnR01
    Examples:       
       | index | FID             |username |password  |MemUserName| planType   | memberType           | copayCategory | language | name         | memberid     | effectivedate | monthlypremium | extrahelp            | Identifier       | count | H-PBP    | rider  |
       | 25-m1 | F494433,F506320 |kkumard  | mnrs786@ |insurance1704| DSNP_MAPD  | Individual_MnR01_BnC | LIS 1         | ENGLISH  | OFER MCLEON  | 937024725-1| 01/01/2020    | Not Available  | Extra Help Level : 1 | IndEffectiveAARP |     6 |  H0271-005 |  NoRider|
       | 26-m2 | F494433,F506320 |kkumard  | mnrs786@ |scales5| DSNP_MAPD  | Individual_MnR02_BnC | LIS 1         | ENGLISH  | DBAD ADFED | 919744565-00 | 01/01/2020    | Not Available  | Extra Help Level : 1 | IndEffectiveAARP |     6 |  H5253-041 | NoRider |

    @prod_DSNP_MnR02
    Examples:      
       | index | FID             |username |password  |MemUserName| planType   | memberType           | copayCategory | language | name         | memberid     | effectivedate | monthlypremium | extrahelp            | Identifier       | count | H-PBP    | rider  |
       | 27-m3 | F494433,F506320 |kkumard  | mnrs786@ |dkdinkins  | DSNP_MAPD  | Individual_MnR03_BnC | LIS 1         | ENGLISH  | DBAD ADFED | 919744565-00 | 01/01/2020   | Not Available   | Extra Help Level : 1 | IndEffectiveAARP |     6 |  R2604-004 | NoRider|
       | 28-m4 | F494433,F506320 |kkumard  | mnrs786@ |Buttercup2020| DSNP_MAPD  | Individual_MnR04_BnC | LIS 3         | ENGLISH  | DBAD ADFED | 919744565-00 | 01/01/2020    | Not Available  | Extra Help Level : 3 | IndEffectiveAARP |     6 |  H0271-006 | NoRider|
