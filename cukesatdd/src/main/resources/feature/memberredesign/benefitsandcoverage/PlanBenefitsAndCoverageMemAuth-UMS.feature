...
###############################Regression Scenarios Begin Here ########################################
  ...
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> - Verify the outpatient widget for a member withprovidertiering
    ...
    Examples: 
      ...
      | 15084 | qavgogine | qavgogine | testUsername    | MAPD      | providerTier_BNC |

  #TC02_Primarycareprovider_specialist_withprovidertiering
  @memAuth_benefitsAndCoverage7 @primarycareproviderspecialist @thepredators @regressionprimarycareprovider @BnC_Part1_memAuth
  ...
  @memAuth_benefitsAndCoverage4 @OfficeVisitswithoutprovidertiering @regression @BnC_Part2_memAuth
  ...
  @memAuth_benefitsAndCoverage11 @CopayCoinsuranceInDrugCostTable @regression @BnC_Part2_memAuth
  ...
  @memAuth_benefitsAndCoverage9 @BenefitsForAlPeehipMember @regression 
  ...
  @memAuth_benefitsAndCoverage3 @BenefitsforTexasERSMember @regression @BnC_Part3_memAuth
...
#TC13_Benefits_for_MA_SSUP_MEDSUPMember
  ...
  @memAuth_benefitsAndCoverage13 @BenefitsRiderFunctionality @regression
