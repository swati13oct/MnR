Feature: 1.19 Verify the premium payment flows on member portal - Part 3 - Test case 14 to 26
  ...
  #Test Case 15 - Member Auth - FED - Error message on submitting payment - Edit Recurring EFT
  @regressionMember
  ...
  #Test Case 20 - Fed - Any member will work
  @regressionMember
  ...
  #Test Case 21 -Fed - Any member will work
  @regressionMember
  ...
  @regressionMember
  Scenario Outline: FID: <FID> -plan: <planType> -memberType: <memberType> - Test Case 25 -Verify billing and payment history for Fed+Fed - Active Group PDP + Active Group SSUP member , Active PDP + Active SHIP with billing and payment history in last 90 days
    Given login with following details logins in the member portal and validate elements
      | Plan Type      | <planType>      |
      | Member Type    | <memberType>    |
      | Copay Category | <copayCategory> |
