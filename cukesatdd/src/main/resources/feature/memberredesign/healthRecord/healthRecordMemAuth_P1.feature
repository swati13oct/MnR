@healthRecord
Feature: 1.24.1.a Member Individual Health Record - Member Auth - P1 - Dashboard, FindCare, Claims
  ...
  Scenario Outline: -Index <index> -FID <FID> -Plan Type: <planType> -Member Type: <memberType> - To verify iHR link display for user that is not on the exclusion table - P1 - Dashboard, FindCare, Claims
    ...
    @memAuth_no_ihr_p1_ship_exclude
    Examples: 
    ...
    @memAuth_no_ihr_p1_shipCombo
    Examples: 
	    | index | FID     | username  | password  | MemUserName             | planType                 | memberType         | expectLink | 
	    | 03    | F424804 | qavgogine | qavgogine | q3_sep_UAT4_AARP273     | SHIP_MEDICARE SUPPLEMENT | COMBO_PDP_SHIP_IHR | false      |
    ...
    Examples: 
	    | index | FID     | username  | password  | MemUserName             | planType | memberType         | expectLink | 
	    | 10    | F424804 | qavgogine | qavgogine | q3_sep_UAT4_AARP273     | PDP      | IHR                | true       |
    ...
    @memAuth_ihr_p1_fedShipCombo_shipFedCombo
    Examples: 
	    | index | FID     | username  | password  | MemUserName             | planType | memberType         | expectLink | 
	    | 15    | F424804 | qavgogine | qavgogine | q3_sep_UAT4_AARP273     | PDP      | COMBO_PDP_SHIP_IHR | true       |
	    | 16    | F424804 | qavgogine | qavgogine | q1_march_PA_008         | MA       | COMBO_SHIP_MA_IHR  | true       |
