...
Feature: 1.06.6.1 Member Plans and Documents - section: Forms And Resources Part 6a of 7 - Other Resources - Member Auth
  ...
  #------------------------------------------
  @memAuth_planAndDocuments06_6aof7 @formsAndResources_6aof7
...
#	@memAuth_terminated_mapd_6aof7
#	Examples: 
#      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_or |
#      | 07-101 | xxxxx       | qavgogine | qavgogine | testusername    | MAPD     | IND_TERM_PDnR         | true   | true   |

	@memAuth_active_ma_ind_6aof7 @memAuth_active_ma_6aof7
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_or |
      | 09-104 | 15129       | qavgogine | qavgogine | q2_june_NiceSeg_1595  | MA  | AARP_IND_EFF_PDnR     | true   | true   |

	@memAuth_active_ma_grp_6aof7 @memAuth_active_ma_6aof7
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_or |
      | 10-105 | 15130       | qavgogine | qavgogine | q3_sep_UAT4_Group152 | MA  | GROUP_EFF_PDnR        | true   | true   |

	@memAuth_active_mapd_ind_6aof7 @memAuth_active_mapd_6aof7
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_or |
      | 11-106 | 15108       | qavgogine | qavgogine | q2_apr_aarp0250 | MAPD     | AARP_IND_EFF_PDnR     | true   | true   |

	@memAuth_active_mapd_grp_6aof7 @memAuth_active_mapd_6aof7
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_or |
...
#      | 15-110 | 15128       | qavgogine | qavgogine | testusername    | MEDICA   | IND_EFF_PDnR          | true   | true   |
	...
	#@memAuth_preeffective_ship_6aof7
	#Examples: 
    #  | index  | TID         | username  | password  | MemUserName         | planType | memberType            | fnr_sd | fnr_or  |
