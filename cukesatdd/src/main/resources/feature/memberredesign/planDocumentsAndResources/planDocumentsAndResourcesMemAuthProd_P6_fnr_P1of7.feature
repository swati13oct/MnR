...
#      | 05-100 | xxxxx       | kkumard  | tnps459#  | testusername    | PDP      | GROUP_PREEFF_PDnR     | false  | false    |
	...
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_pdmo |
#      | 06-103 | xxxxx       | kkumard  | tnps459#  | testusername    | MA       | IND_TERM_PDnR         | true   | false    |
      | 07-102 | xxxxx       | kkumard  | tnps459#  | PJVANEKRIS65    | MA       | GROUP_TERM_PDnR       | true   | false    |
...
#      | 07-101 | xxxxx       | kkumard  | tnps459#  | BEVERLY_BOB5    | MAPD     | IND_TERM_PDnR         | true   | true     |
	...
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_pdmo |
      | 09-104 | 15129       | kkumard  | tnps459#  | haradaty32      | MA       | AARP_IND_EFF_PDnR     | true   | false    |

	@prod_active_ma_grp_1of7 @prod_active_ma_1of7
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_pdmo |
      | 10-105 | 15130       | kkumard  | tnps459#  | 1GIRL4DEAN      | MA       | GROUP_EFF_PDnR        | true   | false    |
...
#     #| 13-108 | 15130       | kkumard  | tnps459#  | testusername    | MAPD     | PEEHIP_GROUP_EFF_PDnR | true   | false    |
	...
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_pdmo |
      | 18-113 | 15131,15233 | kkumard  | tnps459#  | DKELLY27        | SSP      | COMBO_GROUP_EFF_PDnR  | true   | false    |

	@prod_active_ship_1of7
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_pdmo |
      | 19-114 | 15119,15304 | kkumard  | tnps459#  | Pramila1946     | SHIP     | IND_EFF_PDnR          | true   | false    |
#     | 19-120 | 15119,15304 | kkumard  | tnps459#  | q1_feb_2020SHIP_001 | SHIP | MULTI_IND_EFF_PDnR    | true   | false    |
