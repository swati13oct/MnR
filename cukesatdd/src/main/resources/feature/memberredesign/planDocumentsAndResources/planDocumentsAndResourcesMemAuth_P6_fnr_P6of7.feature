...
Feature: 1.06.6.1 Member Plans and Documents - section: Forms And Resources Part 6 of 7 - Other Resources - Member Auth
  ...
  #------------------------------------------
  @memAuth_planAndDocuments06_6of7 @formsAndResources_6of7
...
#      | 15-110 | 15128       | qavgogine | qavgogine | testusername    | MEDICA   | IND_EFF_PDnR          | true   | true   |
	...
	#@memAuth_preeffective_ship_6bf7
	#Examples: 
    #  | index  | TID         | username  | password  | MemUserName         | planType | memberType            | fnr_sd | fnr_or  |
