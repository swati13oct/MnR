...
#      | 07-101 | xxxxx       | qavgogine | qavgogine | testusername    | MAPD     | IND_TERM_PDnR         | true   | true     | true    | true   | true   |
	...
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_pdmo | fnr_ppi | fnr_rf | fnr_af |
      | 09-104 | 15129       | qavgogine | qavgogine | q3_sep_UAT4_AARP203 | MA   | AARP_IND_EFF_PDnR     | true   | false    | true    | true   | true   |
...
#      | 15-110 | 15128       | qavgogine | qavgogine | testusername    | MEDICA   | IND_EFF_PDnR          | true   | true     | true    | true   | true   | 
	...
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_pdmo | fnr_ppi | fnr_rf | fnr_af |
      | 19-114 | 15119,15304 | qavgogine | qavgogine | q1_feb_ship_20_001  | SHIP | IND_EFF_PDnR          | true   | false    | false   | false  | false  |
      | 19-120 | 15119,15304 | qavgogine | qavgogine | q1_feb_2020SHIP_001 | SHIP | MULTI_IND_EFF_PDnR    | true   | false    | false   | false  | false  |    