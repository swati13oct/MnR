...
#      | 07-101 | xxxxx       | kkumard  | mnrs786@  | BEVERLY_BOB5    | MAPD     | IND_TERM_PDnR         | true   | true    | true   | true   | 
	...
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_maf | fnr_or | fnr_di |
      | 09-104 | 15129       | kkumard  | mnrs786@  | haradaty32      | MA       | AARP_IND_EFF_PDnR     | true   | false   | true   | true   |
...
#      | 10-105 | 15130       | kkumard  | mnrs786@  | SPENCEPR1      | MA       | NICE_GROUP_EFF_PDnR        | true   | false   | true   | true   |
	...
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_maf | fnr_or | fnr_di |
      | 11-106 | 15108       | kkumard  | mnrs786@  | LMHOCHSCHILD11 | MAPD     | AARP_IND_EFF_PDnR     | true   | true    | true   | true   |
...
#	Examples: 
#      | index  | TID         | username  | password  | MemUserName  | planType | memberType            | fnr_sd | fnr_maf | fnr_or | fnr_di |
#     | 21-121 | xxxxx       | kkumard   | mnrs786@  | testusername | SHIP     | IND_PREEFF_PDnR       | true   | false   | false  | false  |
