...
#      | 02-097 | xxxxx       | kkumard  | tnps459#  | testusername    | MA       | GROUP_PREEFF_PDnR     | false  | false    | false   | false  |
	...
	Examples: 
      | index  | TID         | username  | password  | MemUserName     | planType | memberType            | fnr_sd | fnr_pdmo | fnr_ppi | fnr_rf |
      | 03-098 | xxxxx       | kkumard  | tnps459#  | UHCjanicejohn          | MAPD     | AARP_IND_PREEFF_PDnR  | false  | false    | false   | false  |
...
#      | 06-103 | xxxxx       | kkumard  | tnps459#  | testusername    | MA       | IND_TERM_PDnR         | true   | false    | true    | true   |
      | 07-102 | xxxxx       | kkumard  | tnps459#  | PJVANEKRIS65    | MA       | GROUP_TERM_PDnR       | true   | false    | false   | true   |
