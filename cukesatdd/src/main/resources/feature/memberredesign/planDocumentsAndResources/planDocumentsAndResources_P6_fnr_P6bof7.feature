...
Feature: 1.06.6 Member Plans and Documents - section: Forms And Resources Part 6 of 7 - Other Resources
  ...
  #------------------------------------------
  @planAndDocuments06_6bof7 @formsAndResources
  Scenario Outline: index: <index> -TID: <TID> -planType <planType> -memberType <memberType> - To validate the plan documents and resources page content for section: Forms And Resources - Other Resources Part2of2
	...
	@active_mapd_6bof7 @devRegression
	Examples: 
      | index  | TID         | planType | memberType            | fnr_sd | fnr_or |
	...
	@active_ship_6bof7 @devRegression
	Examples: 
      | index  | TID         | planType | memberType            | fnr_sd | fnr_or |
      | 19-120 | 15119,15304 | SHIP     | MULTI_IND_EFF_PDnR    | true   | false  |   
 
	@preeffective_ship_6bof7
	Examples: 
      | index  | TID         | planType | memberType            | fnr_sd | fnr_or  |
      | 20-121 | xxxxx       | SHIP     | IND_PREEFF_PDnR       | true   | false   |             
=======
@planAndDocuments @thePredators @regressionMember @E2E @feature-F368974
Feature: 1.06.6 Member Plans and Documents - section: Forms And Resources Part 6b of 7 - Other Resources
