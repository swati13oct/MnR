...
Feature: 1.06.6 Member Plans and Documents - section: Forms And Resources Part 6a of 7 - Other Resources
  ...
  #------------------------------------------
  @planAndDocuments06_6aof7 @formsAndResources
  Scenario Outline: index: <index> -TID: <TID> -planType <planType> -memberType <memberType> - To validate the plan documents and resources page content for section: Forms And Resources - Other Resources Part1of2
	...
	@active_mapd_6aof7 @devRegression
	Examples: 
      | index  | TID         | planType | memberType            | fnr_sd | fnr_or |
	...
	@active_ship_6aof7 @devRegression
	Examples: 
      | index  | TID         | planType | memberType            | fnr_sd | fnr_or |
      | 19-120 | 15119,15304 | SHIP     | MULTI_IND_EFF_PDnR    | true   | false  |    
      
	#note: no test user available for now
	#@preeffective_ship_6aof7
	#Examples: 
    #  | index  | TID         | planType | memberType            | fnr_sd | fnr_or  |
