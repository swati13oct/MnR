...
Feature: To test HSID registration flow
  ...
  #Then user should see a latest unread mail recieved  in mail server
   ...
   | SHIP    |  Individual  |  NON LIS      | STVTBQ  | WKYX         | 01/01/1941     | 321006300-11    | 07747	 | shipgogreen227      | Password@1 | codetransformer002@gmail.com      | number1   | name1     | color1    |
  | Combo   |  Individual  |  NON LIS      | DIAMANTA      | ISMAEL   | 07/13/1942     | 913311879-1  | 06904	 | q3_sep_Active_combo_0008    | Password@1 | codetransformer002@gmail.com      | number1   | name1     | color1    |
