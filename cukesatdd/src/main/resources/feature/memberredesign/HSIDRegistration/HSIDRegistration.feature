...
Feature: To test HSID registration flow
  ...
  #Then user should see a latest unread mail recieved  in mail server
   ...
   | PDP     |  Individual  |  NON LIS      | LAT   | HENKE           | 08/22/1992       | 018229742-1 | 51047	 | q3_sep_UAT4_AARP004        | Password@1 | codetransformer002@gmail.com      | number1   | name1     | color1    |
   ...
   | Combo   |  Individual  |  NON LIS      | NELA      | MACLACHLAN   | 12/07/1937     | 012806140-1  | 00801	 | q3_sep_Active_combo_0008    | Password@1 | codetransformer002@gmail.com      | number1   | name1     | color1    |
