Feature: S1.1 To test Member Auth Sign for SSO Micro App.
  ...
  Scenario Outline: Scenario- <Scenario> - Test Case_To test single signon using member auth - Search with Username
    ...
    Examples: 
      ...
      | jkuma14  | Brock@05 | Pramila1946                          | Scenario 2a: Search using username � SHIP Member                                |
      | jkuma14  | Brock@05 | marylamb823                          | Scenario 3: Search using username � PCP Plan Member                             |
  ...
  Scenario Outline: Scenario- <Scenario> - Test Case_To test single signon using member auth - Search with Username
    ...
    Examples: 
      | username | password | member                               | Scenario                                                                        |
      | jkuma14  | Brock@05 | TCZUNIGA52                           | Scenario 4: Search using username � Medica Plan Member                          |
      | jkuma14  | Brock@05 | erbenoit56                           | Scenario 5: Search using username � Terminated<12                               |
      | jkuma14  | Brock@05 | Beaver34                             | Scenario 6: Search using username � Pre-effective                               |
  ...
  Scenario Outline: Scenario- <Scenario> - Test Case_To test single signon using member auth - Search with Username
    ...
    Examples: 
      | username | password | member                               | Scenario                                                                        |
      | jkuma14  | Brock@05 | 6b8691ed-7b30-4673-9dd6-54a8acc66129 | Scenario 7: Search using username � UUID                                        |
  ...
  Scenario Outline: Scenario- <Scenario> - Test Case_To test single signon using member auth - Search using memberid and dob
    ...
    Examples: 
      ...
      | jkuma14  | Brock@05 | 970530542-1  |    01 |  28 | 1952 | Scenario 2b: Search using member id and DOB � Group MAPD Member-COSMOS     |
      | jkuma14  | Brock@05 | 063246454-11 |    07 |  07 | 1949 | Scenario 2c: Search using member id and DOB � COMBO Member (PDP + MedSupp) |
