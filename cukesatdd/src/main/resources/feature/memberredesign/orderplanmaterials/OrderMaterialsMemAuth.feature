...
Feature: 1.10.1 Member  order materials Page - Member Auth
  ...
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> - Verify order plan material functionality for different type of users
    ...
    Examples: 
      ...
      | 15288 | qavgogine | qavgogine | q2_jun_aarp0062    | MAPD     | AARP_Individual_order |

    @memAuth_Individuala @ma
    Examples: 
      | TID   | username  | password  | MemUserName     | planType | memberType            |  
      | 15287 | qavgogine | qavgogine | q2_june_Cosmos_Seg002    | MA	   | AARP_Individual_order |

    @memAuth_Individuala @pdp
    Examples: 
      | TID   | username  | password  | MemUserName     | planType | memberType            |  
      | 15292 | qavgogine | qavgogine | q2_jun_aarp0112    | PDP      | AARP_Individual_order |
