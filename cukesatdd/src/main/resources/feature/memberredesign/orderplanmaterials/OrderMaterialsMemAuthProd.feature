...
Feature: 1.10.1 Member  order materials Page - PROD
  ...
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> - Verify order plan material functionality for different type of users
    ...
    Examples:
      | TID   | username | password | MemUserName        | planType | memberType    |
      | 15293 | ujethwa | Member22 | rldf1942 | SHIP     | MEDSUPP_order |
  ...
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> - Verify order plan material functionality for different type of users
    ...
    Examples:
      | TID   | username | password | MemUserName  | planType | memberType            |
      | 15287 | ujethwa | Member22 | TOMIKOARMER2 | MA       | AARP_Individual_order |

      @prod_orderPlanMaterials1b @pdp
    Examples:
      | TID   | username | password | MemUserName | planType | memberType            |
      | 15292 | ujethwa | Member22 | LSLOMSKI777 | PDP      | AARP_Individual_order |

    #-------------------
       @prod_orderPlanMaterials1b
    Examples:
      | TID   | username | password | MemUserName           | planType | memberType       |
      | 15286 | ujethwa | Member22 | marylamb823           | PCP      | Individual_order |
      | 15285 | ujethwa | Member22 | SUSICHAPMAN@GMAIL.COM | MEDICA   | Individual_order |
    ...
    Examples:
      | TID   | username | password | MemUserName       | planType | memberType      |
      | 15289 | ujethwa | Member22 | WILLIAMGARRISON48 | MAPD     | UHC_Group_order |

     @prod_orderPlanMaterials1d
    Examples:
      | TID   | username | password | MemUserName  | planType | memberType      |
      | 15289 | ujethwa | Member22 | TOMIKOARMER2 | MA       | UHC_Group_order |
      | 15290 | ujethwa | Member22 | Norm749   | PDP      | UHC_Group_order |

    #-------------------
      @prod_orderPlanMaterials1d
    Examples:
      | TID   | username | password | MemUserName        | planType | memberType  |
      #| 15281 | ujethwa | Member22 | aliceb1105@aol.com | MAPD     | COMBO_order |
      | 15281 | ujethwa | Member22 | Norm749            | MEDSUPP  | COMBO_order |
    ...
    Examples:
      | TID   | username | password | MemUserName | planType | memberType  |
      | 15291 | ujethwa | Member22 | Norm749     | PDP      | COMBO_order |
  ...
  Scenario Outline: TID: <TID> -plan: <planType> -memberType: <memberType> - Verify Terminated members cannot access Order Plan materials Page
    ...
    Examples:
      | TID   | username | password | MemUserName | planType | memberType                  |
      | 15284 | ujethwa | Member22 | erbenoit56  | MAPD     | AARP_Terminatedmember_order |