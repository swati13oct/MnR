...
Feature: 1.02.1 Member Profile page - Member Auth
  ...
  Scenario Outline: TID: <TID> -Plan Type: <planType> - To verify Profile page End to End test for Ship Members
    ...
    Examples: 
	    ...
	    | 15103 | qavgogine | qavgogine | testusername    | SHIP     | SHIP_ProfilePref    |   
  ...
  Scenario Outline: TID: <TID> -Plan Type: <planType> - To verify Profile page End to End test for MAPD and MA Members
    ...
    Examples: 
      | TID     | username  | password  | MemUserName  | planType | memberType                     |
      | 15083_1 | qavgogine | qavgogine | testusername | MAPD     | MAPD_GROUP_GOGreen_Profilepref |
      | 15083_2 | qavgogine | qavgogine | testusername | MA       | MA_AARP_GOGreen_Profilepref    |
      | 15083_3 | qavgogine | qavgogine | testusername | PDP      | PDP_AARP_GOGreen_Profilepref   |

  @memAuth_accountProfile03 @NegativeTestonHSIDpage @AP_Part1_MemAuth
