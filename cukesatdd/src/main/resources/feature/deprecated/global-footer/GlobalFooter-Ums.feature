...
Scenario: To test Request for assistance link in global footer in UMS site
Given the user is on the UHC Medicaresolutions Site
When user accesses global footer UHC Medicaresolutions Site
And the user clicks on Request for assistance link from home page footer UHC Medicaresolutions Site
