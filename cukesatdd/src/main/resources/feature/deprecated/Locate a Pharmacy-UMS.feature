@unimplemented
Feature:To test Locate a Pharmacy in UMS site
Scenario Outline:To verify available pharmacies displayed in Locate a Pharmacy in UMS site
When the user selects pharmacy link in UMS site
And the user enters zipcode and distance details in UMS site
	| Zip Code    | <zipcode>   |
	| Distance | <distance>    |
And the user selects county in UMS site
	 | County Name | <county>    |
...
Scenario Outline:To verify pharmacies displayed in Locate a Pharmacy in UMS site
When the user selects pharmacy link in UMS site
And the user enters zipcode and distance details in UMS site
	| Zip Code    | <zipcode>   |
	| Distance | <distance>    |
