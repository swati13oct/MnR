...
Examples:
	...
	| PDP      | AARPIndividual  |  25       |Open 24 hours |
	| MAPD	   | AARPIndividual  |   10      |Long-term care |
...
@ValidateLanguageandErrorMessages
Scenario Outline: To verify pharmacy Locator for Chinese and Spanish Language in Redesign site
Given registered member to verify locate a pharmacy in Redesign Site
| Plan Type	| <planType> |
  | Member Type  | <memberType> |
When the user navigates to pharmacy search page in Redesign site
